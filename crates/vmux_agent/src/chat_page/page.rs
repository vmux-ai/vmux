...
use vmux_chat::activity::{
    ActivityIcon, activity_icon_paths, language_activity_icon, render_activity_icon,
    render_file_activity_icon, render_tool_activity_icon, should_expand_thinking,
    tool_activity_icon_for, tool_presentation,
};
