...
impl Plugin for VisualToolsPlugin {
    fn build(&self, app: &mut App) {
        ...
        tools.local(app, "screenshot", screenshot);
        tools.local(app, "simulator_screenshot", simulator_screenshot);
        tools.local(app, "simulator_tap", simulator_tap);
        tools.local(app, "simulator_swipe", simulator_swipe);
        tools.local(app, "simulator_type", simulator_type);
        tools.local(app, "simulator_key", simulator_key);
        tools.local(app, "simulator_button", simulator_button);
        tools.local(app, "browser_snapshot", browser_snapshot);
        tools.local(app, "browser_scroll", browser_scroll);
        tools.local(app, "record_start", record_start);
        tools.local(app, "record_stop", record_stop);
        tools.finish();
    }
}
