    ...
    rsx! {
        div { class: "flex shrink-0 items-center gap-1 pl-1",
            ...
            button {
                ...
                Icon { class: "h-4 w-4",
                    path { d: "M15 3h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z" }
                    path { d: "M10 21V8a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1H8" }
                }
            }
        }
    }
