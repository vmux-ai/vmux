...
use crate::event::{
    TermCursor, TermLine, TermThemeEvent, TermViewportPatch, TerminalUiStateEvent,
    TerminalUiStatePatch,
};
...
#[derive(Clone, Copy)]
pub(crate) struct TerminalPageState {
...
impl TerminalPageState {
    ...
    fn listen(self) {
        let root = use_ui_state_root::<TerminalUiStateEvent>();
