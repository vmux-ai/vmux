...
pub use definition::{
    AgentAccess, CommandCatalog, CommandDefinition, CommandDispatch, CommandInvocation, CommandMcp,
    CommandRuntimePlugin, CommandShortcut, CommandSpawner, DispatchCommandInvocations,
