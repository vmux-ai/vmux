...
knowledge-search = جستجوی دانش
knowledge-no-match = هیچ یادداشت منطبقی وجود ندارد
knowledge-open-linked-note = یادداشت پیوندی را باز کنید
knowledge-create-linked-note = یادداشت پیوندی ایجاد کنید
editor-properties = خواص
editor-no-properties = بدون خواص
editor-add-tags = برچسب ها را اضافه کنید
editor-add-property = افزودن ملک
editor-change-property-type = تغییر نوع ویژگی
editor-add-tag = برچسب اضافه کنید
editor-add-item = مورد را اضافه کنید
editor-linked-note = یادداشت پیوندی
editor-property-value = ارزش
editor-delete-property = حذف ملک
editor-property-kind-text = متن
editor-property-kind-number = شماره
editor-property-kind-checkbox = چک باکس
...
mobile-demo-open = بدون Mac یک تور ببینید
mobile-demo-exit = خروج از تور
mobile-status-demo = تور
mobile-demo-session-title = رفع اشکال جمع سفارش
mobile-demo-prompt = در سبدهای چندکالایی، جمع سفارش یک سنت اختلاف دارد. می‌توانی علتش را پیدا کنی؟
mobile-demo-thinking = گرد کردن هر ردیف پیش از جمع زدن، اختلاف یک سنتی را توضیح می‌دهد. دارم بررسی می‌کنم که جمع چگونه ساخته می‌شود.
mobile-demo-answer = نوع جمع به‌صورت اعشاری استنباط می‌شد، بنابراین هر ردیف پیش از افزوده‌شدن گرد می‌شد. تعیین نوع جمع به‌عنوان Cents آن را در حساب اعداد صحیح نگه می‌دارد و اختلاف از بین می‌رود.
