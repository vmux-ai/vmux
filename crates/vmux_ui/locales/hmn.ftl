...
knowledge-search = Nrhiav Kev Paub
knowledge-no-match = Tsis muaj ntawv sau zoo sib xws
knowledge-open-linked-note = Qhib cov ntawv txuas
knowledge-create-linked-note = Tsim cov ntawv txuas
editor-properties = Cov khoom
editor-no-properties = Tsis muaj khoom
editor-add-tags = Ntxiv tag
editor-add-property = Ntxiv cov khoom
editor-change-property-type = Hloov hom khoom
editor-add-tag = Ntxiv tag
editor-add-item = Ntxiv cov khoom
editor-linked-note = Txuas daim ntawv
editor-property-value = Tus nqi
editor-delete-property = Rho tawm cov cuab yeej
editor-property-kind-text = Ntawv nyeem
editor-property-kind-number = Tus lej
editor-property-kind-checkbox = Checkbox
editor-property-kind-date = Hnub tim
...
mobile-pair-title = Txuas mus rau koj lub Mac
mobile-pair-subtitle = Hauv Vmux, qhib Remote thiab xaiv Connect device.
mobile-pair-scan = Luam QR code
mobile-pair-show-link = Ntaus txoj link txuas ntawm koj tus kheej
mobile-pair-hide-link = Zais txoj link txuas
mobile-pair-link-placeholder = Muab txoj link txuas los
mobile-pair-connect = Txuas
mobile-pair-connecting = Tab tom txuas…
mobile-pair-disconnect = Tshem txuas
mobile-status-connected = Txuas lawm
mobile-status-reaching = Tab tom nrhiav koj lub Mac…
mobile-status-disconnected = Tsis txuas

mobile-url-invalid = Txoj URL txuas tsis raug.
mobile-url-no-address = Txoj URL txuas tsis muaj chaw nyob server.
mobile-url-bad-address = Txoj URL txuas muaj chaw nyob server tsis raug.
mobile-url-no-token = Txoj URL txuas tsis muaj token.
mobile-url-scheme = Txoj URL txuas yuav tsum siv HTTPS los yog HTTP.
mobile-url-paste-full = Muab tag nrho txoj URL txuas uas Vmux qhia hauv koj lub Mac los.

mobile-error-pairing-outdated = Qhov txuas no qub lawm. Rov luam QR hauv koj lub Mac dua.
mobile-error-pairing-expired = Qhov txuas tas sijhawm lawm. Rov luam QR hauv koj lub Mac dua.
mobile-error-pairing-lost = Qhov txuas tas sijhawm lawm. Rov txuas nrog lub Mac dua.
mobile-error-token-rejected = Tsis lees paub tus token txuas.
mobile-error-stack-missing = Lub computer qhib chat lawm, tiam sis nws lub stack tsis tshwm.
mobile-error-not-offered = Koj lub Mac tseem tsis tau muaj qhov no.
mobile-error-remote-disabled = Remote raug kaw hauv koj lub Mac.
mobile-error-session-gone = Lub session ntawd ploj lawm.
mobile-error-no-desktop = Qhib lub qhov rais Vmux hauv koj lub Mac.
mobile-error-refused = Koj lub Mac ua tsis tau li ntawd.
mobile-error-no-answer = Tsis muaj lus teb los ntawm { $address } tom qab { $seconds } vib nas this.

mobile-start-stacks = Stacks
mobile-start-no-stacks = Tsis muaj stack qhib
mobile-start-team = Pab pawg
mobile-start-search-placeholder = Nrhiav lossis nug…
mobile-start-new-chat = Pib chat
mobile-start-starting = Tab tom pib…

mobile-chat-back = Rov qab
mobile-chat-back-to-stacks = Rov qab mus rau stacks
mobile-chat-no-messages = Tseem tsis muaj lus.
mobile-chat-no-session = Tsis muaj session ua haujlwm
...
mobile-qr-unavailable = QR scanner siv tsis tau.
mobile-qr-camera-unavailable = Koob yees duab siv tsis tau. Ntaus txoj link txuas hloov chaw.
mobile-qr-camera-failed = Qhib koob yees duab tsis tau: { $error }
mobile-qr-camera-input-unavailable = Koob yees duab tsis muaj input.
mobile-qr-unsupported-device = Luam QR siv tsis tau hauv lub cuab yeej no.
mobile-qr-unsupported-platform = Luam QR tseem siv tsis tau hauv lub platform no. Ntaus txoj link txuas hloov chaw.
mobile-error-unexpected-answer = Koj lub Mac teb tsis raws li xav.
mobile-error-connection-dropped = Qhov txuas mus rau koj lub Mac tu lawm.
...
mobile-demo-open = Mus ncig saib tsis siv Mac
mobile-demo-exit = Tawm ntawm qhov ncig saib
mobile-status-demo = Ncig saib
mobile-demo-session-title = Kho cov nqi tag nrho ntawm cov ntawv yuav khoom
mobile-demo-prompt = Cov nqi tag nrho txawv ib xees rau cov tawb uas muaj ntau yam khoom. Koj puas pom qhov laj thawj?
mobile-demo-thinking = Yog tias txhua kab raug rounded ua ntej sib ntxiv, ces yuav piav tau qhov txawv ib xees. Kuv tab tom saib seb cov nqi tag nrho raug xam li cas.
mobile-demo-answer = Cov nqi tag nrho raug xam ua tus lej float, yog li txhua kab raug rounded ua ntej ntxiv. Yog muab cov nqi tag nrho ua hom Cents, nws yuav nyob hauv kev xam lej integer thiab qhov txawv yuav ploj.
