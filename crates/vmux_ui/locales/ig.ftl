...
knowledge-search = Chọọ ihe ọmụma
knowledge-no-match = Enweghị ndetu dakọtara
knowledge-open-linked-note = Mepee ndetu ejikọrọ
knowledge-create-linked-note = Mepụta ndetu ejikọrọ
editor-properties = Njirimara
editor-no-properties = Enweghị akụrụngwa
editor-add-tags = Tinye mkpado
editor-add-property = Tinye ihe onwunwe
editor-change-property-type = Gbanwee ụdị ihe onwunwe
editor-add-tag = Tinye mkpado
editor-add-item = Tinye ihe
editor-linked-note = ndetu ejikọrọ
editor-property-value = Uru
editor-delete-property = Hichapụ ihe onwunwe
editor-property-kind-text = Ederede
editor-property-kind-number = Nọmba
editor-property-kind-checkbox = Igbe nbanye
editor-property-kind-date = Ụbọchị
...
mobile-demo-open = Gaa njem na-enweghị Mac
mobile-demo-exit = Pụọ na njem
mobile-status-demo = Njem
mobile-demo-session-title = Dozie ngụkọta iwu
mobile-demo-prompt = Ngụkọta iwu na-ehie otu sent na ụgbọ ahịa nwere ọtụtụ ihe. Ị nwere ike ịchọta ihe kpatara ya?
mobile-demo-thinking = Ịgbakọ ahịrị ọ bụla tupu ịchịkọta ha ga-akọwa ọdịiche otu sent. Ana m ele anya ka esi ewulite ngụkọta.
mobile-demo-answer = A na-ewere ngụkọta ahụ dị ka nọmba float, ya mere e gbakọtara ahịrị ọ bụla tupu etinye ya. Inye ngụkọta ahụ ụdị Cents na-eme ka ọ nọgide na mgbakọ nọmba zuru ezu, ọdịiche ahụ akwụsịkwa.
