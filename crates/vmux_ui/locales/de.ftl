...
schema-update-channel = Release-Kanal
schema-update-channel-detail = Stabil erhält veröffentlichte Versionen. Vorschau erhält nächtliche Builds.
schema-update-channel-stable = Stabil
schema-update-channel-preview = Vorschau
...
command-rotate-forward = Layout > Bereich > Bereiche vorwärts drehen
command-rotate-backward = Layout > Bereich > Bereiche rückwärts drehen
command-mirror-panes = Layout > Bereich > Bereiche spiegeln
command-mirror-panes-horizontal = Layout > Bereich > Bereiche horizontal spiegeln
command-mirror-panes-vertical = Layout > Bereich > Bereiche vertikal spiegeln
...
mobile-nav-untitled-chat = Unbenannter Chat
mobile-nav-launcher = Start
mobile-nav-new-tab = Neuer Tab
mobile-nav-unsupported = Auf diesem Gerät nicht verfügbar
mobile-nav-read-only = Schreibgeschützt
mobile-nav-open-on-mac = Auf dem Mac öffnen
mobile-nav-url-placeholder = Fragen oder URL einfügen…
...
git-commits = Commits
git-log = Verlauf
git-command-log = Befehlsprotokoll
git-command-log-empty = Git-Aktionen werden hier angezeigt.
git-command-error = Fehler
git-repository = Git-Repository
git-changes = Änderungen
git-branches = Zweige
git-staged-changes = Bereitgestellte Änderungen
git-unstaged-changes = Nicht bereitgestellte Änderungen
git-repository-clean = Arbeitsverzeichnis ist unverändert
git-select-file = Wähle eine Datei aus, um den Diff anzuzeigen
git-stage = Bereitstellen
git-discard = Verwerfen
git-recent-commits = Letzte Commits
git-no-commits = Noch keine Commits
git-local-branches = Lokale Zweige
git-local = Lokal
git-remote = Remote
git-tags = Tags
git-no-branches = Keine lokalen Zweige
...
git-switch-workspace = Arbeitsbereich wechseln
git-edit-config = Konfigurationsdatei bearbeiten
git-switch-recent-repository = Zu einem kürzlich verwendeten Repository wechseln
git-keybindings = Tastenbelegung
git-checkout = Auschecken
git-new-branch = Neuer Branch
git-delete-branch = Branch löschen
git-stashes = Stashes
git-no-stashes = Keine Stashes
git-stash = Änderungen stashen
git-stash-pop = Stash anwenden und löschen
git-stash-drop = Stash löschen
git-amend = Commit ergänzen
git-rebase = Rebase
git-merge = Zusammenführen
git-fast-forward = Fast-Forward
git-revert-commit = Commit zurücknehmen
git-cherry-pick = Cherry-Pick
git-checkout-commit = Commit auschecken
git-shortcut-panels = Bereiche
git-shortcut-navigate = Navigieren
git-shortcut-help = Tastenkürzel
git-shortcut-title = Git-Tastenkürzel
git-shortcut-description = Verfügbare Tastenkürzel für diese Git-Seite.
git-shortcut-universal = Allgemein
git-shortcut-next-panel = Nächster Bereich
git-shortcut-previous = Vorheriger Eintrag
git-shortcut-next = Nächster Eintrag
