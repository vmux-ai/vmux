...
mobile-chat-allow = Erlauben
mobile-chat-deny = Ablehnen
mobile-chat-allow-prompt = { $name } erlauben?
mobile-chat-enter-to-send = Enter zum Senden
mobile-chat-default-effort = Standardaufwand
