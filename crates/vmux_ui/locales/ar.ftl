...
mobile-chat-allow = السماح
mobile-chat-deny = رفض
mobile-chat-allow-prompt = السماح بـ { $name }؟
mobile-chat-enter-to-send = Enter للإرسال
mobile-chat-default-effort = الجهد الافتراضي
