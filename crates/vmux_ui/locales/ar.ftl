...
schema-update-channel = قناة الإصدار
schema-update-channel-detail = تتلقى القناة المستقرة الإصدارات المنشورة، وتتلقى قناة المعاينة الإصدارات الليلية.
schema-update-channel-stable = مستقرة
schema-update-channel-preview = معاينة
...
command-rotate-forward = التخطيط > الجزء > تدوير الأجزاء للأمام
command-rotate-backward = التخطيط > الجزء > تدوير الأجزاء للخلف
command-mirror-panes = التخطيط > الجزء > عكس الأجزاء
command-mirror-panes-horizontal = التخطيط > الجزء > عكس الأجزاء أفقيًا
command-mirror-panes-vertical = التخطيط > الجزء > عكس الأجزاء رأسيًا
...
git-status = الحالة
git-files = الملفات
git-commits = الالتزامات
git-log = السجل
git-command-log = سجل الأوامر
git-command-log-empty = ستظهر عمليات Git هنا.
git-command-error = خطأ
git-repository = المستودع
git-changes = التغييرات
git-branches = الفروع
git-staged-changes = التغييرات المرحّلة
git-unstaged-changes = التغييرات غير المرحّلة
git-repository-clean = شجرة العمل نظيفة
git-select-file = اختر ملفًا لمعاينة الفروقات
git-stage = تجهيز
git-discard = تجاهل
git-recent-commits = الإيداعات الأخيرة
git-no-commits = لا توجد إيداعات بعد
git-local-branches = الفروع المحلية
git-local = محلي
git-remote = بعيد
git-tags = وسوم
git-no-branches = لا توجد فروع محلية
...
git-stage-all = تجهيز الكل
git-switch-workspace = تبديل مساحة العمل
git-edit-config = تحرير ملف الإعدادات
git-switch-recent-repository = التبديل إلى مستودع حديث
git-keybindings = اختصارات لوحة المفاتيح
git-checkout = تبديل الفرع
git-new-branch = فرع جديد
git-delete-branch = حذف الفرع
git-stashes = التغييرات المحفوظة
git-no-stashes = لا توجد تغييرات محفوظة
git-stash = حفظ التغييرات
git-stash-pop = تطبيق الحفظ وحذفه
git-stash-drop = حذف الحفظ
git-amend = تعديل الالتزام
git-rebase = إعادة التأسيس
git-merge = دمج
git-fast-forward = تقديم سريع
git-revert-commit = عكس الالتزام
git-cherry-pick = انتقاء الالتزام
git-checkout-commit = الانتقال إلى الالتزام
git-shortcut-panels = اللوحات
git-shortcut-navigate = تنقّل
git-shortcut-help = الاختصارات
git-shortcut-title = اختصارات Git
git-shortcut-description = الاختصارات المتاحة لصفحة Git هذه.
git-shortcut-universal = عامة
git-shortcut-next-panel = اللوحة التالية
git-shortcut-previous = العنصر السابق
git-shortcut-next = العنصر التالي
