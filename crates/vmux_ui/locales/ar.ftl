...
mobile-demo-open = جرّب جولة بدون Mac
mobile-demo-exit = إنهاء الجولة
mobile-status-demo = جولة
mobile-demo-session-title = إصلاح إجماليات الطلبات
mobile-demo-prompt = إجمالي الطلب يختلف بمقدار سنت واحد في السلال متعددة العناصر. هل يمكنك إيجاد السبب؟
mobile-demo-thinking = تقريب كل سطر قبل الجمع يفسّر انحرافًا بمقدار سنت واحد. سأتحقق من طريقة حساب الإجمالي.
mobile-demo-answer = كان المجموع يُستنتج كعدد عشري، فيُقرَّب كل سطر قبل إضافته. تحديد نوع الإجمالي على أنه Cents يُبقيه في حساب الأعداد الصحيحة ويزول الانحراف.
