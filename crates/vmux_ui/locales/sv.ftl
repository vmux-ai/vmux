...
mobile-chat-allow = Tillåt
mobile-chat-deny = Neka
mobile-chat-allow-prompt = Tillåt { $name }?
mobile-chat-enter-to-send = Enter för att skicka
mobile-chat-default-effort = Standardinsats
