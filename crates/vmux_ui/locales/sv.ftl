...
knowledge-search = Sök Kunskap
knowledge-no-match = Inga matchande anteckningar
knowledge-open-linked-note = Öppna länkad anteckning
knowledge-create-linked-note = Skapa länkad anteckning
editor-properties = Egenskaper
editor-no-properties = Inga fastigheter
editor-add-tags = Lägg till taggar
editor-add-property = Lägg till egendom
editor-change-property-type = Ändra egenskapstyp
editor-add-tag = Lägg till tagg
editor-add-item = Lägg till objekt
editor-linked-note = Länkad anteckning
editor-property-value = Värde
editor-delete-property = Ta bort egendom
editor-property-kind-text = Text
editor-property-kind-number = Antal
editor-property-kind-checkbox = Kryssruta
...
mobile-pair-title = Anslut till din Mac
mobile-pair-subtitle = Öppna Remote i Vmux och välj Connect device.
mobile-pair-scan = Skanna QR-kod
mobile-pair-show-link = Ange parkopplingslänk manuellt
mobile-pair-hide-link = Dölj parkopplingslänk
mobile-pair-link-placeholder = Klistra in parkopplingslänk
mobile-pair-connect = Anslut
mobile-pair-connecting = Ansluter…
mobile-pair-disconnect = Koppla från
mobile-status-connected = Ansluten
mobile-status-reaching = Kontaktar din Mac…
mobile-status-disconnected = Inte ansluten

mobile-url-invalid = Parkopplings-URL:en är ogiltig.
mobile-url-no-address = Parkopplings-URL:en saknar serveradress.
mobile-url-bad-address = Parkopplings-URL:en har en ogiltig serveradress.
mobile-url-no-token = Parkopplings-URL:en saknar token.
mobile-url-scheme = Parkopplings-URL:en måste använda HTTPS eller HTTP.
mobile-url-paste-full = Klistra in hela parkopplings-URL:en som Vmux visar på din Mac.

mobile-error-pairing-outdated = Parkopplingen är inaktuell. Skanna QR-koden på din Mac igen.
mobile-error-pairing-expired = Parkopplingen har gått ut. Skanna QR-koden på din Mac igen.
mobile-error-pairing-lost = Parkopplingen har gått ut. Parkoppla med din Mac igen.
mobile-error-token-rejected = Parkopplingstoken avvisades.
mobile-error-stack-missing = Datorn öppnade chatten, men dess stack dök aldrig upp.
mobile-error-not-offered = Din Mac erbjuder inte detta ännu.
mobile-error-remote-disabled = Remote är avstängt på din Mac.
mobile-error-session-gone = Den sessionen finns inte längre.
mobile-error-no-desktop = Öppna Vmux-fönstret på din Mac.
mobile-error-refused = Din Mac kunde inte göra det.
mobile-error-no-answer = Inget svar från { $address } efter { $seconds } s.

mobile-start-stacks = Stackar
mobile-start-no-stacks = Inga öppna stackar
mobile-start-team = Team
mobile-start-search-placeholder = Sök eller fråga…
mobile-start-new-chat = Starta chatt
mobile-start-starting = Startar…

mobile-chat-back = Tillbaka
mobile-chat-back-to-stacks = Tillbaka till stackar
mobile-chat-no-messages = Inga meddelanden än.
mobile-chat-no-session = Ingen aktiv session
mobile-chat-placeholder = Skriv till agenten…
mobile-chat-send = Skicka
mobile-chat-stop = Stoppa

mobile-qr-title = Skanna QR-koden som Vmux visar
mobile-qr-cancel = Avbryt
mobile-qr-unavailable = QR-skannern är inte tillgänglig.
mobile-qr-camera-unavailable = Kameran är inte tillgänglig. Ange parkopplingslänken i stället.
mobile-qr-camera-failed = Det gick inte att öppna kameran: { $error }
mobile-qr-camera-input-unavailable = Kameraingången är inte tillgänglig.
mobile-qr-unsupported-device = QR-skanning är inte tillgänglig på den här enheten.
mobile-qr-unsupported-platform = QR-skanning är inte tillgänglig på den här plattformen ännu. Ange parkopplingslänken i stället.
mobile-error-unexpected-answer = Din Mac svarade oväntat.
mobile-error-connection-dropped = Anslutningen till din Mac bröts.
...
mobile-demo-open = Ta en rundtur utan Mac
mobile-demo-exit = Avsluta rundturen
mobile-status-demo = Rundtur
mobile-demo-session-title = Fixa ordersummor
mobile-demo-prompt = Ordersumman blir en cent fel för kundvagnar med flera artiklar. Kan du hitta felet?
mobile-demo-thinking = Att avrunda varje rad före summeringen skulle förklara en avvikelse på en cent. Kollar hur summan byggs upp.
mobile-demo-answer = Summan härleddes som float, så varje rad avrundades innan den lades till. Om summan typas som Cents stannar den i heltalsaritmetik och avvikelsen försvinner.
