...
knowledge-search = د پوهې لټون
knowledge-no-match = د سمون یادښتونه نشته
knowledge-open-linked-note = تړل شوی یادداشت خلاص کړئ
knowledge-create-linked-note = تړل شوی یادښت جوړ کړئ
editor-properties = ملکیتونه
editor-no-properties = هیڅ ملکیت نشته
editor-add-tags = ټګونه اضافه کړئ
editor-add-property = ملکیت اضافه کړئ
editor-change-property-type = د ملکیت ډول بدل کړئ
editor-add-tag = ټګ اضافه کړئ
editor-add-item = توکي اضافه کړئ
editor-linked-note = تړل شوی یادښت
editor-property-value = ارزښت
editor-delete-property = ملکیت ړنګ کړئ
editor-property-kind-text = متن
editor-property-kind-number = شمیره
editor-property-kind-checkbox = چک بکس
editor-property-kind-date = نیټه
...
mobile-pair-title = له خپل Mac سره ونښلئ
mobile-pair-subtitle = په Vmux کې Remote پرانیزئ او Connect device وټاکئ.
mobile-pair-scan = QR کوډ سکن کړئ
mobile-pair-show-link = د پیرنګ لینک په لاس ولیکئ
mobile-pair-hide-link = د پیرنګ لینک پټ کړئ
mobile-pair-link-placeholder = د پیرنګ لینک پیست کړئ
mobile-pair-connect = ونښلئ
mobile-pair-connecting = نښلي…
mobile-pair-disconnect = پرې کړئ
mobile-status-connected = نښلول شوی
mobile-status-reaching = ستاسو Mac لټول کېږي…
mobile-status-disconnected = تړلی نه دی

mobile-url-invalid = د پیرنګ URL ناسم دی.
mobile-url-no-address = د پیرنګ URL کې د سرور پته نشته.
mobile-url-bad-address = د پیرنګ URL کې د سرور پته ناسمه ده.
mobile-url-no-token = د پیرنګ URL کې ټوکن نشته.
mobile-url-scheme = د پیرنګ URL باید HTTPS یا HTTP وکاروي.
mobile-url-paste-full = هغه بشپړ د پیرنګ URL پیست کړئ چې Vmux یې ستاسو په Mac کې ښیي.

mobile-error-pairing-outdated = دا پیرنګ زوړ شوی. په خپل Mac کې QR بیا سکن کړئ.
mobile-error-pairing-expired = د پیرنګ موده پای ته رسېدلې. په خپل Mac کې QR بیا سکن کړئ.
mobile-error-pairing-lost = د پیرنګ موده پای ته رسېدلې. له Mac سره بیا پیرنګ وکړئ.
mobile-error-token-rejected = د پیرنګ ټوکن رد شو.
mobile-error-stack-missing = ډېسکټاپ خبرې اترې پرانیستې، خو سټک یې ښکاره نه شو.
mobile-error-not-offered = ستاسو Mac دا لا نه وړاندې کوي.
mobile-error-remote-disabled = ستاسو په Mac کې Remote مړ دی.
mobile-error-session-gone = هغه ناسته نور نشته.
mobile-error-no-desktop = په خپل Mac کې د Vmux کړکۍ پرانیزئ.
mobile-error-refused = ستاسو Mac دا ونه شو کولی.
mobile-error-no-answer = د { $seconds } ثانیو وروسته له { $address } څخه ځواب نشته.

mobile-start-stacks = سټکونه
mobile-start-no-stacks = هیڅ پرانیستی سټک نشته
mobile-start-team = ټیم
mobile-start-search-placeholder = ولټوئ یا وپوښتئ…
mobile-start-new-chat = خبرې پیل کړئ
mobile-start-starting = پیلېږي…

mobile-chat-back = شاته
mobile-chat-back-to-stacks = سټکونو ته بېرته
mobile-chat-no-messages = لا هیڅ پیغام نشته.
mobile-chat-no-session = فعاله ناسته نشته
mobile-chat-placeholder = اجنټ ته پیغام…
mobile-chat-send = لېږل
mobile-chat-stop = تمول

mobile-qr-title = هغه QR کوډ سکن کړئ چې Vmux یې ښیي
mobile-qr-cancel = لغوه
mobile-qr-unavailable = د QR سکنر شتون نلري.
mobile-qr-camera-unavailable = کامره شتون نلري. پرځای یې د پیرنګ لینک ولیکئ.
mobile-qr-camera-failed = کامره ونه پرانیستل شوه: { $error }
mobile-qr-camera-input-unavailable = د کامرې ورودي شتون نلري.
mobile-qr-unsupported-device = په دې وسیله کې د QR سکن کول شتون نلري.
mobile-qr-unsupported-platform = په دې پلیټفارم کې د QR سکن کول لا شتون نلري. پرځای یې د پیرنګ لینک ولیکئ.
mobile-error-unexpected-answer = ستاسو Mac ناڅاپي ځواب ورکړ.
mobile-error-connection-dropped = له ستاسو Mac سره اړیکه پرې شوه.
...
mobile-demo-open = پرته له Mac څخه یوه کتنه وکړئ
mobile-demo-exit = له کتنې ووځئ
mobile-status-demo = کتنه
mobile-demo-session-title = د فرمایش ټولې اندازې سمې کړئ
mobile-demo-prompt = په هغو ټوکریو کې چې ډېر توکي لري، د فرمایش ټوله اندازه په یوه سینټ توپیر لري. کولی شئ لامل یې ومومئ؟
mobile-demo-thinking = د راټولولو دمخه د هرې کرښې ګردول به د یوه سینټ توپیر تشریح کړي. ګورم چې ټوله اندازه څنګه جوړېږي.
mobile-demo-answer = ټولګه د float په توګه اټکل کېده، نو هره کرښه د زیاتولو دمخه ګردېده. که ټولې اندازې ته د Cents ډول ورکړل شي، په بشپړ عدد حساب کې پاتې کېږي او توپیر له منځه ځي.
