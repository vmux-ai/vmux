...
mobile-chat-allow = اجازه
mobile-chat-deny = ردول
mobile-chat-allow-prompt = { $name } ته اجازه ورکړئ؟
mobile-chat-enter-to-send = د لېږلو لپاره Enter
mobile-chat-default-effort = اصلي هڅه
