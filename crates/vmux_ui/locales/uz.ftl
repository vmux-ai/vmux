...
knowledge-search = Bilimlarni qidirish
knowledge-no-match = Mos qaydlar yoʻq
knowledge-open-linked-note = Bog'langan qaydni oching
knowledge-create-linked-note = Bog'langan qayd yarating
editor-properties = Xususiyatlari
editor-no-properties = Xususiyatlari yoʻq
editor-add-tags = Teglar qo'shing
editor-add-property = Mulk qo'shing
editor-change-property-type = Mulk turini o'zgartirish
editor-add-tag = Teg qo'shing
editor-add-item = Element qo'shish
editor-linked-note = Bog'langan qayd
editor-property-value = Qiymat
editor-delete-property = Mulkni o'chirish
editor-property-kind-text = Matn
editor-property-kind-number = Raqam
editor-property-kind-checkbox = Belgilash katagi
editor-property-kind-date = Sana
...
mobile-demo-open = Mac bo‘lmasdan sayohat qiling
mobile-demo-exit = Sayohatdan chiqish
mobile-status-demo = Sayohat
mobile-demo-session-title = Buyurtma jamilarini tuzatish
mobile-demo-prompt = Bir nechta mahsulot bor savatlarda buyurtma jami bir sentga xato chiqmoqda. Sababini topa olasizmi?
mobile-demo-thinking = Qo‘shishdan oldin har bir qatorni yaxlitlash bir sentlik farqni tushuntirishi mumkin. Jami qanday hisoblanishini ko‘ryapman.
mobile-demo-answer = Yig‘indi float sifatida taxmin qilingan, shuning uchun har bir qator qo‘shilishdan oldin yaxlitlangan. Jamiga Cents turi berilsa, u butun sonli arifmetikada qoladi va farq yo‘qoladi.
