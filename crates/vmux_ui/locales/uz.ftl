...
mobile-chat-allow = Ruxsat berish
mobile-chat-deny = Rad etish
mobile-chat-allow-prompt = { $name } ga ruxsat berilsinmi?
mobile-chat-enter-to-send = Yuborish uchun Enter
mobile-chat-default-effort = Standart harakat
