...
knowledge-search = Batla Tsebo
knowledge-no-match = Ha ho lintlha tse tsamaellanang
knowledge-open-linked-note = Bula molaetsa o hokahantsoeng
knowledge-create-linked-note = Etsa molaetsa o hokahantsoeng
editor-properties = Thepa
editor-no-properties = Ha ho thepa
editor-add-tags = Kenya li-tag
editor-add-property = Kenya thepa
editor-change-property-type = Fetola mofuta oa thepa
editor-add-tag = Kenya tag
editor-add-item = Kenya ntho
editor-linked-note = Molaetsa o hokahaneng
editor-property-value = Boleng
editor-delete-property = Hlakola thepa
editor-property-kind-text = Mongolo
editor-property-kind-number = Nomoro
editor-property-kind-checkbox = Lebokose la ho hlahloba
editor-property-kind-date = Letsatsi
...
mobile-demo-open = Etsa leeto ntle le Mac
mobile-demo-exit = Tswa leetong
mobile-status-demo = Leeto
mobile-demo-session-title = Lokisa dipalo tsa diodara
mobile-demo-prompt = Palo ya odara e fosahetse ka sente e le nngwe dikoloing tse nang le dintho tse ngata. Na o ka fumana lebaka?
mobile-demo-thinking = Ho potoloha ha mola o mong le o mong pele di kopanngwa ho ka hlalosa phapang ya sente e le nngwe. Ke sheba kamoo palo e ahuwang kateng.
mobile-demo-answer = Kakaretso e ne e nkuwa e le float, kahoo mola o mong le o mong o ne o potolohuwa pele o kenyelletswa. Ho fa kakaretso mofuta wa Cents ho e boloka dipalong tse feletseng mme phapang e a nyamela.
