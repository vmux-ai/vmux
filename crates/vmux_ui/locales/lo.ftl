...
knowledge-search = ຄົ້ນຫາຄວາມຮູ້
knowledge-no-match = ບໍ່ມີບັນທຶກທີ່ກົງກັນ
knowledge-open-linked-note = ເປີດບັນທຶກທີ່ເຊື່ອມຕໍ່
knowledge-create-linked-note = ສ້າງບັນທຶກທີ່ເຊື່ອມໂຍງ
editor-properties = ຄຸນສົມບັດ
editor-no-properties = ບໍ່ມີຄຸນສົມບັດ
editor-add-tags = ເພີ່ມແທັກ
editor-add-property = ເພີ່ມຊັບສິນ
editor-change-property-type = ປ່ຽນປະເພດຊັບສິນ
editor-add-tag = ເພີ່ມແທັກ
editor-add-item = ເພີ່ມລາຍການ
editor-linked-note = ບັນທຶກທີ່ເຊື່ອມຕໍ່
editor-property-value = ມູນຄ່າ
editor-delete-property = ລຶບຊັບສິນ
editor-property-kind-text = ຂໍ້ຄວາມ
editor-property-kind-number = ເລກ
editor-property-kind-checkbox = ປ່ອງໝາຍ
editor-property-kind-date = ວັນທີ
...
mobile-demo-open = ທ່ຽວຊົມໂດຍບໍ່ຕ້ອງມີ Mac
mobile-demo-exit = ອອກຈາກການທ່ຽວຊົມ
mobile-status-demo = ທ່ຽວຊົມ
mobile-demo-session-title = ແກ້ໄຂຍອດລວມຄຳສັ່ງຊື້
mobile-demo-prompt = ຍອດລວມຄຳສັ່ງຊື້ຄາດເຄື່ອນໜຶ່ງເຊັນໃນກະຕ່າທີ່ມີຫຼາຍລາຍການ. ຊອກຫາສາເຫດໄດ້ບໍ?
mobile-demo-thinking = ການປັດເສດແຕ່ລະແຖວກ່ອນລວມກັນຈະອະທິບາຍຄວາມຄາດເຄື່ອນໜຶ່ງເຊັນໄດ້. ກຳລັງກວດເບິ່ງວ່າຍອດລວມຖືກຄິດໄລ່ແນວໃດ.
mobile-demo-answer = ຍອດລວມຖືກອະນຸມານເປັນເລກທົດສະນິຍົມ ດັ່ງນັ້ນແຕ່ລະແຖວຈຶ່ງຖືກປັດເສດກ່ອນຖືກບວກ. ການກຳນົດຊະນິດຂອງຍອດລວມເປັນ Cents ຈະຮັກສາໃຫ້ຢູ່ໃນເລກຈຳນວນເຕັມ ແລະ ຄວາມຄາດເຄື່ອນຈະຫາຍໄປ.
