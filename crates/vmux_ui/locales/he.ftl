...
knowledge-search = חיפוש ידע
knowledge-no-match = אין הערות תואמות
knowledge-open-linked-note = פתח הערה מקושרת
knowledge-create-linked-note = צור הערה מקושרת
editor-properties = נכסים
editor-no-properties = אין נכסים
editor-add-tags = הוסף תגים
editor-add-property = הוסף נכס
editor-change-property-type = שנה את סוג הנכס
editor-add-tag = הוסף תג
editor-add-item = הוסף פריט
editor-linked-note = הערה מקושרת
editor-property-value = עֵרֶך
editor-delete-property = מחק נכס
editor-property-kind-text = טֶקסט
editor-property-kind-number = מִספָּר
editor-property-kind-checkbox = תיבת סימון
editor-property-kind-date = תַאֲרִיך
...
mobile-pair-title = התחברות ל-Mac שלך
mobile-pair-subtitle = ב-Vmux, פתח את Remote ובחר Connect device.
mobile-pair-scan = סרוק קוד QR
mobile-pair-show-link = הזן קישור התחברות ידנית
mobile-pair-hide-link = הסתר קישור התחברות
mobile-pair-link-placeholder = הדבק קישור התחברות
mobile-pair-connect = התחבר
mobile-pair-connecting = מתחבר…
mobile-pair-disconnect = התנתק
mobile-status-connected = מחובר
mobile-status-reaching = מנסה להגיע ל-Mac שלך…
mobile-status-disconnected = לא מחובר

mobile-url-invalid = כתובת ההתחברות אינה תקינה.
mobile-url-no-address = בכתובת ההתחברות אין כתובת שרת.
mobile-url-bad-address = כתובת השרת בקישור ההתחברות אינה תקינה.
mobile-url-no-token = בכתובת ההתחברות אין טוקן.
mobile-url-scheme = כתובת ההתחברות חייבת להשתמש ב-HTTPS או ב-HTTP.
mobile-url-paste-full = הדבק את כתובת ההתחברות המלאה ש-Vmux מציג ב-Mac שלך.

mobile-error-pairing-outdated = ההתאמה הזו אינה עדכנית. סרוק שוב את ה-QR ב-Mac שלך.
mobile-error-pairing-expired = ההתאמה פגה. סרוק שוב את ה-QR ב-Mac שלך.
mobile-error-pairing-lost = ההתאמה פגה. בצע התאמה מחדש עם ה-Mac.
mobile-error-token-rejected = טוקן ההתאמה נדחה.
mobile-error-stack-missing = המחשב פתח את הצ׳אט, אבל הערימה שלו לא הופיעה.
mobile-error-not-offered = ה-Mac שלך עדיין לא מציע את זה.
mobile-error-remote-disabled = Remote כבוי ב-Mac שלך.
mobile-error-session-gone = הסשן הזה כבר לא קיים.
mobile-error-no-desktop = פתח את חלון Vmux ב-Mac שלך.
mobile-error-refused = ה-Mac שלך לא הצליח לעשות זאת.
mobile-error-no-answer = אין תשובה מ-{ $address } אחרי { $seconds } שניות.

mobile-start-stacks = ערימות
mobile-start-no-stacks = אין ערימות פתוחות
mobile-start-team = צוות
mobile-start-search-placeholder = חפש או שאל…
mobile-start-new-chat = התחל צ׳אט
mobile-start-starting = מתחיל…

mobile-chat-back = חזור
mobile-chat-back-to-stacks = חזרה לערימות
mobile-chat-no-messages = אין עדיין הודעות.
mobile-chat-no-session = אין סשן פעיל
...
mobile-qr-unavailable = סורק ה-QR אינו זמין.
mobile-qr-camera-unavailable = המצלמה אינה זמינה. הזן את קישור ההתחברות במקום זאת.
mobile-qr-camera-failed = לא ניתן לפתוח את המצלמה: { $error }
mobile-qr-camera-input-unavailable = קלט המצלמה אינו זמין.
mobile-qr-unsupported-device = סריקת QR אינה זמינה במכשיר הזה.
mobile-qr-unsupported-platform = סריקת QR עדיין אינה זמינה בפלטפורמה הזו. הזן את קישור ההתחברות במקום זאת.
mobile-error-unexpected-answer = ה-Mac שלך השיב תשובה לא צפויה.
mobile-error-connection-dropped = החיבור ל-Mac שלך נותק.
...
mobile-demo-open = סיור בלי Mac
mobile-demo-exit = יציאה מהסיור
mobile-status-demo = סיור
mobile-demo-session-title = תיקון סכומי ההזמנה
mobile-demo-prompt = סכום ההזמנה סוטה בסנט אחד בעגלות עם כמה פריטים. תוכל למצוא למה?
mobile-demo-thinking = עיגול של כל שורה לפני החיבור יסביר סטייה של סנט אחד. בודק איך הסכום מחושב.
mobile-demo-answer = הסכום הוסק כמספר עשרוני, ולכן כל שורה עוגלה לפני שנוספה. הגדרת הסכום כטיפוס Cents שומרת אותו בחשבון שלמים והסטייה נעלמת.
