...
knowledge-search = Caută cunoștințe
knowledge-no-match = Nicio notă care se potrivește
knowledge-open-linked-note = Deschideți nota legată
knowledge-create-linked-note = Creați o notă legată
editor-properties = Proprietăți
editor-no-properties = Fără proprietăți
editor-add-tags = Adăugați etichete
editor-add-property = Adăugați proprietate
editor-change-property-type = Schimbați tipul proprietății
editor-add-tag = Adăugați etichetă
editor-add-item = Adăugați articol
editor-linked-note = Notă legată
editor-property-value = Valoare
editor-delete-property = Ștergeți proprietatea
editor-property-kind-text = Text
editor-property-kind-number = Număr
editor-property-kind-checkbox = Caseta de selectare
...
mobile-demo-open = Fă un tur fără Mac
mobile-demo-exit = Ieși din tur
mobile-status-demo = Tur
mobile-demo-session-title = Repară totalurile comenzilor
mobile-demo-prompt = Totalul comenzii diferă cu un cent la coșurile cu mai multe produse. Poți găsi cauza?
mobile-demo-thinking = Rotunjirea fiecărei linii înainte de însumare ar explica o abatere de un cent. Verific cum se calculează totalul.
mobile-demo-answer = Suma era dedusă ca float, așa că fiecare linie era rotunjită înainte de a fi adunată. Tipizarea totalului ca Cents îl păstrează în aritmetică pe numere întregi și abaterea dispare.
