...
knowledge-search = Pilarian Pangaweruh
knowledge-no-match = Taya catetan cocog
knowledge-open-linked-note = Buka catetan numbu
knowledge-create-linked-note = Jieun catetan numbu
editor-properties = Pasipatan
editor-no-properties = Taya sipat
editor-add-tags = Tambahkeun tag
editor-add-property = Tambahkeun harta
editor-change-property-type = Robah tipe sipat
editor-add-tag = Tambahkeun tag
editor-add-item = Tambahkeun item
editor-linked-note = Catetan numbu
editor-property-value = Nilai
editor-delete-property = Hapus harta
editor-property-kind-text = Téks
editor-property-kind-number = Jumlah
editor-property-kind-checkbox = Kotak centang
editor-property-kind-date = titimangsa
...
mobile-pair-title = Sambungkeun ka Mac anjeun
mobile-pair-subtitle = Dina Vmux, buka Remote terus pilih Connect device.
mobile-pair-scan = Pindai kode QR
mobile-pair-show-link = Asupkeun tautan pasangan sacara manual
mobile-pair-hide-link = Sumputkeun tautan pasangan
mobile-pair-link-placeholder = Témpélkeun tautan pasangan
mobile-pair-connect = Nyambung
mobile-pair-connecting = Keur nyambung…
mobile-pair-disconnect = Pegatkeun
mobile-status-connected = Nyambung
mobile-status-reaching = Keur ngahubungan Mac anjeun…
mobile-status-disconnected = Teu nyambung

mobile-url-invalid = URL pasangan teu valid.
mobile-url-no-address = URL pasangan teu boga alamat server.
mobile-url-bad-address = URL pasangan boga alamat server nu teu valid.
mobile-url-no-token = URL pasangan teu boga token.
mobile-url-scheme = URL pasangan kudu maké HTTPS atawa HTTP.
mobile-url-paste-full = Témpélkeun sakabéh URL pasangan nu ditémbongkeun ku Vmux dina Mac anjeun.

mobile-error-pairing-outdated = Pasangan ieu geus kadaluwarsa. Pindai deui QR dina Mac anjeun.
mobile-error-pairing-expired = Pasangan geus béak. Pindai deui QR dina Mac anjeun.
mobile-error-pairing-lost = Pasangan geus béak. Pasangkeun deui jeung Mac.
mobile-error-token-rejected = Token pasangan ditampik.
mobile-error-stack-missing = Desktop muka obrolan, tapi tumpukanana teu bijil.
mobile-error-not-offered = Mac anjeun tacan nyadiakeun ieu.
mobile-error-remote-disabled = Remote dipareuman dina Mac anjeun.
mobile-error-session-gone = Sési éta geus euweuh.
mobile-error-no-desktop = Buka jandéla Vmux dina Mac anjeun.
mobile-error-refused = Mac anjeun teu bisa ngalakukeun éta.
mobile-error-no-answer = Teu aya waleran ti { $address } sanggeus { $seconds } detik.

mobile-start-stacks = Tumpukan
mobile-start-no-stacks = Euweuh tumpukan nu muka
mobile-start-team = Tim
mobile-start-search-placeholder = Téangan atawa tanya…
mobile-start-new-chat = Mimitian obrolan
mobile-start-starting = Keur ngamimitian…

mobile-chat-back = Balik
mobile-chat-back-to-stacks = Balik ka tumpukan
mobile-chat-no-messages = Tacan aya pesen.
mobile-chat-no-session = Euweuh sési nu aktif
...
mobile-qr-unavailable = Pemindai QR teu sadia.
mobile-qr-camera-unavailable = Kaméra teu sadia. Asupkeun tautan pasangan waé.
mobile-qr-camera-failed = Teu bisa muka kaméra: { $error }
mobile-qr-camera-input-unavailable = Asupan kaméra teu sadia.
mobile-qr-unsupported-device = Mindai QR teu sadia dina alat ieu.
mobile-qr-unsupported-platform = Mindai QR tacan sadia dina platform ieu. Asupkeun tautan pasangan waé.
mobile-error-unexpected-answer = Mac anjeun ngawaler teu kaduga.
mobile-error-connection-dropped = Sambungan ka Mac anjeun pegat.
...
mobile-demo-open = Coba tur tanpa Mac
mobile-demo-exit = Kaluar ti tur
mobile-status-demo = Tur
mobile-demo-session-title = Menerkeun total pesenan
mobile-demo-prompt = Total pesenan salah sasen dina karanjang nu eusina loba barang. Bisa manggihan sababna?
mobile-demo-thinking = Ngabuletkeun unggal baris saméméh dijumlahkeun bisa ngajelaskeun béda sasen. Keur mariksa kumaha total diitungna.
mobile-demo-answer = Jumlahna disimpulkeun jadi float, jadi unggal baris dibuletkeun saméméh ditambahkeun. Lamun total dibéré tipe Cents, itungan tetep dina wilangan buleud jeung bédana leungit.
