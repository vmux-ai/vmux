...
knowledge-search = Raadi Aqoon
knowledge-no-match = Ma jiraan qoraallo u dhigma
knowledge-open-linked-note = Fur qoraal ku xidhan
knowledge-create-linked-note = Samee qoraal ku xidhan
editor-properties = Guryaha
editor-no-properties = Guryo malaha
editor-add-tags = Ku dar tags
editor-add-property = Hanti ku dar
editor-change-property-type = Beddel hantida
editor-add-tag = Ku dar tag
editor-add-item = Ku dar shayga
editor-linked-note = Qoraal ku xidhan
editor-property-value = Qiimaha
editor-delete-property = Tirtir hantida
editor-property-kind-text = Qoraal
editor-property-kind-number = Lambarka
editor-property-kind-checkbox = Sanduuqa hubinta
editor-property-kind-date = Taariikhda
...
mobile-pair-title = Ku xidhnow Mac-kaaga
mobile-pair-subtitle = Vmux dhexdiisa, fur Remote oo dooro Connect device.
mobile-pair-scan = Iskaan QR code
mobile-pair-show-link = Gacanta ku gali linkiga isku xidhka
mobile-pair-hide-link = Qari linkiga isku xidhka
mobile-pair-link-placeholder = Ku dheji linkiga isku xidhka
mobile-pair-connect = Ku xidhnow
mobile-pair-connecting = Waa la xidhiidhayaa…
mobile-pair-disconnect = Ka go'
mobile-status-connected = Waa la xidhiidhay
mobile-status-reaching = Mac-kaaga waa la gaadhayaa…
mobile-status-disconnected = Lama xidhiidhin

mobile-url-invalid = URL-ka isku xidhka waa khaldan yahay.
mobile-url-no-address = URL-ka isku xidhka ma laha cinwaan server.
mobile-url-bad-address = URL-ka isku xidhka wuxuu leeyahay cinwaan server oo khaldan.
mobile-url-no-token = URL-ka isku xidhka ma laha token.
mobile-url-scheme = URL-ka isku xidhka waa inuu isticmaalaa HTTPS ama HTTP.
mobile-url-paste-full = Ku dheji URL-ka isku xidhka ee dhammaystiran oo Vmux ku muujinayo Mac-kaaga.

mobile-error-pairing-outdated = Isku xidhkani waa duugoobay. Mar kale iskaan QR-ka Mac-kaaga.
mobile-error-pairing-expired = Isku xidhku wuu dhacay. Mar kale iskaan QR-ka Mac-kaaga.
mobile-error-pairing-lost = Isku xidhku wuu dhacay. Mar kale la xidhiidh Mac-ka.
mobile-error-token-rejected = Token-ka isku xidhka waa la diiday.
mobile-error-stack-missing = Deskoobku wuu furay chat-ka, laakiin lakabkiisu ma soo bixin.
mobile-error-not-offered = Mac-kaagu weli tan ma bixiyo.
mobile-error-remote-disabled = Remote waa lagu damiyay Mac-kaaga.
mobile-error-session-gone = Fadhigaas waa tegey.
mobile-error-no-desktop = Fur daaqadda Vmux ee Mac-kaaga.
mobile-error-refused = Mac-kaagu taas ma samayn karin.
mobile-error-no-answer = Jawaab kama imanin { $address } { $seconds } ilbiriqsi kadib.

mobile-start-stacks = Lakabyo
mobile-start-no-stacks = Lakabyo furan ma jiraan
mobile-start-team = Koox
mobile-start-search-placeholder = Raadi ama weydii…
mobile-start-new-chat = Bilow chat
mobile-start-starting = Waa la bilaabayaa…

mobile-chat-back = Dib
mobile-chat-back-to-stacks = Ku noqo lakabyada
mobile-chat-no-messages = Weli farriimo ma jiraan.
mobile-chat-no-session = Fadhi firfircoon ma jiro
...
mobile-qr-unavailable = Iskaanka QR lama heli karo.
mobile-qr-camera-unavailable = Kamaradu ma jirto. Halkii geli linkiga isku xidhka.
mobile-qr-camera-failed = Kamarada lama furi karin: { $error }
mobile-qr-camera-input-unavailable = Gelinta kamarada lama heli karo.
mobile-qr-unsupported-device = Iskaanka QR lagama heli karo qalabkan.
mobile-qr-unsupported-platform = Iskaanka QR weli laguma heli karo goobtan. Halkii geli linkiga isku xidhka.
mobile-error-unexpected-answer = Mac-kaagu si lama filaan ah ayuu u jawaabay.
mobile-error-connection-dropped = Xidhiidhka Mac-kaaga wuu go'ay.
...
mobile-demo-open = Soo booqo Mac la'aan
mobile-demo-exit = Ka bax booqashada
mobile-status-demo = Booqasho
mobile-demo-session-title = Hagaaji wadarta dalabka
mobile-demo-prompt = Wadarta dalabka waxay ku khaldan tahay hal sent gaadhiyada leh alaab badan. Ma heli kartaa sababta?
mobile-demo-thinking = Soo koobidda sadar kasta ka hor inta aan la isku darin ayaa sharxi karta kala duwanaanshaha hal sent. Waxaan eegayaa sida wadarta loo xisaabiyo.
mobile-demo-answer = Wadarta waxaa loo qaatay float, sidaas darteed sadar kasta waa la soo koobay ka hor inta aan lagu darin. Haddii wadarta loo nooceeyo Cents, waxay ku sii jirtaa xisaabta tirooyinka buuxa, kala duwanaanshuhuna wuu baaba'ayaa.
