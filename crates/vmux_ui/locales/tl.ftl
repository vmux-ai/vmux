...
mobile-pair-show-link = Manu-manong ilagay ang pairing link
...
mobile-status-connected = Konektado
mobile-status-reaching = Inaabot ang iyong Mac…
mobile-status-disconnected = Hindi konektado
...
mobile-error-pairing-expired = Nag-expire na ang pairing. I-scan muli ang QR sa iyong Mac.
mobile-error-pairing-lost = Nag-expire na ang pairing. Muling ipares sa Mac.
mobile-error-token-rejected = Tinanggihan ang pairing token.
mobile-error-stack-missing = Binuksan ng desktop ang chat, pero hindi lumitaw ang stack nito.
...
mobile-error-no-desktop = Buksan ang Vmux window sa iyong Mac.
mobile-error-refused = Hindi iyon nagawa ng iyong Mac.
mobile-error-no-answer = Walang sagot mula sa { $address } pagkalipas ng { $seconds } segundo.
...
mobile-demo-open = Mag-tour nang walang Mac
mobile-demo-exit = Lumabas sa tour
mobile-status-demo = Tour
mobile-demo-session-title = Ayusin ang kabuuan ng order
mobile-demo-prompt = Mali nang isang sentimo ang kabuuan ng order sa mga cart na maraming item. Mahahanap mo ba ang dahilan?
mobile-demo-thinking = Ang pag-round sa bawat linya bago isama sa kabuuan ang magpapaliwanag sa isang sentimong pagkakaiba. Tinitingnan ko kung paano binubuo ang kabuuan.
mobile-demo-answer = Na-infer ang sum bilang float, kaya na-round ang bawat linya bago idagdag. Kapag Cents ang tipo ng kabuuan, mananatili itong nasa integer arithmetic at mawawala ang pagkakaiba.
