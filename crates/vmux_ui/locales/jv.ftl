...
mobile-demo-open = Tur tanpa Mac
mobile-demo-exit = Metu saka tur
mobile-status-demo = Tur
mobile-demo-session-title = Ndandani total pesenan
mobile-demo-prompt = Total pesenan mlèsèt sak sen ing karanjang sing isiné pirang-pirang barang. Bisa nemokaké sebabé?
mobile-demo-thinking = Yèn saben baris dibunderaké sadurungé dijumlah, kuwi bisa nerangaké sélisih sak sen. Aku ndelok kepriyé total kuwi diitung.
mobile-demo-answer = Jumlahé disimpulaké minangka float, mula saben baris dibunderaké sadurungé ditambahaké. Nyetèl tipe total dadi Cents njaga étungan tetep ing wilangan bulat lan sélisihé ilang.
