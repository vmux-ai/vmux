...
knowledge-search = Rannsachadh Eòlais
knowledge-no-match = Gun notaichean co-ionnan
knowledge-open-linked-note = Fosgail nota ceangailte
knowledge-create-linked-note = Cruthaich nota ceangailte
editor-properties = Feartan
editor-no-properties = Gun seilbh
editor-add-tags = Cuir tagaichean ris
editor-add-property = Cuir seilbh ris
editor-change-property-type = Atharraich an seòrsa seilbh
editor-add-tag = Cuir taga ris
editor-add-item = Cuir ris an nì
editor-linked-note = Nota ceangailte
editor-property-value = Luach
editor-delete-property = Sguab às seilbh
editor-property-kind-text = Teacs
editor-property-kind-number = Aireamh
editor-property-kind-checkbox = Bogsa-seic
editor-property-kind-date = Ceann-latha
...
mobile-demo-open = Gabh cuairt gun Mac
mobile-demo-exit = Fàg a’ chuairt
mobile-status-demo = Cuairt
mobile-demo-session-title = Càraich iomlain nan òrdughan
mobile-demo-prompt = Tha iomlan an òrduigh ceàrr le aon sgillinn ann an cairtean le grunn nithean. Am faigh thu a-mach carson?
mobile-demo-thinking = Nam biodh gach loidhne air a chuairteachadh mus tèid an cur ri chèile, mhìnicheadh sin diofar de dh’aon sgillinn. Tha mi a’ coimhead air mar a thathar a’ togail an iomlain.
mobile-demo-answer = Bha an t-suim ga co-dhùnadh mar àireamh air fleòd, agus mar sin bha gach loidhne ga cuairteachadh mus deach a cur ris. Ma bheirear an seòrsa Cents don iomlan, fanaidh e ann an àireamhachd shlàn agus falbhaidh an diofar.
