...
mobile-chat-allow = อนุญาต
mobile-chat-deny = ปฏิเสธ
mobile-chat-allow-prompt = อนุญาต { $name } หรือไม่
mobile-chat-enter-to-send = กด Enter เพื่อส่ง
mobile-chat-default-effort = ระดับความพยายามเริ่มต้น
