...
knowledge-no-match = ไม่มีบันทึกที่ตรงกัน
knowledge-open-linked-note = เปิดบันทึกที่เชื่อมโยง
knowledge-create-linked-note = สร้างบันทึกที่เชื่อมโยง
editor-properties = คุณสมบัติ
editor-no-properties = ไม่มีคุณสมบัติ
editor-add-tags = เพิ่มแท็ก
editor-add-property = เพิ่มคุณสมบัติ
editor-change-property-type = เปลี่ยนประเภททรัพย์สิน
editor-add-tag = เพิ่มแท็ก
editor-add-item = เพิ่มรายการ
editor-linked-note = บันทึกที่เชื่อมโยง
editor-property-value = ค่า
editor-delete-property = ลบคุณสมบัติ
editor-property-kind-text = ข้อความ
editor-property-kind-number = ตัวเลข
editor-property-kind-checkbox = ช่องทำเครื่องหมาย
editor-property-kind-date = วันที่
...
mobile-pair-title = เชื่อมต่อกับ Mac ของคุณ
mobile-pair-subtitle = ใน Vmux ให้เปิด Remote แล้วเลือก Connect device
mobile-pair-scan = สแกน QR code
mobile-pair-show-link = ป้อนลิงก์จับคู่เอง
mobile-pair-hide-link = ซ่อนลิงก์จับคู่
mobile-pair-link-placeholder = วางลิงก์จับคู่
mobile-pair-connect = เชื่อมต่อ
mobile-pair-connecting = กำลังเชื่อมต่อ…
mobile-pair-disconnect = ตัดการเชื่อมต่อ
mobile-status-connected = เชื่อมต่อแล้ว
mobile-status-reaching = กำลังติดต่อ Mac ของคุณ…
mobile-status-disconnected = ยังไม่ได้เชื่อมต่อ

mobile-url-invalid = URL การจับคู่ไม่ถูกต้อง
mobile-url-no-address = URL การจับคู่ไม่มีที่อยู่เซิร์ฟเวอร์
mobile-url-bad-address = URL การจับคู่มีที่อยู่เซิร์ฟเวอร์ที่ไม่ถูกต้อง
mobile-url-no-token = URL การจับคู่ไม่มีโทเค็น
mobile-url-scheme = URL การจับคู่ต้องใช้ HTTPS หรือ HTTP
mobile-url-paste-full = วาง URL การจับคู่แบบเต็มที่ Vmux แสดงบน Mac ของคุณ

mobile-error-pairing-outdated = การจับคู่นี้ล้าสมัยแล้ว สแกน QR บน Mac ของคุณอีกครั้ง
mobile-error-pairing-expired = การจับคู่หมดอายุแล้ว สแกน QR บน Mac ของคุณอีกครั้ง
mobile-error-pairing-lost = การจับคู่หมดอายุแล้ว จับคู่กับ Mac อีกครั้ง
mobile-error-token-rejected = โทเค็นการจับคู่ถูกปฏิเสธ
mobile-error-stack-missing = เดสก์ท็อปเปิดแชทแล้ว แต่สแต็กของแชทไม่ปรากฏ
mobile-error-not-offered = Mac ของคุณยังไม่รองรับสิ่งนี้
mobile-error-remote-disabled = Remote ถูกปิดอยู่บน Mac ของคุณ
mobile-error-session-gone = เซสชันนั้นหายไปแล้ว
mobile-error-no-desktop = เปิดหน้าต่าง Vmux บน Mac ของคุณ
mobile-error-refused = Mac ของคุณทำสิ่งนั้นไม่ได้
mobile-error-no-answer = ไม่มีการตอบกลับจาก { $address } หลังผ่านไป { $seconds } วินาที

mobile-start-stacks = สแต็ก
mobile-start-no-stacks = ไม่มีสแต็กที่เปิดอยู่
mobile-start-team = ทีม
mobile-start-search-placeholder = ค้นหาหรือถาม…
mobile-start-new-chat = เริ่มแชท
mobile-start-starting = กำลังเริ่ม…

mobile-chat-back = ย้อนกลับ
mobile-chat-back-to-stacks = กลับไปที่สแต็ก
mobile-chat-no-messages = ยังไม่มีข้อความ
mobile-chat-no-session = ไม่มีเซสชันที่ใช้งานอยู่
mobile-chat-placeholder = ส่งข้อความถึงเอเจนต์…
mobile-chat-send = ส่ง
mobile-chat-stop = หยุด

mobile-qr-title = สแกน QR code ที่ Vmux แสดงอยู่
mobile-qr-cancel = ยกเลิก
mobile-qr-unavailable = ใช้เครื่องสแกน QR ไม่ได้
mobile-qr-camera-unavailable = ใช้กล้องไม่ได้ ให้ป้อนลิงก์จับคู่แทน
mobile-qr-camera-failed = เปิดกล้องไม่ได้: { $error }
mobile-qr-camera-input-unavailable = ใช้อินพุตกล้องไม่ได้
mobile-qr-unsupported-device = อุปกรณ์นี้สแกน QR ไม่ได้
mobile-qr-unsupported-platform = แพลตฟอร์มนี้ยังสแกน QR ไม่ได้ ให้ป้อนลิงก์จับคู่แทน
mobile-error-unexpected-answer = Mac ของคุณตอบกลับมาอย่างไม่คาดคิด
mobile-error-connection-dropped = การเชื่อมต่อกับ Mac ของคุณหลุด
...
mobile-demo-open = ชมทัวร์โดยไม่ต้องมี Mac
mobile-demo-exit = ออกจากทัวร์
mobile-status-demo = ทัวร์
mobile-demo-session-title = แก้ยอดรวมคำสั่งซื้อ
mobile-demo-prompt = ยอดรวมคำสั่งซื้อคลาดเคลื่อนไปหนึ่งเซ็นต์ในตะกร้าที่มีหลายรายการ ช่วยหาสาเหตุได้ไหม
mobile-demo-thinking = การปัดเศษแต่ละรายการก่อนนำมารวมกันน่าจะอธิบายส่วนต่างหนึ่งเซ็นต์ได้ กำลังดูว่ายอดรวมถูกคำนวณอย่างไร
mobile-demo-answer = ผลรวมถูกอนุมานเป็น float จึงมีการปัดเศษแต่ละรายการก่อนนำไปบวก การกำหนดชนิดของยอดรวมเป็น Cents จะทำให้คำนวณด้วยจำนวนเต็มและส่วนต่างจะหายไป
