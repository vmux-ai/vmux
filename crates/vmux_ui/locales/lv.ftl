...
knowledge-search = Meklēt zināšanas
knowledge-no-match = Nav atbilstošu piezīmju
knowledge-open-linked-note = Atvērt saistīto piezīmi
knowledge-create-linked-note = Izveidojiet saistīto piezīmi
editor-properties = Īpašības
editor-no-properties = Nav īpašumtiesību
editor-add-tags = Pievienojiet atzīmes
editor-add-property = Pievienot īpašumu
editor-change-property-type = Mainiet īpašuma veidu
editor-add-tag = Pievienot tagu
editor-add-item = Pievienot vienumu
editor-linked-note = Saistītā piezīme
editor-property-value = Vērtība
editor-delete-property = Dzēst īpašumu
editor-property-kind-text = Teksts
editor-property-kind-number = Numurs
editor-property-kind-checkbox = Izvēles rūtiņa
editor-property-kind-date = Datums
...
mobile-pair-title = Savienojieties ar savu Mac
mobile-pair-subtitle = Vmux atveriet Remote un izvēlieties Savienot ierīci.
mobile-pair-scan = Skenēt QR kodu
mobile-pair-show-link = Ievadīt savienošanas saiti manuāli
mobile-pair-hide-link = Slēpt savienošanas saiti
mobile-pair-link-placeholder = Ielīmējiet savienošanas saiti
mobile-pair-connect = Savienot
mobile-pair-connecting = Notiek savienošana…
mobile-pair-disconnect = Atvienot
mobile-status-connected = Savienots
mobile-status-reaching = Notiek saziņa ar jūsu Mac…
mobile-status-disconnected = Nav savienots

mobile-url-invalid = Savienošanas URL nav derīgs.
mobile-url-no-address = Savienošanas URL nav servera adreses.
mobile-url-bad-address = Savienošanas URL ir nederīga servera adrese.
mobile-url-no-token = Savienošanas URL nav marķiera.
mobile-url-scheme = Savienošanas URL jāizmanto HTTPS vai HTTP.
mobile-url-paste-full = Ielīmējiet pilno savienošanas URL, ko Vmux rāda jūsu Mac.

mobile-error-pairing-outdated = Šis savienojums ir novecojis. Skenējiet QR savā Mac vēlreiz.
mobile-error-pairing-expired = Savienojuma termiņš beidzies. Skenējiet QR savā Mac vēlreiz.
mobile-error-pairing-lost = Savienojuma termiņš beidzies. Savienojiet ar Mac vēlreiz.
mobile-error-token-rejected = Savienošanas marķieris tika noraidīts.
mobile-error-stack-missing = Dators atvēra tērzēšanu, bet tās slānis neparādījās.
mobile-error-not-offered = Jūsu Mac to vēl nepiedāvā.
mobile-error-remote-disabled = Jūsu Mac Remote ir izslēgts.
mobile-error-session-gone = Tā sesija vairs nepastāv.
mobile-error-no-desktop = Atveriet Vmux logu savā Mac.
mobile-error-refused = Jūsu Mac to nevarēja izdarīt.
mobile-error-no-answer = Nav atbildes no { $address } pēc { $seconds } s.

mobile-start-stacks = Slāņi
mobile-start-no-stacks = Nav atvērtu slāņu
mobile-start-team = Komanda
mobile-start-search-placeholder = Meklējiet vai jautājiet…
mobile-start-new-chat = Sākt tērzēšanu
mobile-start-starting = Sākas…

mobile-chat-back = Atpakaļ
mobile-chat-back-to-stacks = Atpakaļ uz slāņiem
mobile-chat-no-messages = Vēl nav ziņu.
mobile-chat-no-session = Nav aktīvas sesijas
...
mobile-qr-unavailable = QR skeneris nav pieejams.
mobile-qr-camera-unavailable = Kamera nav pieejama. Tā vietā ievadiet savienošanas saiti.
mobile-qr-camera-failed = Neizdevās atvērt kameru: { $error }
mobile-qr-camera-input-unavailable = Kameras ievade nav pieejama.
mobile-qr-unsupported-device = QR skenēšana šajā ierīcē nav pieejama.
mobile-qr-unsupported-platform = QR skenēšana šajā platformā vēl nav pieejama. Tā vietā ievadiet savienošanas saiti.
mobile-error-unexpected-answer = Jūsu Mac atbildēja negaidīti.
mobile-error-connection-dropped = Savienojums ar jūsu Mac pārtrūka.
...
mobile-demo-open = Apskats bez Mac
mobile-demo-exit = Iziet no apskata
mobile-status-demo = Apskats
mobile-demo-session-title = Labot pasūtījumu kopsummas
mobile-demo-prompt = Grozos ar vairākām precēm pasūtījuma kopsumma atšķiras par vienu centu. Vai vari atrast, kāpēc?
mobile-demo-thinking = Ja katra rinda tiek noapaļota pirms saskaitīšanas, tas izskaidrotu viena centa novirzi. Skatos, kā tiek veidota kopsumma.
mobile-demo-answer = Summa tika izsecināta kā peldošā komata skaitlis, tāpēc katra rinda tika noapaļota pirms pieskaitīšanas. Piešķirot kopsummai tipu Cents, aprēķins paliek veselo skaitļu aritmētikā un novirze pazūd.
