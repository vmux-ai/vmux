...
mobile-demo-open = بەبێ Mac گەشتێک بکە
mobile-demo-exit = دەرچوون لە گەشت
mobile-status-demo = گەشت
mobile-demo-session-title = چاککردنی کۆی داواکاری
mobile-demo-prompt = لە سەبەتەکانی چەند شتومەکدا کۆی داواکاری بە یەک سەنت جیاوازە. دەتوانیت هۆکارەکەی بدۆزیتەوە؟
mobile-demo-thinking = خڕکردنەوەی هەر دێڕێک پێش کۆکردنەوە جیاوازی یەک سەنت ڕوون دەکاتەوە. سەیر دەکەم کۆکە چۆن دروست دەبێت.
mobile-demo-answer = کۆکە وەک ژمارەی خاڵدار مەزەندە دەکرا، بۆیە هەر دێڕێک پێش زیادکردن خڕ دەکرایەوە. دیاریکردنی جۆری کۆکە وەک Cents لە حیسابی ژمارەی تەواودا ڕایدەگرێت و جیاوازییەکە نامێنێت.
