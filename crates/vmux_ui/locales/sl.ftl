...
vault-recovery-key-create-failed = Ključa za obnovitev ni bilo mogoče ustvariti.
vault-recovery-key-save = Shranite ta ključ zdaj. Vmux tega ne more več prikazati.
vault-recovery-key-saved = Shranil sem ga
vault-recovery-key-placeholder = Prilepi ključ za obnovitev
vault-recovery-key-unlock = Odkleni
vault-recovery-key-invalid = Ta ključ za obnovitev ne more odkleniti trezorja.
vault-recovery-key-ready = Ključ za obnovitev konfiguriran
vault-recovery-key-upload-pending = Ključ je shranjen lokalno, vendar nalaganje ni uspelo. Shranite ga na varno in pritisnite Sinhroniziraj, da poskusite znova.
vault-auto-sync = Samodejno varnostno kopiranje
vault-backup-failed = Samodejno varnostno kopiranje ni uspelo. Pritisnite Sync za ponovni poskus.
vault-backup-failed-short = Varnostno kopiranje ni uspelo
vault-recovery-key-copy-hint = Kliknite za kopiranje
vault-recovery-key-copied = Kopirano
vault-recovery-key-verify = Shranite ga v upravitelju gesel in ga prilepite spodaj, da preverite.
vault-recovery-key-verify-placeholder = Prilepite shranjen obnovitveni ključ
vault-recovery-key-mismatch = Ključ za obnovitev se ne ujema.
...
vault-github = GitHub
vault-github-description = Ustvarite zasebno skladišče ali izberite obstoječi trezor.
vault-connect-github = Povežite GitHub
vault-connected-as = Povezan kot { $name }
vault-use-repository = Uporaba
vault-repository-name = Ime repozitorija
vault-cloud-folder = Mapa v oblaku
vault-cloud-folder-description = Uporabite mapo iz Google Drive, iCloud Drive, Dropbox ali OneDrive.
vault-choose-folder = Izberite mapo
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Mapa · { common-done }
vault-private = Zasebno skladišče
vault-public-warning = Zgodovina repozitorija in šifrirani podatki bodo javni.
...
knowledge-search = Iskanje znanja
knowledge-no-match = Ni ustreznih zapiskov
knowledge-open-linked-note = Odpri povezani zapisek
knowledge-create-linked-note = Ustvarite povezano opombo
editor-properties = Lastnosti
editor-no-properties = Brez lastnosti
editor-add-tags = Dodajte oznake
editor-add-property = Dodaj lastnino
editor-change-property-type = Spremenite vrsto lastnosti
editor-add-tag = Dodaj oznako
editor-add-item = Dodaj element
editor-linked-note = Povezana opomba
editor-property-value = Vrednost
editor-delete-property = Izbriši lastnino
editor-property-kind-text = Besedilo
editor-property-kind-number = številka
editor-property-kind-checkbox = Potrditveno polje
...
mobile-pair-title = Povežite se s svojim Mac
mobile-pair-subtitle = V Vmux odprite Remote in izberite Connect device.
mobile-pair-scan = Skeniraj kodo QR
mobile-pair-show-link = Ročno vnesi povezavo za seznanitev
mobile-pair-hide-link = Skrij povezavo za seznanitev
mobile-pair-link-placeholder = Prilepite povezavo za seznanitev
mobile-pair-connect = Poveži
mobile-pair-connecting = Povezovanje …
mobile-pair-disconnect = Prekini
mobile-status-connected = Povezano
mobile-status-reaching = Iskanje vašega Mac …
mobile-status-disconnected = Ni povezano

mobile-url-invalid = Povezava za seznanitev ni veljavna.
mobile-url-no-address = Povezava za seznanitev nima naslova strežnika.
mobile-url-bad-address = Povezava za seznanitev ima neveljaven naslov strežnika.
mobile-url-no-token = Povezava za seznanitev nima žetona.
mobile-url-scheme = Povezava za seznanitev mora uporabljati HTTPS ali HTTP.
mobile-url-paste-full = Prilepite celotno povezavo za seznanitev, ki jo Vmux prikaže na vašem Mac.

mobile-error-pairing-outdated = Ta seznanitev je zastarela. Znova skenirajte kodo QR na svojem Mac.
mobile-error-pairing-expired = Seznanitev je potekla. Znova skenirajte kodo QR na svojem Mac.
mobile-error-pairing-lost = Seznanitev je potekla. Znova se seznanite z Mac.
mobile-error-token-rejected = Žeton za seznanitev je bil zavrnjen.
mobile-error-stack-missing = Namizna aplikacija je odprla klepet, a se njegov sklad ni pojavil.
mobile-error-not-offered = Vaš Mac tega še ne ponuja.
mobile-error-remote-disabled = Remote je na vašem Mac izklopljen.
mobile-error-session-gone = Te seje ni več.
mobile-error-no-desktop = Odprite okno Vmux na svojem Mac.
mobile-error-refused = Vaš Mac tega ni mogel storiti.
mobile-error-no-answer = Ni odziva z { $address } po { $seconds } s.

mobile-start-stacks = Skladi
mobile-start-no-stacks = Ni odprtih skladov
mobile-start-team = Ekipa
mobile-start-search-placeholder = Išči ali vprašaj …
mobile-start-new-chat = Začni klepet
mobile-start-starting = Zaganjanje …

mobile-chat-back = Nazaj
mobile-chat-back-to-stacks = Nazaj na sklade
mobile-chat-no-messages = Še ni sporočil.
mobile-chat-no-session = Ni dejavne seje
...
mobile-qr-unavailable = Bralnik kod QR ni na voljo.
mobile-qr-camera-unavailable = Kamera ni na voljo. Namesto tega vnesite povezavo za seznanitev.
mobile-qr-camera-failed = Kamere ni bilo mogoče odpreti: { $error }
mobile-qr-camera-input-unavailable = Vhod kamere ni na voljo.
mobile-qr-unsupported-device = Skeniranje kod QR na tej napravi ni na voljo.
mobile-qr-unsupported-platform = Skeniranje kod QR na tej platformi še ni na voljo. Namesto tega vnesite povezavo za seznanitev.
mobile-error-unexpected-answer = Vaš Mac je odgovoril nepričakovano.
mobile-error-connection-dropped = Povezava z vašim Mac se je prekinila.
...
mobile-demo-open = Oglej si predstavitev brez Mac
mobile-demo-exit = Zapusti predstavitev
mobile-status-demo = Predstavitev
mobile-demo-session-title = Popravi seštevke naročil
mobile-demo-prompt = Seštevek naročila odstopa za en cent pri košaricah z več izdelki. Znaš najti vzrok?
mobile-demo-thinking = Zaokroževanje vsake vrstice pred seštevanjem bi pojasnilo odstopanje za en cent. Preverjam, kako se seštevek sestavi.
mobile-demo-answer = Vsota se je izpeljala kot float, zato se je vsaka vrstica zaokrožila, preden je bila prišteta. Če seštevku določimo tip Cents, ostane v celoštevilski aritmetiki in odstopanje izgine.
