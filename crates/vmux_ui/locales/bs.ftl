...
knowledge-open-linked-note = Otvorite povezanu bilješku
knowledge-create-linked-note = Kreirajte povezanu bilješku
editor-properties = Svojstva
editor-no-properties = Nema nekretnina
editor-add-tags = Dodaj oznake
editor-add-property = Dodajte nekretninu
editor-change-property-type = Promijenite vrstu imovine
...
editor-property-kind-checkbox = Polje za potvrdu
...
mobile-demo-open = Razgledaj bez Mac-a
mobile-demo-exit = Izađi iz obilaska
mobile-status-demo = Obilazak
mobile-demo-session-title = Popravi zbrojeve narudžbi
mobile-demo-prompt = Ukupan iznos narudžbe odstupa za jedan cent kod korpi s više artikala. Možeš li pronaći zašto?
mobile-demo-thinking = Zaokruživanje svake stavke prije zbrajanja objasnilo bi odstupanje od jednog centa. Provjeravam kako se ukupan iznos računa.
mobile-demo-answer = Zbroj se izvodio kao decimalni broj, pa se svaka stavka zaokruživala prije dodavanja. Ako se ukupnom iznosu da tip Cents, računanje ostaje cjelobrojno i odstupanje nestaje.
