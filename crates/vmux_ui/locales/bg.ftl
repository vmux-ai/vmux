...
vault-title = Vault
vault-encrypted = Шифровано от край до край
vault-passkey = Ключ за достъп
...
vault-recovery-key = Ключ за възстановяване
vault-recovery-key-description = Запазете един ключ в Bitwarden или друг мениджър на пароли, за да възстановите това хранилище на ново устройство.
vault-recovery-key-create = Създаване на ключ
vault-recovery-key-create-failed = Ключът за възстановяване не можа да бъде създаден.
vault-recovery-key-save = Запазете този ключ сега. Vmux не може да го покаже отново.
vault-recovery-key-saved = Запазих го
vault-recovery-key-placeholder = Paste Recovery Key
vault-recovery-key-unlock = Unlock
vault-recovery-key-invalid = Този ключ за възстановяване не може да отключи хранилището.
vault-recovery-key-ready = Ключът за възстановяване е конфигуриран
vault-recovery-key-upload-pending = Ключът е записан локално, но качването е неуспешно. Пазете го и натиснете Sync, за да опитате отново.
vault-auto-sync = Автоматично архивиране
vault-backup-failed = Неуспешно автоматично архивиране. Натиснете Sync, за да опитате отново.
vault-backup-failed-short = Неуспешно архивиране
vault-recovery-key-copy-hint = Кликнете, за да копирате
vault-recovery-key-copied = Копирано
vault-recovery-key-verify = Запазете го във вашия мениджър на пароли, след което го поставете по-долу, за да потвърдите.
vault-recovery-key-verify-placeholder = Поставете запазения ключ за възстановяване
vault-recovery-key-mismatch = Ключът за възстановяване не съвпада.
...
vault-github = GitHub
vault-github-description = Създайте частно хранилище или изберете съществуващ Vault.
vault-connect-github = Свържете GitHub
vault-connected-as = Свързан като { $name }
vault-use-repository = Използвайте
vault-repository-name = Име на хранилище
vault-cloud-folder = Облачна папка
vault-cloud-folder-description = Използвайте папка от Google Drive, iCloud Drive, Dropbox или OneDrive.
vault-choose-folder = Изберете папка
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Папка · { common-done }
vault-private = Частно хранилище
vault-public-warning = Историята на хранилището и шифрованите данни ще бъдат публични.
...
knowledge-search = Търсене на знания
knowledge-no-match = Няма съответстващи бележки
knowledge-open-linked-note = Отворете свързаната бележка
knowledge-create-linked-note = Създайте свързана бележка
editor-properties = Свойства
editor-no-properties = Няма имоти
editor-add-tags = Добавете етикети
editor-add-property = Добавете собственост
editor-change-property-type = Промяна на типа собственост
editor-add-tag = Добавете етикет
editor-add-item = Добавете елемент
editor-linked-note = Свързана бележка
editor-property-value = Стойност
editor-delete-property = Изтриване на собственост
editor-property-kind-text = Текст
editor-property-kind-number = Номер
editor-property-kind-checkbox = Квадратче за отметка
...
mobile-pair-title = Свържете се с вашия Mac
mobile-pair-subtitle = Във Vmux отворете Remote и изберете Свързване на устройство.
mobile-pair-scan = Сканирай QR код
mobile-pair-show-link = Въведи връзката ръчно
mobile-pair-hide-link = Скрий връзката за сдвояване
mobile-pair-link-placeholder = Поставете връзката за сдвояване
mobile-pair-connect = Свържи
mobile-pair-connecting = Свързване…
mobile-pair-disconnect = Прекъсни
mobile-status-connected = Свързано
mobile-status-reaching = Свързване с вашия Mac…
mobile-status-disconnected = Не е свързано

mobile-url-invalid = Невалиден URL за сдвояване.
mobile-url-no-address = URL за сдвояване няма адрес на сървър.
mobile-url-bad-address = URL за сдвояване има невалиден адрес на сървър.
mobile-url-no-token = URL за сдвояване няма токен.
mobile-url-scheme = URL за сдвояване трябва да използва HTTPS или HTTP.
mobile-url-paste-full = Поставете пълния URL за сдвояване, показан от Vmux на вашия Mac.

mobile-error-pairing-outdated = Това сдвояване е остаряло. Сканирайте отново QR кода на вашия Mac.
mobile-error-pairing-expired = Сдвояването изтече. Сканирайте отново QR кода на вашия Mac.
mobile-error-pairing-lost = Сдвояването изтече. Сдвоете се отново с Mac.
mobile-error-token-rejected = Токенът за сдвояване беше отхвърлен.
mobile-error-stack-missing = Настолното приложение отвори чата, но стекът му не се появи.
mobile-error-not-offered = Вашият Mac още не поддържа това.
mobile-error-remote-disabled = Remote е изключен на вашия Mac.
mobile-error-session-gone = Тази сесия вече я няма.
mobile-error-no-desktop = Отворете прозореца на Vmux на вашия Mac.
mobile-error-refused = Вашият Mac не можа да направи това.
mobile-error-no-answer = Няма отговор от { $address } след { $seconds } с.

mobile-start-stacks = Стекове
mobile-start-no-stacks = Няма отворени стекове
mobile-start-team = Екип
mobile-start-search-placeholder = Търсене или въпрос…
mobile-start-new-chat = Започни чат
mobile-start-starting = Стартиране…

mobile-chat-back = Назад
mobile-chat-back-to-stacks = Назад към стековете
mobile-chat-no-messages = Още няма съобщения.
mobile-chat-no-session = Няма активна сесия
mobile-chat-placeholder = Съобщение до агента…
mobile-chat-send = Изпрати
mobile-chat-stop = Спри

mobile-qr-title = Сканирайте QR кода, показан от Vmux
mobile-qr-cancel = Отказ
mobile-qr-unavailable = QR скенерът не е достъпен.
mobile-qr-camera-unavailable = Камерата не е достъпна. Въведете връзката за сдвояване.
mobile-qr-camera-failed = Камерата не можа да се отвори: { $error }
mobile-qr-camera-input-unavailable = Входът от камерата не е достъпен.
mobile-qr-unsupported-device = Сканирането на QR не е достъпно на това устройство.
mobile-qr-unsupported-platform = Сканирането на QR още не е достъпно на тази платформа. Въведете връзката за сдвояване.
mobile-error-unexpected-answer = Вашият Mac отговори неочаквано.
mobile-error-connection-dropped = Връзката с вашия Mac прекъсна.
...
mobile-demo-open = Разгледайте без Mac
mobile-demo-exit = Изход от обиколката
mobile-status-demo = Обиколка
mobile-demo-session-title = Поправяне на сумите по поръчките
mobile-demo-prompt = Сумата на поръчката се разминава с един цент при колички с няколко артикула. Можеш ли да откриеш защо?
mobile-demo-thinking = Закръгляването на всеки ред преди сумиране би обяснило разминаване от един цент. Проверявам как се изчислява сумата.
mobile-demo-answer = Сумата се извеждаше като число с плаваща запетая, затова всеки ред се закръгляваше преди добавяне. Типизирането на сумата като Cents я запазва в целочислена аритметика и разминаването изчезва.
