...
mobile-chat-allow = Разреши
mobile-chat-deny = Откажи
mobile-chat-allow-prompt = Да се разреши ли { $name }?
mobile-chat-enter-to-send = Enter за изпращане
mobile-chat-default-effort = Усилие по подразбиране
