...
knowledge-search = Wa Imọ
knowledge-no-match = Ko si awọn akọsilẹ ti o baamu
knowledge-open-linked-note = Ṣii akọsilẹ asopọ
knowledge-create-linked-note = Ṣẹda akọsilẹ asopọ
editor-properties = Awọn ohun-ini
editor-no-properties = Ko si ohun-ini
editor-add-tags = Fi awọn afi sii
editor-add-property = Fi ohun ini kun
editor-change-property-type = Yi ohun ini iru
editor-add-tag = Fi aami kun
editor-add-item = Fi nkan kun
editor-linked-note = Akọsilẹ ti o sopọ
editor-property-value = Iye
editor-delete-property = Pa ohun-ini rẹ kuro
editor-property-kind-text = Ọrọ
editor-property-kind-number = Nọmba
editor-property-kind-checkbox = Apoti ayẹwo
editor-property-kind-date = Ọjọ
...
mobile-demo-open = Ṣe ìrìn àjò láìsí Mac
mobile-demo-exit = Jáde kúrò nínú ìrìn àjò
mobile-status-demo = Ìrìn àjò
mobile-demo-session-title = Ṣàtúnṣe àpapọ̀ owó àṣẹ ọjà
mobile-demo-prompt = Àpapọ̀ owó àṣẹ ọjà ṣàṣìṣe ní sẹ́ǹtì kan nínú kẹ̀kẹ́ tí ó ní ọjà púpọ̀. Ṣé o lè rí ìdí rẹ̀?
mobile-demo-thinking = Yíyí ìlà kọ̀ọ̀kan ká kí a tó ṣàpapọ̀ lè ṣàlàyé ìyàtọ̀ sẹ́ǹtì kan. Mò ń wo bí a ṣe ń ṣírò àpapọ̀ náà.
mobile-demo-answer = A gbà pé float ni àpapọ̀, nítorí náà ìlà kọ̀ọ̀kan ni a yí ká kí a tó fi kún un. Fífún àpapọ̀ ní irú Cents jẹ́ kí ó dúró nínú ìṣirò nọ́mbà odidi, ìyàtọ̀ náà sì parẹ́.
