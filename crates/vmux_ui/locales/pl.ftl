...
mobile-demo-open = Zobacz przewodnik bez komputera Mac
mobile-demo-exit = Zakończ przewodnik
mobile-status-demo = Przewodnik
mobile-demo-session-title = Napraw sumy zamówień
mobile-demo-prompt = Suma zamówienia różni się o jeden cent w koszykach z wieloma pozycjami. Znajdziesz przyczynę?
mobile-demo-thinking = Zaokrąglanie każdej pozycji przed sumowaniem tłumaczyłoby odchylenie o jeden cent. Sprawdzam, jak liczona jest suma.
mobile-demo-answer = Suma była wnioskowana jako float, więc każda pozycja była zaokrąglana przed dodaniem. Nadanie sumie typu Cents utrzymuje ją w arytmetyce całkowitoliczbowej i odchylenie znika.
