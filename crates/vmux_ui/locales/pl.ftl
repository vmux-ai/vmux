...
mobile-chat-allow = Zezwól
mobile-chat-deny = Odmów
mobile-chat-allow-prompt = Zezwolić na { $name }?
mobile-chat-enter-to-send = Enter wysyła
mobile-chat-default-effort = Domyślny wysiłek
