...
mobile-chat-allow = Laat toe
mobile-chat-deny = Weier
mobile-chat-allow-prompt = Laat { $name } toe?
mobile-chat-enter-to-send = Enter om te stuur
mobile-chat-default-effort = Verstekpoging
