...
knowledge-search = Soek Kennis
knowledge-no-match = Geen ooreenstemmende notas nie
knowledge-open-linked-note = Maak gekoppelde nota oop
knowledge-create-linked-note = Skep gekoppelde nota
editor-properties = Eienskappe
editor-no-properties = Geen eiendomme nie
editor-add-tags = Voeg etikette by
editor-add-property = Voeg eiendom by
editor-change-property-type = Verander tipe eiendom
editor-add-tag = Voeg merker by
editor-add-item = Voeg item by
editor-linked-note = Gekoppelde nota
editor-property-value = Waarde
editor-delete-property = Vee eiendom uit
editor-property-kind-text = Teks
editor-property-kind-number = Nommer
editor-property-kind-checkbox = Merkblokkie
...
mobile-demo-open = Neem ’n toer sonder ’n Mac
mobile-demo-exit = Verlaat toer
mobile-status-demo = Toer
mobile-demo-session-title = Herstel bestellingtotale
mobile-demo-prompt = Die bestellingtotaal is ’n sent uit by karretjies met meer as een item. Kan jy dit opspoor?
mobile-demo-thinking = As elke reël afgerond word voordat dit opgetel word, sou dit ’n afwyking van een sent verklaar. Ek kyk hoe die totaal opgebou word.
mobile-demo-answer = Die som het ’n dryfpuntgetal afgelei, dus is elke reël afgerond voordat dit bygetel is. Deur die totaal as Cents te tipeer, bly dit heelgetalrekenkunde en die afwyking verdwyn.
