...
vault-title = Vault
vault-encrypted = Šifrirano s kraja na kraj
vault-passkey = Zaporka
vault-passkey-description = Otključajte ovaj trezor na drugim uređajima bez lozinke.
vault-passkey-add = Dodajte zaporku
vault-passkey-unlock = Otključati
vault-passkey-provider-unsupported = Ovaj pružatelj zaporke još ne podržava šifrirano otključavanje trezora.
vault-recovery-key = Ključ za oporavak
vault-recovery-key-description = Spremite jedan ključ u Bitwarden ili drugi upravitelj lozinki za oporavak ovog trezora na novom uređaju.
vault-recovery-key-create = Stvorite ključ
vault-recovery-key-create-failed = Ključ za oporavak nije moguće izraditi.
vault-recovery-key-save = Spremite ovaj ključ sada. Vmux ga ne može ponovno prikazati.
vault-recovery-key-saved = Sačuvao sam
...
vault-recovery-key-ready = Ključ za oporavak konfiguriran
vault-recovery-key-upload-pending = Ključ je spremljen lokalno, ali prijenos nije uspio. Čuvajte ga na sigurnom i pritisnite Sync za ponovni pokušaj.
...
vault-recovery-key-verify = Spremite ga u svoj upravitelj zaporki, a zatim ga zalijepite ispod za potvrdu.
vault-recovery-key-verify-placeholder = Zalijepite spremljeni ključ za oporavak
vault-recovery-key-mismatch = Ključ za oporavak ne odgovara.
...
vault-github = GitHub
vault-github-description = Stvorite privatno spremište ili odaberite postojeći trezor.
vault-connect-github = Povežite GitHub
vault-connected-as = Povezan kao { $name }
vault-use-repository = Koristiti
vault-repository-name = Naziv spremišta
vault-cloud-folder = Mapa oblaka
vault-cloud-folder-description = Koristite mapu s Google Drivea, iCloud Drivea, Dropboxa ili OneDrivea.
vault-choose-folder = Odaberite mapu
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Mapa · { common-done }
vault-private = Privatno spremište
vault-public-warning = Povijest repozitorija i šifrirani podaci bit će javni.
...
knowledge-search = Pretraživanje znanja
knowledge-no-match = Nema odgovarajućih bilješki
knowledge-open-linked-note = Otvori povezanu bilješku
knowledge-create-linked-note = Stvorite povezanu bilješku
editor-properties = Svojstva
editor-no-properties = Nema svojstava
editor-add-tags = Dodajte oznake
editor-add-property = Dodaj imovinu
editor-change-property-type = Promjena vrste nekretnine
editor-add-tag = Dodaj oznaku
editor-add-item = Dodaj stavku
editor-linked-note = Povezana bilješka
editor-property-value = Vrijednost
editor-delete-property = Izbriši svojstvo
editor-property-kind-text = Tekst
editor-property-kind-number = Broj
editor-property-kind-checkbox = Potvrdni okvir
...
mobile-pair-title = Poveži se sa svojim Mac uređajem
mobile-pair-subtitle = U aplikaciji Vmux otvori Remote i odaberi Connect device.
mobile-pair-scan = Skeniraj QR kod
mobile-pair-show-link = Ručno unesi poveznicu za uparivanje
mobile-pair-hide-link = Sakrij poveznicu
mobile-pair-link-placeholder = Zalijepi poveznicu za uparivanje
mobile-pair-connect = Poveži se
mobile-pair-connecting = Povezivanje…
mobile-pair-disconnect = Prekini vezu
mobile-status-connected = Povezano
mobile-status-reaching = Traženje tvog Mac uređaja…
mobile-status-disconnected = Nije povezano

mobile-url-invalid = URL za uparivanje nije valjan.
mobile-url-no-address = URL za uparivanje nema adresu poslužitelja.
mobile-url-bad-address = URL za uparivanje ima neispravnu adresu poslužitelja.
mobile-url-no-token = URL za uparivanje nema token.
mobile-url-scheme = URL za uparivanje mora koristiti HTTPS ili HTTP.
mobile-url-paste-full = Zalijepi cijeli URL za uparivanje koji Vmux prikazuje na tvom Mac uređaju.

mobile-error-pairing-outdated = Ovo uparivanje je zastarjelo. Ponovno skeniraj QR na svom Mac uređaju.
mobile-error-pairing-expired = Uparivanje je isteklo. Ponovno skeniraj QR na svom Mac uređaju.
mobile-error-pairing-lost = Uparivanje je isteklo. Ponovno se upari s Mac uređajem.
mobile-error-token-rejected = Token za uparivanje je odbijen.
mobile-error-stack-missing = Računalo je otvorilo chat, ali njegov stog se nije pojavio.
mobile-error-not-offered = Tvoj Mac to još ne nudi.
mobile-error-remote-disabled = Remote je isključen na tvom Mac uređaju.
mobile-error-session-gone = Ta sesija više ne postoji.
mobile-error-no-desktop = Otvori Vmux prozor na svom Mac uređaju.
mobile-error-refused = Tvoj Mac to nije mogao učiniti.
mobile-error-no-answer = Nema odgovora od { $address } nakon { $seconds } s.

mobile-start-stacks = Stogovi
mobile-start-no-stacks = Nema otvorenih stogova
...
mobile-chat-back = Natrag
mobile-chat-back-to-stacks = Natrag na stogove
...
mobile-qr-cancel = Odustani
mobile-qr-unavailable = Skener QR kodova nije dostupan.
mobile-qr-camera-unavailable = Kamera nije dostupna. Umjesto toga unesi poveznicu za uparivanje.
mobile-qr-camera-failed = Nije moguće otvoriti kameru: { $error }
...
mobile-qr-unsupported-platform = Skeniranje QR koda još nije dostupno na ovoj platformi. Umjesto toga unesi poveznicu za uparivanje.
mobile-error-unexpected-answer = Tvoj Mac je odgovorio neočekivano.
mobile-error-connection-dropped = Veza s tvojim Mac uređajem je izgubljena.
...
mobile-demo-open = Razgledaj bez Mac uređaja
mobile-demo-exit = Izađi iz obilaska
mobile-status-demo = Obilazak
mobile-demo-session-title = Popravi zbrojeve narudžbi
mobile-demo-prompt = Ukupan iznos narudžbe odstupa za jedan cent kod košarica s više artikala. Možeš li pronaći zašto?
mobile-demo-thinking = Zaokruživanje svake stavke prije zbrajanja objasnilo bi odstupanje od jednog centa. Gledam kako se ukupan iznos računa.
mobile-demo-answer = Zbroj se izvodio kao decimalni broj pa se svaka stavka zaokruživala prije dodavanja. Ako se ukupnom iznosu dodijeli tip Cents, računanje ostaje cjelobrojno i odstupanje nestaje.
