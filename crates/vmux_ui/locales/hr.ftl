...
mobile-chat-allow = Dopusti
mobile-chat-deny = Odbij
mobile-chat-allow-prompt = Dopustiti { $name }?
mobile-chat-enter-to-send = Enter za slanje
mobile-chat-default-effort = Zadani napor
