...
knowledge-search = علم جي ڳولا
knowledge-no-match = نه ملندڙ نوٽس
knowledge-open-linked-note = ڳنڍيل نوٽ کوليو
knowledge-create-linked-note = ڳنڍيل نوٽ ٺاهيو
editor-properties = ملڪيتون
editor-no-properties = ڪابه ملڪيت
editor-add-tags = ٽيگ شامل ڪريو
editor-add-property = ملڪيت شامل ڪريو
editor-change-property-type = ملڪيت جو قسم تبديل ڪريو
editor-add-tag = ٽيگ شامل ڪريو
editor-add-item = شيون شامل ڪريو
editor-linked-note = ڳنڍيل نوٽ
editor-property-value = قدر
editor-delete-property = ملڪيت کي ختم ڪريو
editor-property-kind-text = متن
editor-property-kind-number = نمبر
editor-property-kind-checkbox = چيڪ باڪس
...
mobile-demo-open = Mac کان سواءِ دورو ڪريو
mobile-demo-exit = دوري مان نڪرو
mobile-status-demo = دورو
mobile-demo-session-title = آرڊر جي ڪل رقم درست ڪريو
mobile-demo-prompt = گھڻين شين واري ڪارٽ ۾ آرڊر جو ڪل هڪ سينٽ غلط اچي ٿو. ڇا توهان سبب ڳولي سگهو ٿا؟
mobile-demo-thinking = جوڙڻ کان اڳ هر لڪير کي گول ڪرڻ هڪ سينٽ جي فرق جي وضاحت ڪري سگهي ٿو. ڏسان ٿو ته ڪل ڪيئن ٺهي ٿو.
mobile-demo-answer = مجموعو float طور سمجهيو پيو وڃي، ان ڪري هر لڪير شامل ٿيڻ کان اڳ گول ٿي وڃي ٿي. ڪل کي Cents قسم ڏيڻ سان اهو مڪمل عدد جي رياضي ۾ رهي ٿو ۽ فرق ختم ٿي وڃي ٿو.
