...
mobile-chat-allow = اجازت ڏيو
mobile-chat-deny = انڪار
mobile-chat-allow-prompt = { $name } کي اجازت ڏجي؟
mobile-chat-enter-to-send = موڪلڻ لاءِ Enter
mobile-chat-default-effort = ڊفالٽ ڪوشش
