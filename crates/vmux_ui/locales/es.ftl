...
schema-update-channel = Canal de versiones
schema-update-channel-detail = Estable recibe versiones publicadas. Vista previa recibe compilaciones nocturnas.
schema-update-channel-stable = Estable
schema-update-channel-preview = Vista previa
...
composer-permissions = Permisos
composer-permission-change = Cambiar modo de permisos
common-stop = Detener
...
command-rotate-forward = Disposición > Panel > Rotar paneles hacia delante
command-rotate-backward = Disposición > Panel > Rotar paneles hacia atrás
command-mirror-panes = Disposición > Panel > Reflejar paneles
command-mirror-panes-horizontal = Disposición > Panel > Reflejar paneles horizontalmente
command-mirror-panes-vertical = Disposición > Panel > Reflejar paneles verticalmente
...
mobile-nav-untitled-chat = Chat sin título
mobile-nav-launcher = Inicio
mobile-nav-new-tab = Nueva pestaña
mobile-nav-unsupported = No disponible en este dispositivo
mobile-nav-read-only = Solo lectura
mobile-nav-open-on-mac = Ábrelo en tu Mac
mobile-nav-url-placeholder = Pregunta o pega una URL…
...
git-status = Estado
git-files = Archivos
git-commits = Confirmaciones
git-log = Historial
git-command-log = Registro de comandos
git-command-log-empty = Las operaciones de Git aparecerán aquí.
git-command-error = error
git-repository = Repositorio
git-changes = Cambios
git-branches = Ramas
git-staged-changes = Cambios preparados
git-unstaged-changes = Cambios sin preparar
git-repository-clean = El árbol de trabajo está limpio
git-select-file = Selecciona un archivo para ver sus diferencias
git-stage = Preparar
git-discard = Descartar
git-recent-commits = Commits recientes
git-no-commits = Aún no hay commits
git-local-branches = Ramas locales
git-local = Local
git-remote = Remoto
git-tags = Etiquetas
git-no-branches = No hay ramas locales
...
git-stage-all = Preparar todo
git-switch-workspace = Cambiar espacio de trabajo
git-edit-config = Editar archivo de configuración
git-switch-recent-repository = Cambiar a un repositorio reciente
git-keybindings = Atajos de teclado
git-checkout = Cambiar a la rama
git-new-branch = Nueva rama
git-delete-branch = Eliminar rama
git-stashes = Stashes
git-no-stashes = No hay stashes
git-stash = Guardar cambios
git-stash-pop = Aplicar y eliminar stash
git-stash-drop = Eliminar stash
git-amend = Modificar commit
git-rebase = Rebase
git-merge = Fusionar
git-fast-forward = Avance rápido
git-revert-commit = Revertir commit
git-cherry-pick = Cherry-pick
git-checkout-commit = Cambiar al commit
git-shortcut-panels = Paneles
git-shortcut-navigate = Navegar
git-shortcut-help = Atajos
git-shortcut-title = Atajos de Git
git-shortcut-description = Atajos disponibles para esta página de Git.
git-shortcut-universal = General
git-shortcut-next-panel = Panel siguiente
git-shortcut-previous = Elemento anterior
git-shortcut-next = Elemento siguiente
