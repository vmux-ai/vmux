...
vault-title = Vault
vault-encrypted = End-to-end šifrování
vault-passkey = Přístupový klíč
...
vault-recovery-key = Obnovovací klíč
vault-recovery-key-description = Uložte jeden klíč do Bitwardenu nebo jiného správce hesel a obnovte tento trezor na novém zařízení.
vault-recovery-key-create = Vytvořit klíč
vault-recovery-key-create-failed = Obnovovací klíč nelze vytvořit.
vault-recovery-key-save = Tento klíč nyní uložte. Vmux to nemůže znovu zobrazit.
vault-recovery-key-saved = Uložil jsem to
vault-recovery-key-placeholder = Vložit klíč pro obnovení
vault-recovery-key-unlock = Odemknout
vault-recovery-key-invalid = Tento obnovovací klíč nemůže odemknout trezor.
vault-recovery-key-ready = Obnovovací klíč nakonfigurován
vault-recovery-key-upload-pending = Klíč je uložen místně, ale nahrání se nezdařilo. Uchovávejte jej v bezpečí a stisknutím tlačítka Synchronizovat to zkuste znovu.
vault-auto-sync = Automatické zálohování
vault-backup-failed = Automatické zálohování se nezdařilo. Stiskněte Sync pro opakování.
vault-backup-failed-short = Zálohování se nezdařilo
vault-recovery-key-copy-hint = Kliknutím zkopírujete
vault-recovery-key-copied = Zkopírováno
vault-recovery-key-verify = Uložte jej ve správci hesel a poté jej ověřte vložením níže.
vault-recovery-key-verify-placeholder = Vložte uložený klíč pro obnovení
vault-recovery-key-mismatch = Recovery Key neodpovídá.
...
vault-github = GitHub
vault-github-description = Vytvořte soukromé úložiště nebo vyberte existující úložiště.
vault-connect-github = Připojte GitHub
vault-connected-as = Připojeno jako { $name }
vault-use-repository = Použití
vault-repository-name = Název úložiště
vault-cloud-folder = Cloudová složka
vault-cloud-folder-description = Použijte složku z Google Drive, iCloud Drive, Dropbox nebo OneDrive.
vault-choose-folder = Vyberte složku
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Složka · { common-done }
vault-private = Soukromé úložiště
vault-public-warning = Historie repozitáře a šifrovaná data budou veřejné.
...
knowledge-search = Hledání znalostí
knowledge-no-match = Žádné odpovídající poznámky
knowledge-open-linked-note = Otevřete propojenou poznámku
knowledge-create-linked-note = Vytvořit propojenou poznámku
editor-properties = Vlastnosti
editor-no-properties = Žádné vlastnosti
editor-add-tags = Přidejte značky
editor-add-property = Přidat vlastnost
editor-change-property-type = Změňte typ vlastnosti
editor-add-tag = Přidat značku
editor-add-item = Přidat položku
editor-linked-note = Propojená poznámka
editor-property-value = Hodnota
editor-delete-property = Smazat vlastnost
editor-property-kind-text = Text
editor-property-kind-number = Číslo
editor-property-kind-checkbox = Zaškrtávací políčko
...
mobile-pair-title = Připojit se k Macu
mobile-pair-subtitle = Ve Vmuxu otevři Remote a zvol Připojit zařízení.
mobile-pair-scan = Naskenovat QR kód
mobile-pair-show-link = Zadat odkaz ručně
mobile-pair-hide-link = Skrýt odkaz pro párování
mobile-pair-link-placeholder = Vlož odkaz pro párování
mobile-pair-connect = Připojit
mobile-pair-connecting = Připojování…
mobile-pair-disconnect = Odpojit
mobile-status-connected = Připojeno
mobile-status-reaching = Hledám tvůj Mac…
mobile-status-disconnected = Nepřipojeno

mobile-url-invalid = Párovací URL je neplatná.
mobile-url-no-address = Párovací URL neobsahuje adresu serveru.
mobile-url-bad-address = Párovací URL má neplatnou adresu serveru.
mobile-url-no-token = Párovací URL neobsahuje token.
mobile-url-scheme = Párovací URL musí používat HTTPS nebo HTTP.
mobile-url-paste-full = Vlož celou párovací URL, kterou Vmux zobrazuje na tvém Macu.

mobile-error-pairing-outdated = Toto párování je zastaralé. Naskenuj QR na svém Macu znovu.
mobile-error-pairing-expired = Párování vypršelo. Naskenuj QR na svém Macu znovu.
mobile-error-pairing-lost = Párování vypršelo. Spáruj se s Macem znovu.
mobile-error-token-rejected = Párovací token byl odmítnut.
mobile-error-stack-missing = Desktop chat otevřel, ale jeho vrstva se neobjevila.
mobile-error-not-offered = Tvůj Mac to zatím nenabízí.
mobile-error-remote-disabled = Remote je na tvém Macu vypnutý.
mobile-error-session-gone = Tato relace už neexistuje.
mobile-error-no-desktop = Otevři okno Vmuxu na svém Macu.
mobile-error-refused = Tvůj Mac to nedokázal provést.
mobile-error-no-answer = Žádná odpověď z { $address } po { $seconds } s.

mobile-start-stacks = Vrstvy
mobile-start-no-stacks = Žádné otevřené vrstvy
mobile-start-team = Tým
mobile-start-search-placeholder = Hledat nebo se zeptat…
mobile-start-new-chat = Začít chat
mobile-start-starting = Spouštění…

mobile-chat-back = Zpět
mobile-chat-back-to-stacks = Zpět na vrstvy
mobile-chat-no-messages = Zatím žádné zprávy.
mobile-chat-no-session = Žádná aktivní relace
...
mobile-qr-unavailable = QR skener není k dispozici.
mobile-qr-camera-unavailable = Kamera není k dispozici. Zadej místo toho odkaz pro párování.
mobile-qr-camera-failed = Kameru se nepodařilo otevřít: { $error }
mobile-qr-camera-input-unavailable = Vstup kamery není k dispozici.
mobile-qr-unsupported-device = Skenování QR není na tomto zařízení dostupné.
mobile-qr-unsupported-platform = Skenování QR zatím není na této platformě dostupné. Zadej místo toho odkaz pro párování.
mobile-error-unexpected-answer = Tvůj Mac odpověděl nečekaně.
mobile-error-connection-dropped = Připojení k tvému Macu se přerušilo.
...
mobile-demo-open = Prohlídka bez Macu
mobile-demo-exit = Ukončit prohlídku
mobile-status-demo = Prohlídka
mobile-demo-session-title = Opravit součty objednávek
mobile-demo-prompt = U košíků s více položkami se součet objednávky liší o jeden cent. Najdeš proč?
mobile-demo-thinking = Zaokrouhlení každé položky před sečtením by odchylku o jeden cent vysvětlovalo. Dívám se, jak se součet skládá.
mobile-demo-answer = Součet se odvozoval jako desetinné číslo, takže se každá položka zaokrouhlila ještě před přičtením. Když se součtu určí typ Cents, zůstane v celočíselné aritmetice a odchylka zmizí.
