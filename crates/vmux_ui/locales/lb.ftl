...
knowledge-search = Sich Wëssen
knowledge-no-match = Keng passende Notizen
knowledge-open-linked-note = Open verlinkt Notiz
knowledge-create-linked-note = Erstellt verlinkt Notiz
editor-properties = Eegeschaften
editor-no-properties = Keng Eegeschafte
editor-add-tags = Tags addéieren
editor-add-property = Dobäizemaachen Propriétéit
editor-change-property-type = Änneren Propriétéit Typ
editor-add-tag = Tag add
editor-add-item = Artikel dobäisetzen
editor-linked-note = Verlinkt Notiz
editor-property-value = Wäert
editor-delete-property = Eegentum läschen
editor-property-kind-text = Text
editor-property-kind-number = Zuel
...
mobile-pair-title = Mat dengem Mac verbannen
mobile-pair-subtitle = Maach a Vmux Remote op a wiel Apparat verbannen.
mobile-pair-scan = QR-Code scannen
mobile-pair-show-link = Koppellink manuell aginn
mobile-pair-hide-link = Koppellink verstoppen
mobile-pair-link-placeholder = Koppellink apechen
mobile-pair-connect = Verbannen
mobile-pair-connecting = Gëtt verbonnen…
mobile-pair-disconnect = Trennen
mobile-status-connected = Verbonnen
mobile-status-reaching = Däi Mac gëtt kontaktéiert…
mobile-status-disconnected = Net verbonnen

mobile-url-invalid = D'Koppel-URL ass ongëlteg.
mobile-url-no-address = D'Koppel-URL huet keng Serveradress.
mobile-url-bad-address = D'Koppel-URL huet eng ongëlteg Serveradress.
mobile-url-no-token = D'Koppel-URL huet keen Token.
mobile-url-scheme = D'Koppel-URL muss HTTPS oder HTTP benotzen.
mobile-url-paste-full = Pech déi ganz Koppel-URL an, déi Vmux op dengem Mac weist.

mobile-error-pairing-outdated = Dës Koppelung ass net méi aktuell. Scan de QR op dengem Mac nach eng Kéier.
mobile-error-pairing-expired = D'Koppelung ass ofgelaf. Scan de QR op dengem Mac nach eng Kéier.
mobile-error-pairing-lost = D'Koppelung ass ofgelaf. Koppel de Mac nach eng Kéier.
mobile-error-token-rejected = De Koppeltoken gouf refuséiert.
mobile-error-stack-missing = Den Desktop huet de Chat opgemaach, mee säi Stack ass net opgetaucht.
mobile-error-not-offered = Däi Mac bitt dat nach net un.
mobile-error-remote-disabled = Remote ass op dengem Mac ausgeschalt.
mobile-error-session-gone = Déi Sessioun gëtt et net méi.
mobile-error-no-desktop = Maach d'Vmux-Fënster op dengem Mac op.
mobile-error-refused = Däi Mac konnt dat net maachen.
mobile-error-no-answer = Keng Äntwert vun { $address } no { $seconds } s.

mobile-start-stacks = Stacks
mobile-start-no-stacks = Keng oppe Stacks
mobile-start-team = Team
mobile-start-search-placeholder = Sichen oder froen…
mobile-start-new-chat = Chat starten
mobile-start-starting = Start…

mobile-chat-back = Zréck
mobile-chat-back-to-stacks = Zréck bei d'Stacks
mobile-chat-no-messages = Nach keng Noriichten.
mobile-chat-no-session = Keng aktiv Sessioun
mobile-chat-placeholder = Noriicht un den Agent…
mobile-chat-send = Schécken
mobile-chat-stop = Stoppen

mobile-qr-title = Scan de QR-Code, deen Vmux weist
mobile-qr-cancel = Ofbriechen
mobile-qr-unavailable = De QR-Scanner ass net verfügbar.
mobile-qr-camera-unavailable = Camera net verfügbar. Gëff amplaz de Koppellink an.
mobile-qr-camera-failed = Camera konnt net opgemaach ginn: { $error }
mobile-qr-camera-input-unavailable = De Camera-Input ass net verfügbar.
mobile-qr-unsupported-device = QR-Scannen ass op dësem Apparat net verfügbar.
mobile-qr-unsupported-platform = QR-Scannen ass op dëser Plattform nach net verfügbar. Gëff amplaz de Koppellink an.
mobile-error-unexpected-answer = Däi Mac huet onerwaart geäntwert.
mobile-error-connection-dropped = D'Verbindung mat dengem Mac ass ofgebrach.
...
mobile-demo-open = Maach eng Tour ouni Mac
mobile-demo-exit = Tour verloossen
mobile-status-demo = Tour
mobile-demo-session-title = Bestellungssummen fléken
mobile-demo-prompt = Bei Kärbecher mat méi Artikelen ass d'Bestellungssumm ëm ee Cent falsch. Fënns du eraus firwat?
mobile-demo-thinking = Wann all Linn virum Zesummenzielen geronnt gëtt, erkläert dat en Ënnerscheed vun engem Cent. Ech kucken, wéi d'Summ opgebaut gëtt.
mobile-demo-answer = D'Summ gouf als Fliesskommazuel ofgeleet, dofir gouf all Linn geronnt, ier se derbäigezielt gouf. Wann een der Summ den Typ Cents gëtt, bleift se an der Ganzzuelenarithmetik an den Ënnerscheed verschwënnt.
