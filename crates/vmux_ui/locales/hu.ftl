...
knowledge-search = Keresés a Tudásban
knowledge-no-match = Nincsenek megfelelő jegyzetek
knowledge-open-linked-note = Kapcsolt jegyzet megnyitása
knowledge-create-linked-note = Kapcsolt jegyzet létrehozása
editor-properties = Tulajdonságok
editor-no-properties = Nincsenek tulajdonságok
editor-add-tags = Címkék hozzáadása
editor-add-property = Tulajdon hozzáadása
editor-change-property-type = Tulajdon típusának módosítása
editor-add-tag = Címke hozzáadása
editor-add-item = Elem hozzáadása
editor-linked-note = Kapcsolt megjegyzés
editor-property-value = Érték
editor-delete-property = Tulajdonság törlése
editor-property-kind-text = Szöveg
editor-property-kind-number = Szám
editor-property-kind-checkbox = Jelölőnégyzet
editor-property-kind-date = Dátum
...
mobile-pair-title = Csatlakozás a Mac géphez
mobile-pair-subtitle = A Vmux alkalmazásban nyissa meg a Remote-ot, majd válassza a Connect device lehetőséget.
mobile-pair-scan = QR-kód beolvasása
mobile-pair-show-link = Párosítási hivatkozás megadása kézzel
mobile-pair-hide-link = Hivatkozás elrejtése
mobile-pair-link-placeholder = Illessze be a párosítási hivatkozást
mobile-pair-connect = Csatlakozás
mobile-pair-connecting = Csatlakozás…
mobile-pair-disconnect = Bontás
mobile-status-connected = Csatlakoztatva
mobile-status-reaching = Kapcsolódás a Mac géphez…
mobile-status-disconnected = Nincs csatlakoztatva

mobile-url-invalid = A párosítási URL érvénytelen.
mobile-url-no-address = A párosítási URL nem tartalmaz kiszolgálócímet.
mobile-url-bad-address = A párosítási URL kiszolgálócíme érvénytelen.
mobile-url-no-token = A párosítási URL nem tartalmaz tokent.
mobile-url-scheme = A párosítási URL-nek HTTPS-t vagy HTTP-t kell használnia.
mobile-url-paste-full = Illessze be a teljes párosítási URL-t, amelyet a Vmux mutat a Mac gépén.

mobile-error-pairing-outdated = Ez a párosítás elavult. Olvassa be újra a QR-kódot a Mac gépén.
mobile-error-pairing-expired = A párosítás lejárt. Olvassa be újra a QR-kódot a Mac gépén.
mobile-error-pairing-lost = A párosítás lejárt. Párosítsa újra a Mac géppel.
mobile-error-token-rejected = A párosítási token elutasítva.
mobile-error-stack-missing = A gépen megnyílt a csevegés, de a verme nem jelent meg.
mobile-error-not-offered = A Mac gépe ezt még nem kínálja.
mobile-error-remote-disabled = A Remote ki van kapcsolva a Mac gépén.
mobile-error-session-gone = Ez a munkamenet már nem létezik.
mobile-error-no-desktop = Nyissa meg a Vmux ablakot a Mac gépén.
mobile-error-refused = A Mac gépe ezt nem tudta végrehajtani.
mobile-error-no-answer = Nincs válasz innen: { $address }, { $seconds } másodperc után.

mobile-start-stacks = Vermek
mobile-start-no-stacks = Nincs nyitott verem
mobile-start-team = Csapat
mobile-start-search-placeholder = Keresés vagy kérdés…
mobile-start-new-chat = Csevegés indítása
mobile-start-starting = Indítás…

mobile-chat-back = Vissza
mobile-chat-back-to-stacks = Vissza a vermekhez
mobile-chat-no-messages = Még nincsenek üzenetek.
mobile-chat-no-session = Nincs aktív munkamenet
...
mobile-qr-unavailable = A QR-olvasó nem érhető el.
mobile-qr-camera-unavailable = A kamera nem érhető el. Adja meg inkább a párosítási hivatkozást.
mobile-qr-camera-failed = Nem sikerült megnyitni a kamerát: { $error }
mobile-qr-camera-input-unavailable = A kamera bemenete nem érhető el.
mobile-qr-unsupported-device = A QR-beolvasás nem érhető el ezen az eszközön.
mobile-qr-unsupported-platform = A QR-beolvasás ezen a platformon még nem érhető el. Adja meg inkább a párosítási hivatkozást.
mobile-error-unexpected-answer = A Mac gépe váratlan választ adott.
mobile-error-connection-dropped = A Mac gépével való kapcsolat megszakadt.
...
mobile-demo-open = Bemutató Mac nélkül
mobile-demo-exit = Kilépés a bemutatóból
mobile-status-demo = Bemutató
mobile-demo-session-title = Rendelési végösszegek javítása
mobile-demo-prompt = Több tételt tartalmazó kosaraknál a rendelés végösszege egy centtel eltér. Megtalálod, hogy miért?
mobile-demo-thinking = Ha minden sort kerekítünk az összeadás előtt, az megmagyarázna egy centes eltérést. Megnézem, hogyan áll össze a végösszeg.
mobile-demo-answer = Az összeg lebegőpontosként lett kikövetkeztetve, így minden sor kerekült, mielőtt hozzáadódott volna. Ha a végösszeg típusa Cents, egész számú aritmetikában marad, és az eltérés eltűnik.
