...
knowledge-search = Білімді іздеу
knowledge-no-match = Сәйкес ескертпелер жоқ
knowledge-open-linked-note = Байланыстырылған жазбаны ашыңыз
knowledge-create-linked-note = Байланыстырылған жазба жасаңыз
editor-properties = Қасиеттер
editor-no-properties = Мүлік жоқ
editor-add-tags = Тегтерді қосыңыз
editor-add-property = Мүлікті қосыңыз
editor-change-property-type = Меншік түрін өзгерту
editor-add-tag = Тег қосыңыз
editor-add-item = Элементті қосу
editor-linked-note = Байланыстырылған жазба
editor-property-value = Мән
editor-delete-property = Мүлікті жою
editor-property-kind-text = Мәтін
editor-property-kind-number = Сан
editor-property-kind-checkbox = Құсбелгі ұяшығы
editor-property-kind-date = Күн
...
mobile-demo-open = Mac-сіз тур жасаңыз
mobile-demo-exit = Турдан шығу
mobile-status-demo = Тур
mobile-demo-session-title = Тапсырыс жиынтығын түзету
mobile-demo-prompt = Бірнеше тауары бар себеттерде тапсырыс жиынтығы бір центке ауытқиды. Себебін таба аласың ба?
mobile-demo-thinking = Әр жолды қосудан бұрын дөңгелектеу бір центтік ауытқуды түсіндірер еді. Жиынтық қалай есептелетінін қарап жатырмын.
mobile-demo-answer = Жиынтық жылжымалы нүктелі сан ретінде тұжырымдалған, сондықтан әр жол қосылмас бұрын дөңгелектенген. Жиынтыққа Cents түрін беру оны бүтін сандық арифметикада ұстайды және ауытқу жоғалады.
