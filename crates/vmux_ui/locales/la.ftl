...
mobile-chat-allow = Permittere
mobile-chat-deny = Negare
mobile-chat-allow-prompt = Permittere { $name }?
mobile-chat-enter-to-send = Enter ad mittendum
mobile-chat-default-effort = Conatus praedefinitus
