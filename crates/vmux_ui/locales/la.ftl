...
knowledge-search = Cognitionem quaerere
knowledge-no-match = Nulla matching notas
knowledge-open-linked-note = Apertum coniunctum nota
knowledge-create-linked-note = Create note coniunctum
editor-properties = Properties
editor-no-properties = Non proprietatibus
editor-add-tags = Add tags
editor-add-property = Addere possessionem
editor-change-property-type = Mutare proprietas genus
editor-add-tag = Add tag
editor-add-item = Add item
editor-linked-note = Coniunctum nota
editor-property-value = Precium
editor-delete-property = Delere possessionem
editor-property-kind-text = Textum
editor-property-kind-number = Numerus
...
mobile-pair-title = Cum Mac tuo coniunge
mobile-pair-subtitle = In Vmux aperi Remote et elige Coniungere machinam.
mobile-pair-scan = Lege codicem QR
mobile-pair-show-link = Nexum coniunctionis manu insere
mobile-pair-hide-link = Nexum coniunctionis occulta
mobile-pair-link-placeholder = Nexum coniunctionis agglutina
mobile-pair-connect = Coniunge
mobile-pair-connecting = Coniungitur…
mobile-pair-disconnect = Disiunge
mobile-status-connected = Coniunctum
mobile-status-reaching = Mac tuum petitur…
mobile-status-disconnected = Non coniunctum

mobile-url-invalid = URL coniunctionis invalidum est.
mobile-url-no-address = URL coniunctionis inscriptionem servitoris non habet.
mobile-url-bad-address = URL coniunctionis inscriptionem servitoris invalidam habet.
mobile-url-no-token = URL coniunctionis tesseram non habet.
mobile-url-scheme = URL coniunctionis HTTPS aut HTTP adhibere debet.
mobile-url-paste-full = Agglutina totum URL coniunctionis quod Vmux in Mac tuo ostendit.

mobile-error-pairing-outdated = Haec coniunctio obsoleta est. Codicem QR in Mac tuo iterum lege.
mobile-error-pairing-expired = Coniunctio exspiravit. Codicem QR in Mac tuo iterum lege.
mobile-error-pairing-lost = Coniunctio exspiravit. Cum Mac iterum coniunge.
mobile-error-token-rejected = Tessera coniunctionis reiecta est.
mobile-error-stack-missing = Mensa colloquium aperuit, sed strues eius non apparuit.
mobile-error-not-offered = Mac tuum hoc nondum praebet.
mobile-error-remote-disabled = Remote in Mac tuo exstinctum est.
mobile-error-session-gone = Illa sessio abiit.
mobile-error-no-desktop = Fenestram Vmux in Mac tuo aperi.
mobile-error-refused = Mac tuum hoc facere non potuit.
mobile-error-no-answer = Nullum responsum ab { $address } post { $seconds } secunda.

mobile-start-stacks = Strues
mobile-start-no-stacks = Nullae strues apertae
mobile-start-team = Grex
mobile-start-search-placeholder = Quaere aut roga…
mobile-start-new-chat = Incipe colloquium
mobile-start-starting = Incipitur…

mobile-chat-back = Retro
mobile-chat-back-to-stacks = Retro ad strues
mobile-chat-no-messages = Nondum ulla nuntia.
mobile-chat-no-session = Nulla sessio activa
mobile-chat-placeholder = Scribe agenti…
mobile-chat-send = Mitte
mobile-chat-stop = Sistere

mobile-qr-title = Lege codicem QR quem Vmux ostendit
mobile-qr-cancel = Abrogare
mobile-qr-unavailable = Lector QR non praesto est.
mobile-qr-camera-unavailable = Camera non praesto. Nexum coniunctionis potius insere.
mobile-qr-camera-failed = Camera aperiri non potuit: { $error }
mobile-qr-camera-input-unavailable = Introitus camerae non praesto est.
mobile-qr-unsupported-device = Lectio QR in hoc instrumento non praesto est.
mobile-qr-unsupported-platform = Lectio QR in hoc systemate nondum praesto est. Nexum coniunctionis potius insere.
mobile-error-unexpected-answer = Mac tuum inexspectate respondit.
mobile-error-connection-dropped = Coniunctio cum Mac tuo intercidit.
...
mobile-demo-open = Circumi sine Mac
mobile-demo-exit = Exi circuitum
mobile-status-demo = Circuitus
mobile-demo-session-title = Corrige summas mandatorum
mobile-demo-prompt = Summa mandati uno centesimo aberrat in corbibus multarum rerum. Potesne causam invenire?
mobile-demo-thinking = Si singulae lineae ante additionem rotundantur, id aberrationem unius centesimi explicet. Inspicio quomodo summa componatur.
mobile-demo-answer = Summa ut numerus fluitans deducebatur, itaque singulae lineae ante additionem rotundabantur. Si summae genus Cents datur, in arithmetica integrorum manet et aberratio evanescit.
