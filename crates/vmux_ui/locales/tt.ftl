...
knowledge-search = Белем эзләү
knowledge-no-match = Бер-берсенә туры килгән язмалар юк
knowledge-open-linked-note = Бәйләнгән язманы ачу
knowledge-create-linked-note = Бәйләнгән язма ясагыз
editor-properties = Сыйфатлар
editor-no-properties = Сыйфат юк
editor-add-tags = Тэглар өстәгез
editor-add-property = Мөлкәт өстәү
editor-change-property-type = Мөлкәт төрен үзгәртү
editor-add-tag = Тэг өстәгез
editor-add-item = Предмет өстәү
editor-linked-note = Бәйләнгән язма
editor-property-value = Кыйммәт
editor-delete-property = Мөлкәтне бетерү
editor-property-kind-text = Текст
editor-property-kind-number = Сан
editor-property-kind-checkbox = Такталар
...
mobile-pair-title = Mac’ыгызга тоташыгыз
mobile-pair-subtitle = Vmux’та Remote’ны ачыгыз һәм Connect device сайлагыз.
mobile-pair-scan = QR-код сканерлау
mobile-pair-show-link = Парлау сылтамасын кулдан кертү
mobile-pair-hide-link = Парлау сылтамасын яшерү
mobile-pair-link-placeholder = Парлау сылтамасын куегыз
mobile-pair-connect = Тоташу
mobile-pair-connecting = Тоташа…
mobile-pair-disconnect = Аеру
mobile-status-connected = Тоташкан
mobile-status-reaching = Mac’ыгыз белән бәйләнешкә керә…
mobile-status-disconnected = Тоташмаган

mobile-url-invalid = Парлау URL’ы дөрес түгел.
mobile-url-no-address = Парлау URL’ында сервер адресы юк.
mobile-url-bad-address = Парлау URL’ындагы сервер адресы дөрес түгел.
mobile-url-no-token = Парлау URL’ында токен юк.
mobile-url-scheme = Парлау URL’ы HTTPS яки HTTP кулланырга тиеш.
mobile-url-paste-full = Mac’ыгызда Vmux күрсәткән парлау URL’ын тулысынча куегыз.

mobile-error-pairing-outdated = Бу парлау искергән. Mac’ыгыздагы QR-кодны яңадан сканерлагыз.
mobile-error-pairing-expired = Парлау вакыты чыкты. Mac’ыгыздагы QR-кодны яңадан сканерлагыз.
mobile-error-pairing-lost = Парлау вакыты чыкты. Mac белән яңадан парлагыз.
mobile-error-token-rejected = Парлау токены кире кагылды.
mobile-error-stack-missing = Эш өстәле чатны ачты, ләкин аның стегы күренмәде.
mobile-error-not-offered = Mac’ыгыз моны әле тәкъдим итми.
mobile-error-remote-disabled = Mac’ыгызда Remote сүндерелгән.
mobile-error-session-gone = Ул сессия юкка чыккан.
mobile-error-no-desktop = Mac’ыгызда Vmux тәрәзәсен ачыгыз.
mobile-error-refused = Mac’ыгыз моны эшли алмады.
mobile-error-no-answer = { $seconds } с эчендә { $address } адресыннан җавап килмәде.

mobile-start-stacks = Стеклар
mobile-start-no-stacks = Ачык стек юк
mobile-start-team = Команда
mobile-start-search-placeholder = Эзләгез яки сорагыз…
mobile-start-new-chat = Чат башлау
mobile-start-starting = Башлана…

mobile-chat-back = Артка
mobile-chat-back-to-stacks = Стекларга кайту
mobile-chat-no-messages = Әле хәбәрләр юк.
mobile-chat-no-session = Актив сессия юк
...
mobile-qr-unavailable = QR сканеры эшләми.
mobile-qr-camera-unavailable = Камера эшләми. Урынына парлау сылтамасын кертегез.
mobile-qr-camera-failed = Камераны ачып булмады: { $error }
mobile-qr-camera-input-unavailable = Камера кертүе эшләми.
mobile-qr-unsupported-device = Бу җайланмада QR сканерлау мөмкин түгел.
mobile-qr-unsupported-platform = QR сканерлау бу платформада әле мөмкин түгел. Урынына парлау сылтамасын кертегез.
mobile-error-unexpected-answer = Mac’ыгыз көтелмәгән җавап бирде.
mobile-error-connection-dropped = Mac’ыгыз белән тоташу өзелде.
...
mobile-demo-open = Mac’сыз экскурсия үтегез
mobile-demo-exit = Экскурсиядән чыгу
mobile-status-demo = Экскурсия
mobile-demo-session-title = Заказ суммаларын төзәтү
mobile-demo-prompt = Күп товарлы кәрзиннәрдә заказ суммасы бер центка ялгыша. Сәбәбен таба аласызмы?
mobile-demo-thinking = Кушканчы һәр юлны түгәрәкләү бер центлык аерманы аңлатыр иде. Сумманың ничек исәпләнүен карыйм.
mobile-demo-answer = Сумма float дип кабул ителгән, шуңа күрә һәр юл кушылганчы түгәрәкләнгән. Суммага Cents тибын биргәч, ул бөтен сан арифметикасында кала һәм аерма юкка чыга.
