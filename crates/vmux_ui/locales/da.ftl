...
knowledge-search = Søg viden
knowledge-no-match = Ingen matchende noter
knowledge-open-linked-note = Åbn linket note
knowledge-create-linked-note = Opret linket note
editor-properties = Egenskaber
editor-no-properties = Ingen ejendomme
editor-add-tags = Tilføj tags
editor-add-property = Tilføj ejendom
editor-change-property-type = Skift ejendomstype
editor-add-tag = Tilføj tag
editor-add-item = Tilføj element
editor-linked-note = Sammenkædet note
editor-property-value = Værdi
editor-delete-property = Slet ejendom
editor-property-kind-text = Tekst
editor-property-kind-number = Antal
editor-property-kind-checkbox = Afkrydsningsfelt
...
mobile-pair-title = Forbind til din Mac
mobile-pair-subtitle = Åbn Remote i Vmux, og vælg Forbind enhed.
mobile-pair-scan = Scan QR-kode
mobile-pair-show-link = Indtast parringslink manuelt
mobile-pair-hide-link = Skjul parringslink
mobile-pair-link-placeholder = Indsæt parringslink
mobile-pair-connect = Forbind
mobile-pair-connecting = Forbinder…
mobile-pair-disconnect = Afbryd
mobile-status-connected = Forbundet
mobile-status-reaching = Kontakter din Mac…
mobile-status-disconnected = Ikke forbundet

mobile-url-invalid = Parrings-URL’en er ugyldig.
mobile-url-no-address = Parrings-URL’en har ingen serveradresse.
mobile-url-bad-address = Parrings-URL’en har en ugyldig serveradresse.
mobile-url-no-token = Parrings-URL’en har intet token.
mobile-url-scheme = Parrings-URL’en skal bruge HTTPS eller HTTP.
mobile-url-paste-full = Indsæt hele den parrings-URL, som Vmux viser på din Mac.

mobile-error-pairing-outdated = Denne parring er forældet. Scan QR-koden på din Mac igen.
mobile-error-pairing-expired = Parringen er udløbet. Scan QR-koden på din Mac igen.
mobile-error-pairing-lost = Parringen er udløbet. Par med din Mac igen.
mobile-error-token-rejected = Parringstokenet blev afvist.
mobile-error-stack-missing = Computeren åbnede chatten, men dens stak dukkede ikke op.
mobile-error-not-offered = Din Mac tilbyder ikke dette endnu.
mobile-error-remote-disabled = Remote er slået fra på din Mac.
mobile-error-session-gone = Den session findes ikke længere.
mobile-error-no-desktop = Åbn Vmux-vinduet på din Mac.
mobile-error-refused = Din Mac kunne ikke gøre det.
mobile-error-no-answer = Intet svar fra { $address } efter { $seconds } s.

mobile-start-stacks = Stakke
mobile-start-no-stacks = Ingen åbne stakke
mobile-start-team = Team
mobile-start-search-placeholder = Søg eller spørg…
mobile-start-new-chat = Start chat
mobile-start-starting = Starter…

mobile-chat-back = Tilbage
mobile-chat-back-to-stacks = Tilbage til stakke
mobile-chat-no-messages = Ingen beskeder endnu.
mobile-chat-no-session = Ingen aktiv session
mobile-chat-placeholder = Besked til agent…
mobile-chat-send = Send
mobile-chat-stop = Stop

mobile-qr-title = Scan QR-koden, som Vmux viser
mobile-qr-cancel = Annuller
mobile-qr-unavailable = QR-scanneren er ikke tilgængelig.
mobile-qr-camera-unavailable = Kameraet er ikke tilgængeligt. Indtast parringslinket i stedet.
mobile-qr-camera-failed = Kunne ikke åbne kameraet: { $error }
mobile-qr-camera-input-unavailable = Kameraets input er ikke tilgængeligt.
mobile-qr-unsupported-device = QR-scanning er ikke tilgængelig på denne enhed.
mobile-qr-unsupported-platform = QR-scanning er endnu ikke tilgængelig på denne platform. Indtast parringslinket i stedet.
mobile-error-unexpected-answer = Din Mac svarede uventet.
mobile-error-connection-dropped = Forbindelsen til din Mac gik tabt.
...
mobile-demo-open = Tag en rundvisning uden Mac
mobile-demo-exit = Forlad rundvisningen
mobile-status-demo = Rundvisning
mobile-demo-session-title = Ret ordretotaler
mobile-demo-prompt = Ordretotalen er én øre forkert i kurve med flere varer. Kan du finde fejlen?
mobile-demo-thinking = Hvis hver linje afrundes, før de lægges sammen, forklarer det en afvigelse på én øre. Jeg ser på, hvordan totalen bygges op.
mobile-demo-answer = Summen blev udledt som et flydende tal, så hver linje blev afrundet, før den blev lagt til. Ved at typebestemme totalen som Cents forbliver den i heltalsaritmetik, og afvigelsen forsvinder.
