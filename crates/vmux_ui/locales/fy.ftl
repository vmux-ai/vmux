...
mobile-chat-allow = Tastean
mobile-chat-deny = Wegerje
mobile-chat-allow-prompt = { $name } tastean?
mobile-chat-enter-to-send = Enter om te ferstjoeren
mobile-chat-default-effort = Standertynspanning
