...
knowledge-search = Sykje Kennis
knowledge-no-match = Gjin oerienkommende notysjes
knowledge-open-linked-note = Iepenje keppele notysje
knowledge-create-linked-note = Meitsje keppele notysje
editor-properties = Eigenskippen
editor-no-properties = Gjin eigenskippen
editor-add-tags = Foegje tags ta
editor-add-property = Foegje eigendom ta
editor-change-property-type = Feroarje eigendom type
editor-add-tag = Tag taheakje
editor-add-item = Add item
editor-linked-note = Keppele notysje
editor-property-value = Wearde
editor-delete-property = Wiskje eigendom
editor-property-kind-text = Tekst
editor-property-kind-number = Nûmer
...
mobile-demo-open = Meitsje in rûnlieding sûnder Mac
mobile-demo-exit = Rûnlieding ferlitte
mobile-status-demo = Rûnlieding
mobile-demo-session-title = Oardertotalen reparearje
mobile-demo-prompt = By karkes mei meardere artikels sit it oardertotaal ien sint mis. Kinsto fine wêrom?
mobile-demo-thinking = As elke rigel foar it optellen ôfrûne wurdt, ferklearret dat in ôfwiking fan ien sint. Ik sjoch hoe’t it totaal opboud wurdt.
mobile-demo-answer = De som waard as driuwendekomma-getal ôflaat, dus elke rigel waard ôfrûne foardat er optelde waard. Troch it totaal as Cents te typearjen bliuwt it yn heeltalrekenkunde en ferdwynt de ôfwiking.
