...
mobile-demo-open = Пройдіть огляд без Mac
mobile-demo-exit = Вийти з огляду
mobile-status-demo = Огляд
mobile-demo-session-title = Виправити підсумки замовлень
mobile-demo-prompt = Підсумок замовлення відрізняється на цент у кошиках із кількома товарами. Знайдете причину?
mobile-demo-thinking = Округлення кожного рядка до підсумовування пояснило б розбіжність в один цент. Дивлюся, як обчислюється підсумок.
mobile-demo-answer = Сума виводилася як float, тому кожен рядок округлювався ще до додавання. Якщо задати підсумку тип Cents, обчислення лишаються цілочисловими і розбіжність зникає.
