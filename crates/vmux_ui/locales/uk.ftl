...
schema-update-channel = Канал оновлень
schema-update-channel-detail = Стабільний канал отримує опубліковані релізи, а попередній — нічні збірки.
schema-update-channel-stable = Стабільний
schema-update-channel-preview = Попередній
...
command-rotate-forward = Макет > Панель > Обернути панелі вперед
command-rotate-backward = Макет > Панель > Обернути панелі назад
command-mirror-panes = Макет > Панель > Віддзеркалити панелі
command-mirror-panes-horizontal = Макет > Панель > Віддзеркалити панелі горизонтально
command-mirror-panes-vertical = Макет > Панель > Віддзеркалити панелі вертикально
...
mobile-nav-untitled-chat = Чат без назви
mobile-nav-launcher = Старт
mobile-nav-new-tab = Нова вкладка
mobile-nav-unsupported = Недоступно на цьому пристрої
mobile-nav-read-only = Лише для читання
mobile-nav-open-on-mac = Відкрийте на Mac
mobile-nav-url-placeholder = Запитайте або вставте URL…
...
git-commits = Коміти
git-log = Журнал
git-command-log = Журнал команд
git-command-log-empty = Операції Git з’являться тут.
git-command-error = помилка
git-repository = Репозиторій
git-changes = Зміни
git-branches = Гілки
git-staged-changes = Індексовані зміни
git-unstaged-changes = Неіндексовані зміни
git-repository-clean = Робоче дерево чисте
git-select-file = Виберіть файл для перегляду відмінностей
git-stage = Індексувати
git-discard = Відкинути
git-recent-commits = Останні коміти
git-no-commits = Комітів ще немає
git-local-branches = Локальні гілки
git-local = Локальні
git-remote = Віддалені
git-tags = Теги
git-no-branches = Локальних гілок немає
...
git-stage-all = Індексувати все
git-switch-workspace = Змінити робочу область
git-edit-config = Редагувати файл конфігурації
git-switch-recent-repository = Перейти до нещодавнього репозиторію
git-keybindings = Сполучення клавіш
git-checkout = Перемкнутися
git-new-branch = Нова гілка
git-delete-branch = Видалити гілку
git-stashes = Сховані зміни
git-no-stashes = Немає схованих змін
git-stash = Сховати зміни
git-stash-pop = Застосувати й видалити
git-stash-drop = Видалити stash
git-amend = Доповнити коміт
git-rebase = Перебазувати
git-merge = Злити
git-fast-forward = Перемотати вперед
git-revert-commit = Скасувати коміт
git-cherry-pick = Cherry-pick
git-checkout-commit = Перейти на коміт
git-shortcut-panels = Панелі
git-shortcut-navigate = Навігація
git-shortcut-help = Комбінації клавіш
git-shortcut-title = Комбінації клавіш Git
git-shortcut-description = Доступні комбінації клавіш для цієї сторінки Git.
git-shortcut-universal = Загальні
git-shortcut-next-panel = Наступна панель
git-shortcut-previous = Попередній елемент
git-shortcut-next = Наступний елемент
