...
mobile-chat-allow = അനുവദിക്കുക
mobile-chat-deny = നിരസിക്കുക
mobile-chat-allow-prompt = { $name } അനുവദിക്കണോ?
mobile-chat-enter-to-send = അയയ്ക്കാൻ Enter
mobile-chat-default-effort = സ്ഥിരസ്ഥിതി പ്രയത്നം
