...
knowledge-search = ცოდნის ძიება
knowledge-no-match = შესატყვისი შენიშვნები არ არის
knowledge-open-linked-note = გახსენით დაკავშირებული შენიშვნა
knowledge-create-linked-note = შექმენით დაკავშირებული შენიშვნა
editor-properties = თვისებები
editor-no-properties = არ არის თვისებები
editor-add-tags = ტეგების დამატება
editor-add-property = დაამატეთ ქონება
editor-change-property-type = ქონების ტიპის შეცვლა
editor-add-tag = ტეგის დამატება
editor-add-item = ელემენტის დამატება
editor-linked-note = დაკავშირებული შენიშვნა
editor-property-value = ღირებულება
editor-delete-property = ქონების წაშლა
editor-property-kind-text = ტექსტი
editor-property-kind-number = ნომერი
editor-property-kind-checkbox = მოსანიშნი ველი
editor-property-kind-date = თარიღი
...
mobile-pair-title = დაუკავშირდით თქვენს Mac-ს
mobile-pair-subtitle = Vmux-ში გახსენით Remote და აირჩიეთ მოწყობილობის დაკავშირება.
mobile-pair-scan = QR კოდის სკანირება
mobile-pair-show-link = დაწყვილების ბმულის ხელით შეყვანა
mobile-pair-hide-link = დაწყვილების ბმულის დამალვა
mobile-pair-link-placeholder = ჩასვით დაწყვილების ბმული
mobile-pair-connect = დაკავშირება
mobile-pair-connecting = მიმდინარეობს დაკავშირება…
mobile-pair-disconnect = გათიშვა
mobile-status-connected = დაკავშირებულია
mobile-status-reaching = მიმდინარეობს თქვენს Mac-თან დაკავშირება…
mobile-status-disconnected = არ არის დაკავშირებული

mobile-url-invalid = დაწყვილების URL არასწორია.
mobile-url-no-address = დაწყვილების URL-ს სერვერის მისამართი არ აქვს.
mobile-url-bad-address = დაწყვილების URL-ში სერვერის მისამართი არასწორია.
mobile-url-no-token = დაწყვილების URL-ს ტოკენი არ აქვს.
mobile-url-scheme = დაწყვილების URL უნდა იყენებდეს HTTPS-ს ან HTTP-ს.
mobile-url-paste-full = ჩასვით სრული დაწყვილების URL, რომელსაც Vmux აჩვენებს თქვენს Mac-ზე.

mobile-error-pairing-outdated = ეს დაწყვილება მოძველებულია. ხელახლა დაასკანირეთ QR თქვენს Mac-ზე.
mobile-error-pairing-expired = დაწყვილების ვადა ამოიწურა. ხელახლა დაასკანირეთ QR თქვენს Mac-ზე.
mobile-error-pairing-lost = დაწყვილების ვადა ამოიწურა. ხელახლა დააწყვილეთ Mac-თან.
mobile-error-token-rejected = დაწყვილების ტოკენი უარყოფილია.
mobile-error-stack-missing = დესკტოპმა ჩატი გახსნა, მაგრამ მისი სტეკი არ გამოჩნდა.
mobile-error-not-offered = თქვენი Mac ამას ჯერ არ გთავაზობთ.
mobile-error-remote-disabled = Remote გამორთულია თქვენს Mac-ზე.
mobile-error-session-gone = ეს სესია აღარ არსებობს.
mobile-error-no-desktop = გახსენით Vmux-ის ფანჯარა თქვენს Mac-ზე.
mobile-error-refused = თქვენმა Mac-მა ეს ვერ შეასრულა.
mobile-error-no-answer = { $address }-დან პასუხი არ მოვიდა { $seconds } წამის შემდეგ.

mobile-start-stacks = სტეკები
mobile-start-no-stacks = ღია სტეკები არ არის
mobile-start-team = გუნდი
mobile-start-search-placeholder = მოძებნეთ ან იკითხეთ…
mobile-start-new-chat = ჩატის დაწყება
mobile-start-starting = იწყება…

mobile-chat-back = უკან
mobile-chat-back-to-stacks = სტეკებზე დაბრუნება
mobile-chat-no-messages = შეტყობინებები ჯერ არ არის.
mobile-chat-no-session = აქტიური სესია არ არის
...
mobile-qr-unavailable = QR სკანერი მიუწვდომელია.
mobile-qr-camera-unavailable = კამერა მიუწვდომელია. ამის ნაცვლად შეიყვანეთ დაწყვილების ბმული.
mobile-qr-camera-failed = კამერის გახსნა ვერ მოხერხდა: { $error }
mobile-qr-camera-input-unavailable = კამერის შეყვანა მიუწვდომელია.
mobile-qr-unsupported-device = QR სკანირება ამ მოწყობილობაზე მიუწვდომელია.
mobile-qr-unsupported-platform = QR სკანირება ამ პლატფორმაზე ჯერ არ არის ხელმისაწვდომი. ამის ნაცვლად შეიყვანეთ დაწყვილების ბმული.
mobile-error-unexpected-answer = თქვენმა Mac-მა მოულოდნელი პასუხი გასცა.
mobile-error-connection-dropped = თქვენს Mac-თან კავშირი გაწყდა.
...
mobile-demo-open = დაათვალიერეთ Mac-ის გარეშე
mobile-demo-exit = ტურიდან გასვლა
mobile-status-demo = ტური
mobile-demo-session-title = შეკვეთის ჯამების გასწორება
mobile-demo-prompt = რამდენიმე ნივთის მქონე კალათებში შეკვეთის ჯამი ერთი ცენტით ცდება. იპოვი მიზეზს?
mobile-demo-thinking = თითოეული ხაზის დამრგვალება შეკრებამდე ერთი ცენტის სხვაობას ახსნიდა. ვამოწმებ, როგორ ითვლება ჯამი.
mobile-demo-answer = ჯამი მცურავმძიმიან რიცხვად განისაზღვრებოდა, ამიტომ თითოეული ხაზი მრგვალდებოდა დამატებამდე. ჯამისთვის Cents ტიპის მინიჭება მას მთელრიცხოვან არითმეტიკაში ტოვებს და სხვაობა ქრება.
