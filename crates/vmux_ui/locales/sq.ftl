...
knowledge-search = Kërko njohuri
knowledge-no-match = Nuk ka shënime që përputhen
knowledge-open-linked-note = Hap shënimin e lidhur
knowledge-create-linked-note = Krijo shënim të lidhur
editor-properties = Vetitë
editor-no-properties = Nuk ka prona
editor-add-tags = Shto etiketa
editor-add-property = Shto pronë
editor-change-property-type = Ndrysho llojin e pronës
editor-add-tag = Shto etiketë
editor-add-item = Shto artikull
editor-linked-note = Shënim i lidhur
editor-property-value = Vlera
editor-delete-property = Fshi pronën
editor-property-kind-text = Teksti
editor-property-kind-number = Numri
editor-property-kind-checkbox = Kutia e zgjedhjes
...
mobile-pair-title = Lidhu me Mac-un tënd
mobile-pair-subtitle = Në Vmux, hap Remote dhe zgjidh Connect device.
mobile-pair-scan = Skano kodin QR
mobile-pair-show-link = Shkruaj vetë lidhjen e çiftimit
mobile-pair-hide-link = Fshih lidhjen e çiftimit
mobile-pair-link-placeholder = Ngjit lidhjen e çiftimit
mobile-pair-connect = Lidhu
mobile-pair-connecting = Po lidhet…
mobile-pair-disconnect = Shkëputu
mobile-status-connected = I lidhur
mobile-status-reaching = Po kontaktohet Mac-u yt…
mobile-status-disconnected = I palidhur

mobile-url-invalid = URL-ja e çiftimit nuk është e vlefshme.
mobile-url-no-address = URL-ja e çiftimit nuk ka adresë serveri.
mobile-url-bad-address = URL-ja e çiftimit ka një adresë serveri të pavlefshme.
mobile-url-no-token = URL-ja e çiftimit nuk ka token.
mobile-url-scheme = URL-ja e çiftimit duhet të përdorë HTTPS ose HTTP.
mobile-url-paste-full = Ngjit URL-në e plotë të çiftimit që shfaqet nga Vmux në Mac-un tënd.

mobile-error-pairing-outdated = Ky çiftim është i vjetruar. Skano sërish QR-in në Mac-un tënd.
mobile-error-pairing-expired = Çiftimi skadoi. Skano sërish QR-in në Mac-un tënd.
mobile-error-pairing-lost = Çiftimi skadoi. Çiftohu sërish me Mac-un.
mobile-error-token-rejected = Tokeni i çiftimit u refuzua.
mobile-error-stack-missing = Desktopi e hapi bisedën, por shtresa e saj nuk u shfaq.
mobile-error-not-offered = Mac-u yt nuk e ofron ende këtë.
mobile-error-remote-disabled = Remote është i çaktivizuar në Mac-un tënd.
mobile-error-session-gone = Ai sesion nuk ekziston më.
mobile-error-no-desktop = Hap dritaren e Vmux në Mac-un tënd.
mobile-error-refused = Mac-u yt nuk mundi ta bënte këtë.
mobile-error-no-answer = Asnjë përgjigje nga { $address } pas { $seconds } sekondash.

mobile-start-stacks = Shtresat
mobile-start-no-stacks = Nuk ka shtresa të hapura
mobile-start-team = Ekipi
mobile-start-search-placeholder = Kërko ose pyet…
mobile-start-new-chat = Nis bisedën
mobile-start-starting = Po niset…

mobile-chat-back = Prapa
mobile-chat-back-to-stacks = Kthehu te shtresat
mobile-chat-no-messages = Ende asnjë mesazh.
mobile-chat-no-session = Asnjë sesion aktiv
...
mobile-qr-unavailable = Skaneri i QR nuk është i disponueshëm.
mobile-qr-camera-unavailable = Kamera nuk është e disponueshme. Fut lidhjen e çiftimit.
mobile-qr-camera-failed = Kamera nuk u hap: { $error }
mobile-qr-camera-input-unavailable = Hyrja e kamerës nuk është e disponueshme.
mobile-qr-unsupported-device = Skanimi i QR nuk mbështetet në këtë pajisje.
mobile-qr-unsupported-platform = Skanimi i QR nuk ofrohet ende në këtë platformë. Fut lidhjen e çiftimit.
mobile-error-unexpected-answer = Mac-u yt u përgjigj në mënyrë të papritur.
mobile-error-connection-dropped = Lidhja me Mac-un tënd u ndërpre.
...
mobile-demo-open = Bëj një tur pa Mac
mobile-demo-exit = Dil nga turi
mobile-status-demo = Tur
mobile-demo-session-title = Rregullo totalet e porosive
mobile-demo-prompt = Totali i porosisë del një cent gabim te shportat me disa artikuj. A e gjen dot shkakun?
mobile-demo-thinking = Rrumbullakimi i çdo rreshti para mbledhjes do ta shpjegonte një ndryshim prej një centi. Po shoh si ndërtohet totali.
mobile-demo-answer = Shuma po nxirrej si float, kështu që çdo rresht rrumbullakosej para se të mblidhej. Duke i dhënë totalit tipin Cents, ai qëndron në aritmetikë me numra të plotë dhe ndryshimi zhduket.
