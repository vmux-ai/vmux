...
mobile-demo-open = ያለ Mac ጉብኝት ያድርጉ
mobile-demo-exit = ከጉብኝቱ ይውጡ
mobile-status-demo = ጉብኝት
mobile-demo-session-title = የትዕዛዝ ድምሮችን ማስተካከል
mobile-demo-prompt = ብዙ ዕቃ ባላቸው ጋሪዎች ላይ የትዕዛዙ ድምር በአንድ ሳንቲም ይሳሳታል። ምክንያቱን ማግኘት ትችላለህ?
mobile-demo-thinking = እያንዳንዱን መስመር ከመደመሩ በፊት ማጠጋጋት የአንድ ሳንቲም ልዩነት ሊያስረዳ ይችላል። ድምሩ እንዴት እንደሚሰላ እየተመለከትኩ ነው።
mobile-demo-answer = ድምሩ እንደ ተንሳፋፊ ቁጥር ስለተወሰደ እያንዳንዱ መስመር ከመደመሩ በፊት ተጠጋግቷል። ድምሩን እንደ Cents አይነት መስጠት በኢንቲጀር ስሌት ውስጥ ያቆየዋል እና ልዩነቱ ይጠፋል።
