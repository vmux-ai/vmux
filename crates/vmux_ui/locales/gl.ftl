...
vault-recovery-key-create-failed = Non se puido crear a chave de recuperación.
vault-recovery-key-save = Garda esta chave agora. Vmux non pode mostralo de novo.
vault-recovery-key-saved = Gardeino
vault-recovery-key-placeholder = Pegar clave de recuperación
vault-recovery-key-unlock = Desbloquear
vault-recovery-key-invalid = Esta chave de recuperación non pode desbloquear a bóveda.
vault-recovery-key-ready = Chave de recuperación configurada
vault-recovery-key-upload-pending = A chave gárdase localmente, pero fallou a carga. Mantéñao seguro e preme Sincronizar para tentalo de novo.
vault-auto-sync = Copia de seguranza automática
vault-backup-failed = Fallou a copia de seguranza automática. Preme Sincronizar para tentalo de novo.
vault-backup-failed-short = Produciuse un erro na copia de seguranza
vault-recovery-key-copy-hint = Fai clic para copiar
vault-recovery-key-copied = Copiouse
vault-recovery-key-verify = Gárdao no teu xestor de contrasinais e pégao a continuación para verificalo.
vault-recovery-key-verify-placeholder = Pega a chave de recuperación gardada
vault-recovery-key-mismatch = A clave de recuperación non coincide.
...
vault-github = GitHub
vault-github-description = Cree un repositorio privado ou escolle unha bóveda existente.
vault-connect-github = Conecta GitHub
vault-connected-as = Conectado como { $name }
vault-use-repository = Use
vault-repository-name = Nome do repositorio
vault-cloud-folder = Cartafol de nube
vault-cloud-folder-description = Usa un cartafol de Google Drive, iCloud Drive, Dropbox ou OneDrive.
vault-choose-folder = Escolla cartafol
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Cartafol · { common-done }
vault-private = Repositorio privado
vault-public-warning = O historial do repositorio e os datos cifrados serán públicos.
...
knowledge-search = Busca Coñecemento
knowledge-no-match = Non hai notas coincidentes
...
editor-no-properties = Sen propiedades
editor-add-tags = Engadir etiquetas
editor-add-property = Engadir propiedade
editor-change-property-type = Cambiar o tipo de propiedade
editor-add-tag = Engadir etiqueta
editor-add-item = Engadir elemento
editor-linked-note = Nota vinculada
editor-property-value = Valor
editor-delete-property = Eliminar propiedade
editor-property-kind-text = Texto
editor-property-kind-number = Número
editor-property-kind-checkbox = Caixa de verificación
...
mobile-pair-title = Conectar co teu Mac
mobile-pair-subtitle = En Vmux, abre Remote e escolle Connect device.
mobile-pair-scan = Escanear código QR
mobile-pair-show-link = Introducir a ligazón de emparellamento
mobile-pair-hide-link = Agochar a ligazón de emparellamento
mobile-pair-link-placeholder = Pega a ligazón de emparellamento
...
mobile-status-reaching = Contactando co teu Mac…
mobile-status-disconnected = Sen conexión

mobile-url-invalid = O URL de emparellamento non é válido.
mobile-url-no-address = O URL de emparellamento non ten enderezo de servidor.
mobile-url-bad-address = O URL de emparellamento ten un enderezo de servidor non válido.
mobile-url-no-token = O URL de emparellamento non ten token.
mobile-url-scheme = O URL de emparellamento debe usar HTTPS ou HTTP.
mobile-url-paste-full = Pega o URL de emparellamento completo que amosa Vmux no teu Mac.

mobile-error-pairing-outdated = Este emparellamento está desactualizado. Escanea de novo o QR no teu Mac.
mobile-error-pairing-expired = O emparellamento caducou. Escanea de novo o QR no teu Mac.
mobile-error-pairing-lost = O emparellamento caducou. Emparella de novo co Mac.
mobile-error-token-rejected = Rexeitouse o token de emparellamento.
mobile-error-stack-missing = O escritorio abriu o chat, pero a súa pila non apareceu.
mobile-error-not-offered = O teu Mac aínda non ofrece isto.
mobile-error-remote-disabled = Remote está desactivado no teu Mac.
mobile-error-session-gone = Esa sesión xa non existe.
mobile-error-no-desktop = Abre a xanela de Vmux no teu Mac.
mobile-error-refused = O teu Mac non puido facer iso.
mobile-error-no-answer = Sen resposta de { $address } tras { $seconds } s.

mobile-start-stacks = Pilas
mobile-start-no-stacks = Non hai pilas abertas
mobile-start-team = Equipo
mobile-start-search-placeholder = Busca ou pregunta…
mobile-start-new-chat = Iniciar chat
mobile-start-starting = Iniciando…

mobile-chat-back = Atrás
mobile-chat-back-to-stacks = Volver ás pilas
mobile-chat-no-messages = Aínda non hai mensaxes.
mobile-chat-no-session = Non hai sesión activa
mobile-chat-placeholder = Mensaxe ao axente…
mobile-chat-send = Enviar
mobile-chat-stop = Deter

mobile-qr-title = Escanea o código QR que amosa Vmux
mobile-qr-cancel = Cancelar
mobile-qr-unavailable = O escáner QR non está dispoñible.
mobile-qr-camera-unavailable = Cámara non dispoñible. Introduce a ligazón de emparellamento.
mobile-qr-camera-failed = Non se puido abrir a cámara: { $error }
mobile-qr-camera-input-unavailable = A entrada da cámara non está dispoñible.
mobile-qr-unsupported-device = O escaneo de QR non está dispoñible neste dispositivo.
mobile-qr-unsupported-platform = O escaneo de QR aínda non está dispoñible nesta plataforma. Introduce a ligazón de emparellamento.
mobile-error-unexpected-answer = O teu Mac respondeu de forma inesperada.
mobile-error-connection-dropped = Perdeuse a conexión co teu Mac.
...
mobile-demo-open = Fai un percorrido sen Mac
mobile-demo-exit = Saír do percorrido
mobile-status-demo = Percorrido
mobile-demo-session-title = Corrixir os totais dos pedidos
mobile-demo-prompt = O total do pedido desvíase un céntimo nos carros con varios artigos. Podes atopar por que?
mobile-demo-thinking = Redondear cada liña antes de sumalas explicaría unha desviación dun céntimo. Estou vendo como se calcula o total.
mobile-demo-answer = A suma inferíase como coma flotante, así que cada liña se redondeaba antes de sumarse. Se se lle dá ao total o tipo Cents, o cálculo mantense en aritmética enteira e a desviación desaparece.
