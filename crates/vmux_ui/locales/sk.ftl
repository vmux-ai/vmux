...
knowledge-search = Hľadať znalosti
knowledge-no-match = Žiadne zodpovedajúce poznámky
knowledge-open-linked-note = Otvorte prepojenú poznámku
knowledge-create-linked-note = Vytvorte prepojenú poznámku
editor-properties = Vlastnosti
editor-no-properties = Žiadne vlastnosti
editor-add-tags = Pridajte značky
editor-add-property = Pridať vlastnosť
editor-change-property-type = Zmeňte typ vlastnosti
editor-add-tag = Pridať značku
editor-add-item = Pridať položku
editor-linked-note = Prepojená poznámka
editor-property-value = Hodnota
editor-delete-property = Odstrániť vlastnosť
editor-property-kind-text = Text
editor-property-kind-number = číslo
editor-property-kind-checkbox = začiarkavacie políčko
...
mobile-demo-open = Prejdite si prehliadku bez Mac
mobile-demo-exit = Ukončiť prehliadku
mobile-status-demo = Prehliadka
mobile-demo-session-title = Opraviť súčty objednávok
mobile-demo-prompt = Súčet objednávky sa líši o cent pri košíkoch s viacerými položkami. Nájdete príčinu?
mobile-demo-thinking = Zaokrúhlenie každého riadka pred sčítaním by vysvetlilo odchýlku o jeden cent. Pozerám sa, ako sa súčet počíta.
mobile-demo-answer = Súčet sa odvodzoval ako float, takže každý riadok sa zaokrúhlil ešte pred pripočítaním. Ak sa súčtu priradí typ Cents, zostane v celočíselnej aritmetike a odchýlka zmizne.
