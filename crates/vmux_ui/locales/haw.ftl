...
mobile-chat-stop = Kū
mobile-chat-allow = ʻAe
mobile-chat-deny = Hōʻole
mobile-chat-allow-prompt = ʻAe iā { $name }?
mobile-chat-enter-to-send = Enter e hoʻouna
mobile-chat-default-effort = Hoʻoikaika maʻamau
