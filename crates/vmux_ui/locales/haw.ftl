...
knowledge-search = Huli ʻIke
knowledge-no-match = ʻAʻohe memo pili
knowledge-open-linked-note = E wehe i ka leka pili
knowledge-create-linked-note = Hana i ka leka pili
editor-properties = Waiwai
editor-no-properties = ʻAʻohe waiwai
editor-add-tags = Hoʻohui i nā hōʻailona
editor-add-property = Hoʻohui waiwai
editor-change-property-type = Hoʻololi i ke ʻano waiwai
editor-add-tag = Hoʻohui i ka hōʻailona
editor-add-item = Hoʻohui mea
editor-linked-note = Palapala pili
editor-property-value = Waiwai
editor-delete-property = Holoi waiwai
editor-property-kind-text = kikokikona
editor-property-kind-number = Helu
editor-property-kind-checkbox = Pahu koho
editor-property-kind-date = Lā
...
mobile-demo-open = E kāʻapuni me ka Mac ʻole
mobile-demo-exit = E haʻalele i ka kāʻapuni
mobile-status-demo = Kāʻapuni
mobile-demo-session-title = Hoʻoponopono i nā huina kauoha
mobile-demo-prompt = Ua hewa ka huina kauoha ma ke keneka hoʻokahi ma nā kāleka me nā mea he nui. Hiki iā ʻoe ke ʻimi i ke kumu?
mobile-demo-thinking = Inā e hoʻopuni ʻia kēlā me kēia laina ma mua o ka hoʻohui ʻana, e wehewehe ana kēlā i ka ʻokoʻa keneka hoʻokahi. Ke nānā nei au i ke kūkulu ʻia ʻana o ka huina.
mobile-demo-answer = Ua manaʻo ʻia ka huina he helu lana, no laila ua hoʻopuni ʻia kēlā me kēia laina ma mua o ka hoʻohui ʻia ʻana. Ma ka hāʻawi ʻana i ke ʻano Cents i ka huina, mau nō ia ma ka helu piha a nalowale ka ʻokoʻa.
