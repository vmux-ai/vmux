...
knowledge-search = Ieškoti žinių
knowledge-no-match = Nėra atitinkančių užrašų
knowledge-open-linked-note = Atidaryti susietą pastabą
knowledge-create-linked-note = Sukurti susietą užrašą
editor-properties = Savybės
editor-no-properties = Nėra savybių
editor-add-tags = Pridėti žymas
editor-add-property = Pridėti nuosavybę
editor-change-property-type = Pakeiskite nuosavybės tipą
editor-add-tag = Pridėti žymą
editor-add-item = Pridėti elementą
editor-linked-note = Susieta pastaba
editor-property-value = Vertė
editor-delete-property = Ištrinti nuosavybę
editor-property-kind-text = Tekstas
editor-property-kind-number = Skaičius
editor-property-kind-checkbox = Žymimasis laukelis
...
mobile-pair-title = Prisijunkite prie savo Mac
mobile-pair-subtitle = Vmux atidarykite Remote ir pasirinkite Prijungti įrenginį.
mobile-pair-scan = Nuskaityti QR kodą
mobile-pair-show-link = Įvesti susiejimo nuorodą ranka
mobile-pair-hide-link = Slėpti susiejimo nuorodą
mobile-pair-link-placeholder = Įklijuokite susiejimo nuorodą
mobile-pair-connect = Prisijungti
mobile-pair-connecting = Jungiamasi…
mobile-pair-disconnect = Atsijungti
mobile-status-connected = Prisijungta
mobile-status-reaching = Ieškoma jūsų Mac…
mobile-status-disconnected = Neprisijungta

mobile-url-invalid = Susiejimo URL netinkamas.
mobile-url-no-address = Susiejimo URL nėra serverio adreso.
mobile-url-bad-address = Susiejimo URL serverio adresas netinkamas.
mobile-url-no-token = Susiejimo URL nėra atpažinimo rakto.
mobile-url-scheme = Susiejimo URL turi naudoti HTTPS arba HTTP.
mobile-url-paste-full = Įklijuokite visą susiejimo URL, rodomą Vmux jūsų Mac kompiuteryje.

mobile-error-pairing-outdated = Šis susiejimas pasenęs. Dar kartą nuskaitykite QR savo Mac.
mobile-error-pairing-expired = Susiejimo galiojimas baigėsi. Dar kartą nuskaitykite QR savo Mac.
mobile-error-pairing-lost = Susiejimo galiojimas baigėsi. Susiekite su Mac iš naujo.
mobile-error-token-rejected = Susiejimo raktas atmestas.
mobile-error-stack-missing = Kompiuteris atidarė pokalbį, bet jo sluoksnis nepasirodė.
mobile-error-not-offered = Jūsų Mac to dar nesiūlo.
mobile-error-remote-disabled = Remote jūsų Mac yra išjungtas.
mobile-error-session-gone = Tos sesijos nebėra.
mobile-error-no-desktop = Atidarykite Vmux langą savo Mac.
mobile-error-refused = Jūsų Mac to atlikti negalėjo.
mobile-error-no-answer = Nėra atsakymo iš { $address } po { $seconds } s.

mobile-start-stacks = Sluoksniai
mobile-start-no-stacks = Nėra atvirų sluoksnių
mobile-start-team = Komanda
mobile-start-search-placeholder = Ieškokite arba klauskite…
mobile-start-new-chat = Pradėti pokalbį
mobile-start-starting = Pradedama…

mobile-chat-back = Atgal
mobile-chat-back-to-stacks = Atgal į sluoksnius
mobile-chat-no-messages = Žinučių dar nėra.
mobile-chat-no-session = Nėra aktyvios sesijos
...
mobile-qr-unavailable = QR skaitytuvas nepasiekiamas.
mobile-qr-camera-unavailable = Kamera nepasiekiama. Vietoj to įveskite susiejimo nuorodą.
mobile-qr-camera-failed = Nepavyko įjungti kameros: { $error }
mobile-qr-camera-input-unavailable = Kameros įvestis nepasiekiama.
mobile-qr-unsupported-device = QR nuskaitymas šiame įrenginyje nepasiekiamas.
mobile-qr-unsupported-platform = QR nuskaitymas šioje platformoje dar nepasiekiamas. Vietoj to įveskite susiejimo nuorodą.
mobile-error-unexpected-answer = Jūsų Mac atsakė netikėtai.
mobile-error-connection-dropped = Ryšys su jūsų Mac nutrūko.
...
mobile-demo-open = Apžvalga be Mac
mobile-demo-exit = Išeiti iš apžvalgos
mobile-status-demo = Apžvalga
mobile-demo-session-title = Pataisyti užsakymų sumas
mobile-demo-prompt = Krepšeliuose su keliomis prekėmis užsakymo suma skiriasi vienu centu. Ar rasi kodėl?
mobile-demo-thinking = Jei kiekviena eilutė suapvalinama prieš sudedant, tai paaiškintų vieno cento skirtumą. Žiūriu, kaip sudaroma suma.
mobile-demo-answer = Suma buvo išvedama kaip slankiojo kablelio skaičius, todėl kiekviena eilutė buvo suapvalinama prieš pridedant. Sumai priskyrus tipą Cents, skaičiavimas lieka sveikųjų skaičių aritmetikoje ir skirtumas dingsta.
