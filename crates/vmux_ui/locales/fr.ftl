...
mobile-chat-allow = Autoriser
mobile-chat-deny = Refuser
mobile-chat-allow-prompt = Autoriser { $name } ?
mobile-chat-enter-to-send = Entrée pour envoyer
mobile-chat-default-effort = Effort par défaut
