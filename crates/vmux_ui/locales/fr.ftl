...
mobile-demo-open = Faire une visite sans Mac
mobile-demo-exit = Quitter la visite
mobile-status-demo = Visite
mobile-demo-session-title = Corriger les totaux de commande
mobile-demo-prompt = Le total de la commande est faux d’un centime sur les paniers à plusieurs articles. Tu peux trouver pourquoi ?
mobile-demo-thinking = Arrondir chaque ligne avant de les additionner expliquerait un écart d’un centime. Je regarde comment le total est calculé.
mobile-demo-answer = La somme était inférée en virgule flottante, donc chaque ligne était arrondie avant d’être ajoutée. En typant le total comme Cents, le calcul reste en arithmétique entière et l’écart disparaît.
