...
vault-recovery-key-create-failed = Taastevõtit ei saanud luua.
vault-recovery-key-save = Salvestage see võti kohe. Vmux ei saa seda uuesti näidata.
vault-recovery-key-saved = Ma salvestasin selle
vault-recovery-key-placeholder = Kleebi taastevõti
vault-recovery-key-unlock = Ava
vault-recovery-key-invalid = See taastevõti ei saa varahoidlat avada.
vault-recovery-key-ready = Taastevõti on konfigureeritud
vault-recovery-key-upload-pending = Võti salvestatakse kohapeal, kuid üleslaadimine ebaõnnestus. Hoidke seda turvaliselt ja vajutage uuesti proovimiseks nuppu Sünkrooni.
vault-auto-sync = Automaatne varundamine
vault-backup-failed = Automaatne varundamine ebaõnnestus. Uuesti proovimiseks vajutage sünkrooni.
vault-backup-failed-short = Varundamine ebaõnnestus
vault-recovery-key-copy-hint = Kopeerimiseks klõpsake
vault-recovery-key-copied = Kopeeritud
vault-recovery-key-verify = Salvestage see oma paroolihaldurisse, seejärel kleepige see kinnitamiseks alla.
vault-recovery-key-verify-placeholder = Kleebi salvestatud taastevõti
vault-recovery-key-mismatch = Taastevõti ei ühti.
...
vault-github = GitHub
vault-github-description = Looge privaatne hoidla või valige olemasolev Vault.
vault-connect-github = Ühendage GitHub
vault-connected-as = Ühendatud kui { $name }
vault-use-repository = Kasuta
vault-repository-name = Hoidla nimi
vault-cloud-folder = Pilvekaust
vault-cloud-folder-description = Kasutage Google Drive'i, iCloud Drive'i, Dropboxi või OneDrive'i kausta.
vault-choose-folder = Valige kaust
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = Kaust · { common-done }
vault-private = Privaatne hoidla
vault-public-warning = Hoidla ajalugu ja krüpteeritud andmed on avalikud.
...
knowledge-search = Otsige teadmisi
knowledge-no-match = Sobivaid märkmeid pole
knowledge-open-linked-note = Ava lingitud märge
knowledge-create-linked-note = Loo lingitud märge
editor-properties = Omadused
editor-no-properties = Ei mingeid omadusi
editor-add-tags = Lisa sildid
editor-add-property = Lisa vara
editor-change-property-type = Muuda vara tüüpi
editor-add-tag = Lisa silt
editor-add-item = Lisa üksus
editor-linked-note = Lingitud märkus
editor-property-value = Väärtus
editor-delete-property = Vara kustutamine
editor-property-kind-text = Tekst
editor-property-kind-number = Number
editor-property-kind-checkbox = Märkeruut
editor-property-kind-date = Kuupäev
...
mobile-pair-title = Ühenda oma Maciga
mobile-pair-subtitle = Ava Vmuxis Remote ja vali Connect device.
mobile-pair-scan = Skanni QR-kood
mobile-pair-show-link = Sisesta sidumislink käsitsi
mobile-pair-hide-link = Peida sidumislink
mobile-pair-link-placeholder = Kleebi sidumislink
mobile-pair-connect = Ühenda
mobile-pair-connecting = Ühendamine…
mobile-pair-disconnect = Katkesta ühendus
mobile-status-connected = Ühendatud
mobile-status-reaching = Maciga ühenduse loomine…
mobile-status-disconnected = Ühendus puudub

mobile-url-invalid = Sidumise URL on vigane.
mobile-url-no-address = Sidumise URL-is puudub serveri aadress.
mobile-url-bad-address = Sidumise URL-is on vigane serveri aadress.
mobile-url-no-token = Sidumise URL-is puudub token.
mobile-url-scheme = Sidumise URL peab kasutama HTTPS-i või HTTP-d.
mobile-url-paste-full = Kleebi kogu sidumise URL, mida Vmux sinu Macis näitab.

mobile-error-pairing-outdated = See sidumine on aegunud. Skanni Maci QR-kood uuesti.
mobile-error-pairing-expired = Sidumine aegus. Skanni Maci QR-kood uuesti.
mobile-error-pairing-lost = Sidumine aegus. Seo Maciga uuesti.
mobile-error-token-rejected = Sidumistoken lükati tagasi.
mobile-error-stack-missing = Töölaud avas vestluse, kuid selle virna ei ilmunud.
mobile-error-not-offered = Sinu Mac ei paku seda veel.
mobile-error-remote-disabled = Remote on sinu Macis välja lülitatud.
mobile-error-session-gone = Seda seanssi enam ei ole.
mobile-error-no-desktop = Ava Vmuxi aken oma Macis.
mobile-error-refused = Sinu Mac ei saanud seda teha.
mobile-error-no-answer = { $address } ei vastanud { $seconds } sekundi jooksul.

mobile-start-stacks = Virnad
mobile-start-no-stacks = Avatud virnu pole
mobile-start-team = Tiim
mobile-start-search-placeholder = Otsi või küsi…
mobile-start-new-chat = Alusta vestlust
mobile-start-starting = Käivitamine…

mobile-chat-back = Tagasi
mobile-chat-back-to-stacks = Tagasi virnade juurde
mobile-chat-no-messages = Sõnumeid veel pole.
mobile-chat-no-session = Aktiivset seanssi pole
...
mobile-qr-unavailable = QR-skanner pole saadaval.
mobile-qr-camera-unavailable = Kaamera pole saadaval. Sisesta selle asemel sidumislink.
mobile-qr-camera-failed = Kaamerat ei õnnestunud avada: { $error }
mobile-qr-camera-input-unavailable = Kaamera sisend pole saadaval.
mobile-qr-unsupported-device = QR-skannimine pole selles seadmes saadaval.
mobile-qr-unsupported-platform = QR-skannimine pole sellel platvormil veel saadaval. Sisesta selle asemel sidumislink.
mobile-error-unexpected-answer = Sinu Mac vastas ootamatult.
mobile-error-connection-dropped = Ühendus sinu Maciga katkes.
...
mobile-demo-open = Tee tuur ilma Macita
mobile-demo-exit = Välju tuurist
mobile-status-demo = Tuur
mobile-demo-session-title = Paranda tellimuste summad
mobile-demo-prompt = Mitme tootega ostukorvides erineb tellimuse summa ühe sendi võrra. Kas leiad põhjuse?
mobile-demo-thinking = Iga rea ümardamine enne liitmist selgitaks ühe sendi suurust erinevust. Vaatan, kuidas summa kokku pannakse.
mobile-demo-answer = Summa tuletati ujukomaarvuna, seega ümardati iga rida enne liitmist. Kui anda summale tüüp Cents, jääb arvutus täisarvuliseks ja erinevus kaob.
