...
knowledge-search = Fittex Għarfien
knowledge-no-match = L-ebda noti li jaqblu
knowledge-open-linked-note = Iftaħ nota marbuta
knowledge-create-linked-note = Oħloq nota marbuta
editor-properties = Proprjetajiet
editor-no-properties = Ebda proprjetajiet
editor-add-tags = Żid tags
editor-add-property = Żid proprjetà
editor-change-property-type = Ibdel it-tip ta' proprjetà
editor-add-tag = Żid tag
editor-add-item = Żid oġġett
editor-linked-note = Nota marbuta
editor-property-value = Valur
editor-delete-property = Ħassar proprjetà
editor-property-kind-text = Test
editor-property-kind-number = Numru
...
mobile-pair-title = Qabbad mal-Mac tiegħek
mobile-pair-subtitle = F’Vmux, iftaħ Remote u agħżel Connect device.
mobile-pair-scan = Skennja l-kodiċi QR
mobile-pair-show-link = Daħħal il-link tal-pairing manwalment
mobile-pair-hide-link = Aħbi l-link tal-pairing
mobile-pair-link-placeholder = Paste il-link tal-pairing
mobile-pair-connect = Qabbad
mobile-pair-connecting = Qed jaqbad…
mobile-pair-disconnect = Skonnettja
mobile-status-connected = Konness
mobile-status-reaching = Qed jipprova jilħaq il-Mac tiegħek…
mobile-status-disconnected = Mhux konness

mobile-url-invalid = L-URL tal-pairing mhuwiex validu.
mobile-url-no-address = L-URL tal-pairing m’għandux indirizz tas-server.
mobile-url-bad-address = L-URL tal-pairing għandu indirizz tas-server invalidu.
mobile-url-no-token = L-URL tal-pairing m’għandux token.
mobile-url-scheme = L-URL tal-pairing irid juża HTTPS jew HTTP.
mobile-url-paste-full = Paste l-URL sħiħ tal-pairing li juri Vmux fuq il-Mac tiegħek.

mobile-error-pairing-outdated = Dan il-pairing skada. Erġa’ skennja l-QR fuq il-Mac tiegħek.
mobile-error-pairing-expired = Il-pairing skada. Erġa’ skennja l-QR fuq il-Mac tiegħek.
mobile-error-pairing-lost = Il-pairing skada. Erġa’ agħmel pairing mal-Mac.
mobile-error-token-rejected = It-token tal-pairing ġie rrifjutat.
mobile-error-stack-missing = Id-desktop fetaħ iċ-chat, imma l-istack tiegħu ma dehritx.
mobile-error-not-offered = Il-Mac tiegħek għadu ma joffrix dan.
mobile-error-remote-disabled = Remote huwa mitfi fuq il-Mac tiegħek.
mobile-error-session-gone = Dik is-sessjoni m’għadhiex hemm.
mobile-error-no-desktop = Iftaħ it-tieqa ta’ Vmux fuq il-Mac tiegħek.
mobile-error-refused = Il-Mac tiegħek ma setax jagħmel dan.
mobile-error-no-answer = L-ebda tweġiba minn { $address } wara { $seconds }s.

mobile-start-stacks = Stacks
mobile-start-no-stacks = L-ebda stack miftuħ
mobile-start-team = Tim
mobile-start-search-placeholder = Fittex jew staqsi…
mobile-start-new-chat = Ibda chat
mobile-start-starting = Qed jibda…

mobile-chat-back = Lura
mobile-chat-back-to-stacks = Lura għall-istacks
mobile-chat-no-messages = Għad m’hemmx messaġġi.
mobile-chat-no-session = L-ebda sessjoni attiva
...
mobile-qr-unavailable = L-iskaner QR mhux disponibbli.
mobile-qr-camera-unavailable = Il-kamera mhix disponibbli. Daħħal il-link tal-pairing minflok.
mobile-qr-camera-failed = Ma setgħetx tinfetaħ il-kamera: { $error }
mobile-qr-camera-input-unavailable = L-input tal-kamera mhux disponibbli.
mobile-qr-unsupported-device = L-iskennjar QR mhux disponibbli fuq dan l-apparat.
mobile-qr-unsupported-platform = L-iskennjar QR għadu mhux disponibbli fuq din il-pjattaforma. Daħħal il-link tal-pairing minflok.
mobile-error-unexpected-answer = Il-Mac tiegħek wieġeb b’mod mhux mistenni.
mobile-error-connection-dropped = Il-konnessjoni mal-Mac tiegħek inqatgħet.
...
mobile-demo-open = Agħmel ġita mingħajr Mac
mobile-demo-exit = Oħroġ mill-ġita
mobile-status-demo = Ġita
mobile-demo-session-title = Irranġa t-totali tal-ordnijiet
mobile-demo-prompt = It-total tal-ordni hu żbaljat b’ċenteżmu f’karrettuni b’ħafna oġġetti. Tista’ ssib għaliex?
mobile-demo-thinking = It-tqarrib ta’ kull linja qabel is-somma jispjega devjazzjoni ta’ ċenteżmu wieħed. Qed nara kif jinbena t-total.
mobile-demo-answer = Is-somma kienet qed tiġi dedotta bħala float, għalhekk kull linja kienet titqarreb qabel ma tiżdied. Jekk it-total jiġi ttajpjat bħala Cents, jibqa’ fl-aritmetika ta’ numri sħaħ u d-devjazzjoni tisparixxi.
