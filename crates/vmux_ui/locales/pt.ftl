...
mobile-chat-allow = Permitir
mobile-chat-deny = Recusar
mobile-chat-allow-prompt = Permitir { $name }?
mobile-chat-enter-to-send = Enter para enviar
mobile-chat-default-effort = Esforço predefinido
