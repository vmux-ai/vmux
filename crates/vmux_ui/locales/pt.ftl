...
tools-search = Procurar pacotes, agentes, MCP, LSP e ficheiros de configuração…
...
schema-tidy-files = Limpeza de arquivos
schema-tidy-files-max = Limite de limpeza de arquivos
schema-tidy-files-auto = Limpar arquivos automaticamente
...
schema-environment = Variáveis de ambiente
...
schema-cursor-blink = Cursor intermitente
...
schema-language-id = ID da linguagem
...
layout-move-to-bookmarks = Mover para Marcadores
...
layout-bookmark-in = Adicionar marcador em { $folder }
...
error-unknown-host = Anfitrião da app Vmux desconhecido: { $host }
...
command-rename-tab = Disposição > Separador > Renomear separador
...
command-browser-prev-page = Navegador > Navegação > Retroceder
...
command-browser-zoom-in = Navegador > Ver > Ampliar
command-browser-zoom-out = Navegador > Ver > Reduzir
command-browser-zoom-reset = Navegador > Ver > Tamanho real
command-browser-dev-tools = Navegador > Ver > Ferramentas de programador
...
command-bookmark-toggle-active = Marcador > Adicionar página aos marcadores
...
layout-bookmark-current-page = Adicionar página atual aos marcadores
...
agent-preparing = A preparar o agente…
agent-send-all-queued = Enviar agora todos os pedidos em fila (Esc)
agent-send = Enviar (Enter)
agent-ready = Pronto quando quiser.
agent-loading-older = A carregar mensagens anteriores…
...
agent-tool-searched-files = Procurou ficheiros
...
agent-reconnecting = A restabelecer ligação { $attempt }/{ $total }
...
agent-working-pondering = A refletir
agent-working-noodling = A explorar ideias
agent-working-percolating = A amadurecer ideias
agent-working-conjuring = A conjurar
agent-working-cooking = A cozinhar
agent-working-brewing = A fermentar ideias
agent-working-musing = A meditar
agent-working-ruminating = A ruminar
agent-working-scheming = A planear
agent-working-synthesizing = A sintetizar
agent-working-tinkering = A afinar
...
agent-working-divining = A descobrir
agent-working-mulling = A ponderar
agent-working-spelunking = A escavar

editor-toggle-explorer = Mostrar/ocultar Explorador (Cmd+B)
editor-unsaved = por guardar
editor-rendered-markdown = Markdown renderizado com edição em direto
editor-note = Nota
editor-source-editor = Editor de código-fonte
editor-editor = Editor
editor-git-diff = Diferenças Git
editor-diff = Diferenças
editor-tidy = Arrumação
...
git-unstage = Remover da área de preparação
...
setup-install-title = Instalar a CLI { $name }
...
setup-terminal-instructions = No terminal, prima Return para começar e, quando solicitado, introduza a palavra-passe do Mac.
