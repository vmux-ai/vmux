...
knowledge-search = Cuardaigh Eolais
knowledge-no-match = Gan nótaí meaitseála
knowledge-open-linked-note = Oscail nóta nasctha
knowledge-create-linked-note = Cruthaigh nóta nasctha
editor-properties = Airíonna
editor-no-properties = Gan airíonna
editor-add-tags = Cuir clibeanna leis
editor-add-property = Cuir airí leis
editor-change-property-type = Athraigh an cineál maoine
editor-add-tag = Cuir clib leis
editor-add-item = Cuir mír leis
editor-linked-note = Nóta nasctha
editor-property-value = Luach
editor-delete-property = Scrios maoin
editor-property-kind-text = Téacs
editor-property-kind-number = Uimhir
editor-property-kind-checkbox = ticbhosca
editor-property-kind-date = Dáta
...
mobile-demo-open = Bain turas gan Mac
mobile-demo-exit = Fág an turas
mobile-status-demo = Turas
mobile-demo-session-title = Deisigh iomláin na n-orduithe
mobile-demo-prompt = Tá iomlán an ordaithe as ceart faoi cent amháin i gcairteacha ina bhfuil níos mó ná mír amháin. An bhfaigheann tú an fáth?
mobile-demo-thinking = Dá slánófaí gach líne sula suimítear iad, mhíneodh sin diall aon cent amháin. Táim ag féachaint ar an gcaoi a dtógtar an t-iomlán.
mobile-demo-answer = Bhí an tsuim á tuiscint mar shnámhphointe, agus mar sin slánaíodh gach líne sular cuireadh leis í. Nuair a shanntar an cineál Cents don iomlán, fanann sé in uimhríocht slánuimhreach agus imíonn an diall.
