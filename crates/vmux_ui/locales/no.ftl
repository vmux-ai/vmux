...
knowledge-search = Søk kunnskap
knowledge-no-match = Ingen samsvarende notater
knowledge-open-linked-note = Åpne koblet notat
knowledge-create-linked-note = Lag koblet notat
editor-properties = Egenskaper
editor-no-properties = Ingen eiendommer
editor-add-tags = Legg til tagger
editor-add-property = Legg til eiendom
editor-change-property-type = Endre egenskapstype
editor-add-tag = Legg til tag
editor-add-item = Legg til element
editor-linked-note = Koblet notat
editor-property-value = Verdi
editor-delete-property = Slett eiendom
editor-property-kind-text = Tekst
editor-property-kind-number = Tall
editor-property-kind-checkbox = Avmerkingsboks
editor-property-kind-date = Dato
...
mobile-demo-open = Ta en omvisning uten Mac
mobile-demo-exit = Avslutt omvisningen
mobile-status-demo = Omvisning
mobile-demo-session-title = Fiks ordresummer
mobile-demo-prompt = Ordresummen bommer med én øre i handlekurver med flere varer. Finner du feilen?
mobile-demo-thinking = Avrunding av hver linje før summering ville forklart et avvik på én øre. Sjekker hvordan summen bygges opp.
mobile-demo-answer = Summen ble utledet som float, så hver linje ble avrundet før den ble lagt til. Å typebestemme summen som Cents holder den i heltallsaritmetikk, og avviket forsvinner.
