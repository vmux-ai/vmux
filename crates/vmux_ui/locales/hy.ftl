...
knowledge-search = Որոնել գիտելիքներ
knowledge-no-match = Համապատասխան նշումներ չկան
knowledge-open-linked-note = Բացեք կապակցված նշումը
knowledge-create-linked-note = Ստեղծեք կապակցված նշում
editor-properties = Հատկություններ
editor-no-properties = Հատկություններ չկան
editor-add-tags = Ավելացնել պիտակներ
editor-add-property = Ավելացնել սեփականություն
editor-change-property-type = Փոխել սեփականության տեսակը
editor-add-tag = Ավելացնել պիտակ
editor-add-item = Ավելացնել տարր
editor-linked-note = Կապված նշում
editor-property-value = Արժեք
editor-delete-property = Ջնջել սեփականությունը
editor-property-kind-text = Տեքստ
editor-property-kind-number = Համար
editor-property-kind-checkbox = Նշավանդակ
editor-property-kind-date = Ամսաթիվ
...
mobile-pair-title = Միացեք ձեր Mac-ին
mobile-pair-subtitle = Vmux-ում բացեք Remote-ը և ընտրեք Connect device:
mobile-pair-scan = Սկանավորել QR կոդը
mobile-pair-show-link = Մուտքագրել զուգակցման հղումը ձեռքով
mobile-pair-hide-link = Թաքցնել զուգակցման հղումը
mobile-pair-link-placeholder = Տեղադրեք զուգակցման հղումը
mobile-pair-connect = Միանալ
mobile-pair-connecting = Միանում է…
mobile-pair-disconnect = Անջատվել
mobile-status-connected = Միացված է
mobile-status-reaching = Կապ է հաստատվում ձեր Mac-ի հետ…
mobile-status-disconnected = Միացված չէ

mobile-url-invalid = Զուգակցման URL-ը վավեր չէ:
mobile-url-no-address = Զուգակցման URL-ում սերվերի հասցե չկա:
mobile-url-bad-address = Զուգակցման URL-ի սերվերի հասցեն սխալ է:
mobile-url-no-token = Զուգակցման URL-ում token չկա:
mobile-url-scheme = Զուգակցման URL-ը պետք է օգտագործի HTTPS կամ HTTP:
mobile-url-paste-full = Տեղադրեք ամբողջ զուգակցման URL-ը, որը Vmux-ը ցույց է տալիս ձեր Mac-ում:

mobile-error-pairing-outdated = Այս զուգակցումը հնացած է: Կրկին սկանավորեք QR-ը ձեր Mac-ում:
mobile-error-pairing-expired = Զուգակցման ժամկետը լրացել է: Կրկին սկանավորեք QR-ը ձեր Mac-ում:
mobile-error-pairing-lost = Զուգակցման ժամկետը լրացել է: Կրկին զուգակցվեք Mac-ի հետ:
mobile-error-token-rejected = Զուգակցման token-ը մերժվեց:
mobile-error-stack-missing = Համակարգիչը բացեց զրույցը, բայց նրա շերտը չհայտնվեց:
mobile-error-not-offered = Ձեր Mac-ը դեռ չի առաջարկում սա:
mobile-error-remote-disabled = Remote-ը անջատված է ձեր Mac-ում:
mobile-error-session-gone = Այդ նիստն այլևս չկա:
mobile-error-no-desktop = Բացեք Vmux-ի պատուհանը ձեր Mac-ում:
mobile-error-refused = Ձեր Mac-ը չկարողացավ դա անել:
mobile-error-no-answer = { $address }-ից պատասխան չկա { $seconds } վայրկյան անց:

mobile-start-stacks = Շերտեր
mobile-start-no-stacks = Բաց շերտեր չկան
mobile-start-team = Թիմ
mobile-start-search-placeholder = Որոնել կամ հարցնել…
mobile-start-new-chat = Սկսել զրույց
mobile-start-starting = Սկսվում է…

mobile-chat-back = Հետ
mobile-chat-back-to-stacks = Հետ դեպի շերտեր
mobile-chat-no-messages = Դեռ հաղորդագրություններ չկան:
mobile-chat-no-session = Ակտիվ նիստ չկա
...
mobile-qr-unavailable = QR սկաները հասանելի չէ:
mobile-qr-camera-unavailable = Տեսախցիկը հասանելի չէ: Փոխարենը մուտքագրեք զուգակցման հղումը:
mobile-qr-camera-failed = Չհաջողվեց բացել տեսախցիկը՝ { $error }
mobile-qr-camera-input-unavailable = Տեսախցիկի մուտքը հասանելի չէ:
mobile-qr-unsupported-device = QR սկանավորումը հասանելի չէ այս սարքում:
mobile-qr-unsupported-platform = QR սկանավորումը դեռ հասանելի չէ այս հարթակում: Փոխարենը մուտքագրեք զուգակցման հղումը:
mobile-error-unexpected-answer = Ձեր Mac-ը անսպասելի պատասխան տվեց:
mobile-error-connection-dropped = Ձեր Mac-ի հետ կապը խզվեց:
...
mobile-demo-open = Շրջայց առանց Mac-ի
mobile-demo-exit = Դուրս գալ շրջայցից
mobile-status-demo = Շրջայց
mobile-demo-session-title = Ուղղել պատվերի գումարները
mobile-demo-prompt = Մի քանի ապրանք պարունակող զամբյուղներում պատվերի գումարը շեղվում է մեկ ցենտով: Կարո՞ղ ես գտնել պատճառը:
mobile-demo-thinking = Յուրաքանչյուր տողը գումարելուց առաջ կլորացնելը կբացատրեր մեկ ցենտի շեղումը: Նայում եմ՝ ինչպես է կազմվում գումարը:
mobile-demo-answer = Գումարը եզրակացվում էր որպես լողացող կետով թիվ, ուստի յուրաքանչյուր տող կլորացվում էր նախքան ավելացվելը: Գումարին Cents տիպը տալն այն պահում է ամբողջաթիվ թվաբանության մեջ, և շեղումը վերանում է:
