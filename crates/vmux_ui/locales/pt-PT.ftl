...
vault-title = Vault
vault-encrypted = Cifrado de ponta a ponta
...
vault-connect-github = Ligue o GitHub
vault-connected-as = Ligado como { $name }
vault-use-repository = Uso
vault-repository-name = Nome do repositório
vault-cloud-folder = Pasta nuvem
vault-cloud-folder-description = Utilize uma pasta do Google Drive, iCloud Drive, Dropbox ou OneDrive.
...
vault-public-warning = O histórico do repositório e os dados cifrados ficarão públicos.
...
editor-delete-property = Apagar propriedade
...
mobile-pair-title = Ligue-se ao seu Mac
mobile-pair-subtitle = No Vmux, abra Remote e escolha Connect device.
mobile-pair-scan = Ler código QR
mobile-pair-show-link = Introduzir manualmente a ligação de emparelhamento
mobile-pair-hide-link = Ocultar ligação de emparelhamento
mobile-pair-link-placeholder = Cole a ligação de emparelhamento
mobile-pair-connect = Ligar
mobile-pair-connecting = A ligar…
mobile-pair-disconnect = Desligar
mobile-status-connected = Ligado
mobile-status-reaching = A contactar o seu Mac…
mobile-status-disconnected = Não ligado

mobile-url-invalid = O URL de emparelhamento é inválido.
mobile-url-no-address = O URL de emparelhamento não tem endereço de servidor.
mobile-url-bad-address = O URL de emparelhamento tem um endereço de servidor inválido.
mobile-url-no-token = O URL de emparelhamento não tem token.
mobile-url-scheme = O URL de emparelhamento tem de usar HTTPS ou HTTP.
mobile-url-paste-full = Cole o URL de emparelhamento completo apresentado pelo Vmux no seu Mac.

mobile-error-pairing-outdated = Este emparelhamento está desatualizado. Leia novamente o QR no seu Mac.
mobile-error-pairing-expired = O emparelhamento expirou. Leia novamente o QR no seu Mac.
mobile-error-pairing-lost = O emparelhamento expirou. Emparelhe novamente com o Mac.
mobile-error-token-rejected = O token de emparelhamento foi recusado.
mobile-error-stack-missing = O computador abriu a conversa, mas a respetiva pilha não apareceu.
mobile-error-not-offered = O seu Mac ainda não disponibiliza isto.
mobile-error-remote-disabled = O Remote está desativado no seu Mac.
mobile-error-session-gone = Essa sessão já não existe.
...
mobile-start-team = Equipa
mobile-start-search-placeholder = Pesquisar ou perguntar…
mobile-start-new-chat = Iniciar conversa
mobile-start-starting = A iniciar…

mobile-chat-back = Recuar
mobile-chat-back-to-stacks = Voltar às pilhas
mobile-chat-no-messages = Ainda não há mensagens.
...
mobile-qr-title = Leia o código QR apresentado pelo Vmux
mobile-qr-cancel = Cancelar
mobile-qr-unavailable = O leitor de QR não está disponível.
mobile-qr-camera-unavailable = Câmara indisponível. Introduza antes a ligação de emparelhamento.
mobile-qr-camera-failed = Não foi possível abrir a câmara: { $error }
mobile-qr-camera-input-unavailable = A entrada da câmara não está disponível.
mobile-qr-unsupported-device = A leitura de QR não está disponível neste dispositivo.
mobile-qr-unsupported-platform = A leitura de QR ainda não está disponível nesta plataforma. Introduza antes a ligação de emparelhamento.
mobile-error-unexpected-answer = O seu Mac respondeu de forma inesperada.
mobile-error-connection-dropped = A ligação ao seu Mac caiu.
...
mobile-demo-open = Faça uma visita guiada sem Mac
mobile-demo-exit = Sair da visita guiada
mobile-status-demo = Visita
mobile-demo-session-title = Corrigir totais das encomendas
mobile-demo-prompt = O total da encomenda está errado por um cêntimo em carrinhos com vários artigos. Consegue descobrir porquê?
mobile-demo-thinking = Arredondar cada linha antes da soma explicaria um desvio de um cêntimo. A verificar como o total é calculado.
mobile-demo-answer = A soma estava a ser inferida como float, pelo que cada linha era arredondada antes de ser adicionada. Tipificar o total como Cents mantém-no em aritmética de inteiros e o desvio desaparece.
