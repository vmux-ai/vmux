...
knowledge-search = Hae tietämystä
knowledge-no-match = Ei vastaavia muistiinpanoja
knowledge-open-linked-note = Avaa linkitetty muistiinpano
knowledge-create-linked-note = Luo linkitetty muistiinpano
editor-properties = Ominaisuudet
editor-no-properties = Ei ominaisuuksia
editor-add-tags = Lisää tunnisteita
editor-add-property = Lisää omaisuutta
editor-change-property-type = Muuta omaisuuden tyyppiä
editor-add-tag = Lisää tunniste
editor-add-item = Lisää kohde
editor-linked-note = Linkitetty muistiinpano
editor-property-value = Arvo
editor-delete-property = Poista omaisuus
editor-property-kind-text = Teksti
editor-property-kind-number = Määrä
editor-property-kind-checkbox = Valintaruutu
editor-property-kind-date = Päivämäärä
...
mobile-pair-title = Yhdistä Maciin
mobile-pair-subtitle = Avaa Vmuxissa Remote ja valitse Connect device.
mobile-pair-scan = Skannaa QR-koodi
mobile-pair-show-link = Syötä pariliitoslinkki käsin
mobile-pair-hide-link = Piilota pariliitoslinkki
mobile-pair-link-placeholder = Liitä pariliitoslinkki
mobile-pair-connect = Yhdistä
mobile-pair-connecting = Yhdistetään…
mobile-pair-disconnect = Katkaise yhteys
mobile-status-connected = Yhdistetty
mobile-status-reaching = Tavoitellaan Maciasi…
mobile-status-disconnected = Ei yhteyttä

mobile-url-invalid = Pariliitos-URL on virheellinen.
mobile-url-no-address = Pariliitos-URL-osoitteesta puuttuu palvelimen osoite.
mobile-url-bad-address = Pariliitos-URL-osoitteessa on virheellinen palvelinosoite.
mobile-url-no-token = Pariliitos-URL-osoitteesta puuttuu token.
mobile-url-scheme = Pariliitos-URL-osoitteen on käytettävä HTTPS- tai HTTP-protokollaa.
mobile-url-paste-full = Liitä koko pariliitos-URL, jonka Vmux näyttää Macissasi.

mobile-error-pairing-outdated = Tämä pariliitos on vanhentunut. Skannaa Macisi QR-koodi uudelleen.
mobile-error-pairing-expired = Pariliitos vanheni. Skannaa Macisi QR-koodi uudelleen.
mobile-error-pairing-lost = Pariliitos vanheni. Muodosta pariliitos Macin kanssa uudelleen.
mobile-error-token-rejected = Pariliitostoken hylättiin.
mobile-error-stack-missing = Työpöytä avasi keskustelun, mutta sen pinoa ei ilmestynyt.
mobile-error-not-offered = Macisi ei tarjoa tätä vielä.
mobile-error-remote-disabled = Remote on pois päältä Macissasi.
mobile-error-session-gone = Kyseistä istuntoa ei enää ole.
mobile-error-no-desktop = Avaa Vmux-ikkuna Macissasi.
mobile-error-refused = Macisi ei pystynyt siihen.
mobile-error-no-answer = Ei vastausta osoitteesta { $address } { $seconds } sekunnin jälkeen.

mobile-start-stacks = Pinot
mobile-start-no-stacks = Ei avoimia pinoja
mobile-start-team = Tiimi
mobile-start-search-placeholder = Hae tai kysy…
mobile-start-new-chat = Aloita keskustelu
mobile-start-starting = Aloitetaan…

mobile-chat-back = Takaisin
mobile-chat-back-to-stacks = Takaisin pinoihin
mobile-chat-no-messages = Ei vielä viestejä.
mobile-chat-no-session = Ei aktiivista istuntoa
...
mobile-qr-unavailable = QR-skanneri ei ole käytettävissä.
mobile-qr-camera-unavailable = Kamera ei ole käytettävissä. Syötä sen sijaan pariliitoslinkki.
mobile-qr-camera-failed = Kameraa ei voitu avata: { $error }
mobile-qr-camera-input-unavailable = Kameran syöte ei ole käytettävissä.
mobile-qr-unsupported-device = QR-skannaus ei ole käytettävissä tällä laitteella.
mobile-qr-unsupported-platform = QR-skannaus ei ole vielä käytettävissä tällä alustalla. Syötä sen sijaan pariliitoslinkki.
mobile-error-unexpected-answer = Macisi vastasi odottamattomasti.
mobile-error-connection-dropped = Yhteys Maciisi katkesi.
...
mobile-demo-open = Tutustu ilman Macia
mobile-demo-exit = Poistu kierrokselta
mobile-status-demo = Kierros
mobile-demo-session-title = Korjaa tilausten loppusummat
mobile-demo-prompt = Tilauksen loppusumma heittää sentin verran, kun ostoskorissa on useita tuotteita. Löydätkö syyn?
mobile-demo-thinking = Jos jokainen rivi pyöristetään ennen yhteenlaskua, se selittäisi yhden sentin heiton. Katson, miten loppusumma muodostetaan.
mobile-demo-answer = Summa tyypittyi liukuluvuksi, joten jokainen rivi pyöristyi ennen lisäämistä. Kun loppusumman tyypiksi asetetaan Cents, laskenta pysyy kokonaisluvuissa ja heitto katoaa.
