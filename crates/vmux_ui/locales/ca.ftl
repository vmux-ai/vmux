...
knowledge-search = Cerca Coneixement
knowledge-no-match = No hi ha notes coincidents
knowledge-open-linked-note = Obriu la nota enllaçada
knowledge-create-linked-note = Crea una nota enllaçada
editor-properties = Propietats
editor-no-properties = Sense propietats
editor-add-tags = Afegeix etiquetes
editor-add-property = Afegeix propietat
editor-change-property-type = Canvia el tipus de propietat
editor-add-tag = Afegeix una etiqueta
editor-add-item = Afegeix un element
editor-linked-note = Nota enllaçada
editor-property-value = Valor
editor-delete-property = Suprimeix la propietat
editor-property-kind-text = Text
editor-property-kind-number = Número
editor-property-kind-checkbox = casella de selecció
...
mobile-pair-title = Connecta amb el teu Mac
mobile-pair-subtitle = A Vmux, obre Remote i tria Connecta un dispositiu.
mobile-pair-scan = Escaneja el codi QR
mobile-pair-show-link = Introdueix l’enllaç manualment
mobile-pair-hide-link = Amaga l’enllaç d’aparellament
mobile-pair-link-placeholder = Enganxa l’enllaç d’aparellament
mobile-pair-connect = Connecta
mobile-pair-connecting = S’està connectant…
mobile-pair-disconnect = Desconnecta
mobile-status-connected = Connectat
mobile-status-reaching = Contactant amb el teu Mac…
mobile-status-disconnected = No connectat

mobile-url-invalid = L’URL d’aparellament no és vàlid.
mobile-url-no-address = L’URL d’aparellament no té adreça de servidor.
mobile-url-bad-address = L’URL d’aparellament té una adreça de servidor no vàlida.
mobile-url-no-token = L’URL d’aparellament no té cap testimoni.
mobile-url-scheme = L’URL d’aparellament ha d’utilitzar HTTPS o HTTP.
mobile-url-paste-full = Enganxa l’URL d’aparellament complet que Vmux mostra al teu Mac.

mobile-error-pairing-outdated = Aquest aparellament ha quedat obsolet. Torna a escanejar el QR del teu Mac.
mobile-error-pairing-expired = L’aparellament ha caducat. Torna a escanejar el QR del teu Mac.
mobile-error-pairing-lost = L’aparellament ha caducat. Torna a aparellar amb el Mac.
mobile-error-token-rejected = S’ha rebutjat el testimoni d’aparellament.
mobile-error-stack-missing = L’escriptori ha obert el xat, però la seva pila no ha aparegut.
mobile-error-not-offered = El teu Mac encara no ho ofereix.
mobile-error-remote-disabled = Remote està desactivat al teu Mac.
mobile-error-session-gone = Aquesta sessió ja no hi és.
mobile-error-no-desktop = Obre la finestra de Vmux al teu Mac.
mobile-error-refused = El teu Mac no ho ha pogut fer.
mobile-error-no-answer = Sense resposta de { $address } després de { $seconds } s.

mobile-start-stacks = Piles
mobile-start-no-stacks = Cap pila oberta
mobile-start-team = Equip
mobile-start-search-placeholder = Cerca o pregunta…
mobile-start-new-chat = Inicia un xat
mobile-start-starting = S’està iniciant…

mobile-chat-back = Enrere
mobile-chat-back-to-stacks = Torna a les piles
mobile-chat-no-messages = Encara no hi ha missatges.
mobile-chat-no-session = Cap sessió activa
mobile-chat-placeholder = Missatge a l’agent…
mobile-chat-send = Envia
mobile-chat-stop = Atura

mobile-qr-title = Escaneja el codi QR que mostra Vmux
mobile-qr-cancel = Cancel·la
mobile-qr-unavailable = L’escàner QR no està disponible.
mobile-qr-camera-unavailable = Càmera no disponible. Introdueix l’enllaç d’aparellament.
mobile-qr-camera-failed = No s’ha pogut obrir la càmera: { $error }
mobile-qr-camera-input-unavailable = L’entrada de la càmera no està disponible.
mobile-qr-unsupported-device = L’escaneig de QR no està disponible en aquest dispositiu.
mobile-qr-unsupported-platform = L’escaneig de QR encara no està disponible en aquesta plataforma. Introdueix l’enllaç d’aparellament.
mobile-error-unexpected-answer = El teu Mac ha respost de manera inesperada.
mobile-error-connection-dropped = S’ha perdut la connexió amb el teu Mac.
...
mobile-demo-open = Fes una visita guiada sense Mac
mobile-demo-exit = Surt de la visita
mobile-status-demo = Visita
mobile-demo-session-title = Corregir els totals de comanda
mobile-demo-prompt = El total de la comanda es desvia un cèntim en cistelles amb diversos articles. Pots trobar per què?
mobile-demo-thinking = Arrodonir cada línia abans de sumar-les explicaria una desviació d’un cèntim. Estic mirant com es calcula el total.
mobile-demo-answer = La suma s’inferia com a coma flotant, així que cada línia s’arrodonia abans de sumar-se. Si es tipa el total com a Cents, el càlcul es manté en aritmètica entera i la desviació desapareix.
