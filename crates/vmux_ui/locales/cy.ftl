...
knowledge-search = Chwilio Gwybodaeth
knowledge-no-match = Dim nodiadau cyfatebol
knowledge-open-linked-note = Agor nodyn cysylltiedig
knowledge-create-linked-note = Creu nodyn cysylltiedig
editor-properties = Priodweddau
editor-no-properties = Dim eiddo
editor-add-tags = Ychwanegu tagiau
editor-add-property = Ychwanegu eiddo
editor-change-property-type = Newid y math o eiddo
editor-add-tag = Ychwanegu tag
editor-add-item = Ychwanegu eitem
editor-linked-note = Nodyn cysylltiedig
editor-property-value = Gwerth
editor-delete-property = Dileu eiddo
editor-property-kind-text = Testun
editor-property-kind-number = Rhif
editor-property-kind-checkbox = Blwch ticio
editor-property-kind-date = Dyddiad
...
mobile-demo-open = Cymerwch daith heb Mac
mobile-demo-exit = Gadael y daith
mobile-status-demo = Taith
mobile-demo-session-title = Trwsio cyfansymiau archebion
mobile-demo-prompt = Mae cyfanswm yr archeb un geiniog allan ohoni ar fasgedi ag amryw eitem. Fedri di ddod o hyd i’r rheswm?
mobile-demo-thinking = Byddai talgrynnu pob llinell cyn eu hadio yn esbonio gwyriad o un geiniog. Rwy’n edrych ar sut mae’r cyfanswm yn cael ei adeiladu.
mobile-demo-answer = Roedd y swm yn cael ei gasglu fel rhif pwynt arnawf, felly roedd pob llinell yn cael ei thalgrynnu cyn ei hadio. Mae rhoi’r math Cents i’r cyfanswm yn ei gadw mewn rhifyddeg cyfanrif ac mae’r gwyriad yn diflannu.
