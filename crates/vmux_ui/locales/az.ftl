...
knowledge-search = Bilik axtarın
knowledge-no-match = Uyğun qeyd yoxdur
knowledge-open-linked-note = Əlaqəli qeydi açın
knowledge-create-linked-note = Əlaqəli qeyd yaradın
editor-properties = Xüsusiyyətlər
editor-no-properties = Mülkiyyət yoxdur
editor-add-tags = Teqlər əlavə edin
editor-add-property = Mülk əlavə edin
editor-change-property-type = Əmlak növünü dəyişdirin
editor-add-tag = Etiket əlavə edin
editor-add-item = Element əlavə edin
editor-linked-note = Əlaqəli qeyd
editor-property-value = Dəyər
editor-delete-property = Mülkiyyəti silin
editor-property-kind-text = Mətn
editor-property-kind-number = Nömrə
editor-property-kind-checkbox = Yoxlama qutusu
editor-property-kind-date = Tarix
...
mobile-demo-open = Mac olmadan tura çıxın
mobile-demo-exit = Turdan çıx
mobile-status-demo = Tur
mobile-demo-session-title = Sifariş cəmlərini düzəlt
mobile-demo-prompt = Çoxməhsullu səbətlərdə sifarişin cəmi bir sent fərqli çıxır. Səbəbini tapa bilərsən?
mobile-demo-thinking = Hər sətrin toplanmadan əvvəl yuvarlaqlaşdırılması bir sentlik fərqi izah edərdi. Cəmin necə hesablandığına baxıram.
mobile-demo-answer = Cəm sürüşən nöqtəli ədəd kimi çıxarılırdı, ona görə hər sətir əlavə olunmadan əvvəl yuvarlaqlaşdırılırdı. Cəmə Cents tipi vermək onu tam ədəd hesablamasında saxlayır və fərq aradan qalxır.
