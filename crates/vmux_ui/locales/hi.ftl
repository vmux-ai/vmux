...
vault-title = Vault
vault-encrypted = एंड-टू-एंड एन्क्रिप्टेड
vault-passkey = सर्व-कुंजी
vault-passkey-description = इस वॉल्ट को अन्य डिवाइस पर बिना पासवर्ड के अनलॉक करें।
vault-passkey-add = पासकी जोड़ें
vault-passkey-unlock = अनलॉक
vault-passkey-provider-unsupported = यह पासकी प्रदाता अभी तक एन्क्रिप्टेड वॉल्ट अनलॉक का समर्थन नहीं करता है।
vault-recovery-key = पुनर्प्राप्ति कुंजी
vault-recovery-key-description = इस वॉल्ट को नए डिवाइस पर पुनर्प्राप्त करने के लिए बिटवर्डन या किसी अन्य पासवर्ड मैनेजर में एक कुंजी सहेजें।
vault-recovery-key-create = कुंजी बनाएं
vault-recovery-key-create-failed = पुनर्प्राप्ति कुंजी नहीं बनाई जा सकी.
vault-recovery-key-save = इस कुंजी को अभी सहेजें। Vmux इसे दोबारा नहीं दिखा सकता।
vault-recovery-key-saved = मैंने इसे सहेजा है
vault-recovery-key-placeholder = पेस्ट रिकवरी कुंजी
vault-recovery-key-unlock = अनलॉक
vault-recovery-key-invalid = यह पुनर्प्राप्ति कुंजी वॉल्ट को अनलॉक नहीं कर सकती.
vault-recovery-key-ready = पुनर्प्राप्ति कुंजी कॉन्फ़िगर की गई
vault-recovery-key-upload-pending = कुंजी स्थानीय रूप से सहेजी गई है, लेकिन अपलोड विफल रहा। इसे सुरक्षित रखें और पुनः प्रयास करने के लिए सिंक दबाएँ।
vault-auto-sync = स्वचालित बैकअप
vault-backup-failed = स्वचालित बैकअप विफल रहा. पुनः प्रयास करने के लिए सिंक दबाएँ।
vault-backup-failed-short = बैकअप विफल रहा
vault-recovery-key-copy-hint = कॉपी करने के लिए क्लिक करें
vault-recovery-key-copied = कॉपी किया गया
vault-recovery-key-verify = इसे अपने पासवर्ड मैनेजर में सेव करें, फिर सत्यापित करने के लिए इसे नीचे पेस्ट करें।
vault-recovery-key-verify-placeholder = सहेजी गई पुनर्प्राप्ति कुंजी चिपकाएँ
vault-recovery-key-mismatch = पुनर्प्राप्ति कुंजी मेल नहीं खाती.
...
vault-github = GitHub
vault-github-description = एक निजी भंडार बनाएं या मौजूदा वॉल्ट चुनें।
vault-connect-github = GitHub कनेक्ट करें
vault-connected-as = { $name } के रूप में जुड़ा हुआ
vault-use-repository = उपयोग
vault-repository-name = भंडार का नाम
vault-cloud-folder = क्लाउड फ़ोल्डर
vault-cloud-folder-description = गूगल ड्राइव, आईक्लाउड ड्राइव, ड्रॉपबॉक्स या वनड्राइव से एक फ़ोल्डर का उपयोग करें।
vault-choose-folder = फोल्डर को चुनो
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = फ़ोल्डर · { common-done }
vault-private = निजी भंडार
vault-public-warning = रिपॉजिटरी का इतिहास और एन्क्रिप्टेड डेटा सार्वजनिक होंगे।
...
knowledge-search = ज्ञान खोजें
knowledge-no-match = कोई मेल खाता नोट नहीं
knowledge-open-linked-note = लिंक किया गया नोट खोलें
knowledge-create-linked-note = लिंक किया गया नोट बनाएं
editor-properties = गुण
editor-no-properties = कोई गुण नहीं
editor-add-tags = टैगों को जोड़ें
editor-add-property = संपत्ति जोड़ें
editor-change-property-type = संपत्ति का प्रकार बदलें
editor-add-tag = टैग जोड़ें
editor-add-item = मद जोड़ें
editor-linked-note = लिंक किया गया नोट
editor-property-value = कीमत
editor-delete-property = संपत्ति हटाएं
editor-property-kind-text = मूलपाठ
editor-property-kind-number = संख्या
editor-property-kind-checkbox = चेक बॉक्स
...
mobile-pair-title = अपने Mac से कनेक्ट करें
mobile-pair-subtitle = Vmux में Remote खोलें और Connect device चुनें।
mobile-pair-scan = QR कोड स्कैन करें
mobile-pair-show-link = पेयरिंग लिंक मैन्युअल रूप से डालें
mobile-pair-hide-link = पेयरिंग लिंक छिपाएँ
mobile-pair-link-placeholder = पेयरिंग लिंक पेस्ट करें
mobile-pair-connect = कनेक्ट करें
mobile-pair-connecting = कनेक्ट हो रहा है…
mobile-pair-disconnect = डिस्कनेक्ट करें
mobile-status-connected = कनेक्टेड
mobile-status-reaching = आपके Mac तक पहुँचा जा रहा है…
mobile-status-disconnected = जुड़े नहीं हैं

mobile-url-invalid = पेयरिंग URL अमान्य है।
mobile-url-no-address = पेयरिंग URL में सर्वर पता नहीं है।
mobile-url-bad-address = पेयरिंग URL में सर्वर पता अमान्य है।
mobile-url-no-token = पेयरिंग URL में टोकन नहीं है।
mobile-url-scheme = पेयरिंग URL में HTTPS या HTTP होना चाहिए।
mobile-url-paste-full = आपके Mac पर Vmux जो पूरा पेयरिंग URL दिखाता है, उसे पेस्ट करें।

mobile-error-pairing-outdated = यह पेयरिंग पुरानी हो चुकी है। अपने Mac पर दिख रहा QR दोबारा स्कैन करें।
mobile-error-pairing-expired = पेयरिंग समाप्त हो गई। अपने Mac पर दिख रहा QR दोबारा स्कैन करें।
mobile-error-pairing-lost = पेयरिंग समाप्त हो गई। Mac के साथ दोबारा पेयर करें।
mobile-error-token-rejected = पेयरिंग टोकन अस्वीकार कर दिया गया।
mobile-error-stack-missing = डेस्कटॉप ने चैट खोल दी, पर उसका स्टैक नहीं दिखा।
mobile-error-not-offered = आपका Mac अभी यह सुविधा नहीं देता।
mobile-error-remote-disabled = आपके Mac पर Remote बंद है।
mobile-error-session-gone = वह सत्र अब मौजूद नहीं है।
mobile-error-no-desktop = अपने Mac पर Vmux विंडो खोलें।
mobile-error-refused = आपका Mac यह नहीं कर सका।
mobile-error-no-answer = { $seconds } सेकंड बाद भी { $address } से कोई जवाब नहीं।

mobile-start-stacks = स्टैक
mobile-start-no-stacks = कोई खुला स्टैक नहीं
mobile-start-team = टीम
mobile-start-search-placeholder = खोजें या पूछें…
mobile-start-new-chat = चैट शुरू करें
mobile-start-starting = शुरू हो रहा है…

mobile-chat-back = पीछे
mobile-chat-back-to-stacks = स्टैक पर वापस
mobile-chat-no-messages = अभी कोई संदेश नहीं।
mobile-chat-no-session = कोई सक्रिय सत्र नहीं
mobile-chat-placeholder = एजेंट को संदेश…
mobile-chat-send = भेजें
mobile-chat-stop = रोकें

mobile-qr-title = Vmux पर दिख रहा QR कोड स्कैन करें
mobile-qr-cancel = रद्द करें
mobile-qr-unavailable = QR स्कैनर उपलब्ध नहीं है।
mobile-qr-camera-unavailable = कैमरा उपलब्ध नहीं है। इसके बजाय पेयरिंग लिंक डालें।
mobile-qr-camera-failed = कैमरा नहीं खुल सका: { $error }
mobile-qr-camera-input-unavailable = कैमरा इनपुट उपलब्ध नहीं है।
mobile-qr-unsupported-device = इस डिवाइस पर QR स्कैनिंग उपलब्ध नहीं है।
mobile-qr-unsupported-platform = इस प्लेटफ़ॉर्म पर QR स्कैनिंग अभी उपलब्ध नहीं है। इसके बजाय पेयरिंग लिंक डालें।
mobile-error-unexpected-answer = आपके Mac से अप्रत्याशित जवाब मिला।
mobile-error-connection-dropped = आपके Mac से कनेक्शन टूट गया।
...
mobile-demo-open = Mac के बिना टूर लें
mobile-demo-exit = टूर से बाहर निकलें
mobile-status-demo = टूर
mobile-demo-session-title = ऑर्डर के कुल योग ठीक करना
mobile-demo-prompt = कई वस्तुओं वाली कार्ट में ऑर्डर का कुल योग एक सेंट गलत आता है। क्या तुम कारण ढूंढ सकते हो?
mobile-demo-thinking = जोड़ने से पहले हर पंक्ति को राउंड करना एक सेंट के अंतर को समझा सकता है। देख रहा हूँ कि कुल योग कैसे बनता है।
mobile-demo-answer = योग फ्लोट के रूप में अनुमानित हो रहा था, इसलिए हर पंक्ति जुड़ने से पहले ही राउंड हो जाती थी। कुल को Cents टाइप देने पर गणना पूर्णांक में रहती है और अंतर मिट जाता है।
