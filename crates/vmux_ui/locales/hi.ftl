...
mobile-chat-allow = अनुमति दें
mobile-chat-deny = अस्वीकार करें
mobile-chat-allow-prompt = { $name } को अनुमति दें?
mobile-chat-enter-to-send = भेजने के लिए Enter
mobile-chat-default-effort = डिफ़ॉल्ट प्रयास
