...
schema-update-channel = Releasekanaal
schema-update-channel-detail = Stabiel ontvangt gepubliceerde releases. Preview ontvangt nachtelijke builds.
schema-update-channel-stable = Stabiel
...
command-rotate-forward = Indeling > Deelvenster > Draai deelvensters vooruit
command-rotate-backward = Indeling > Deelvenster > Draai deelvensters achteruit
command-mirror-panes = Indeling > Deelvenster > Spiegel deelvensters
command-mirror-panes-horizontal = Indeling > Deelvenster > Spiegel deelvensters horizontaal
command-mirror-panes-vertical = Indeling > Deelvenster > Spiegel deelvensters verticaal
...
git-staged-changes = Gestagede wijzigingen
git-unstaged-changes = Niet-gestagede wijzigingen
git-repository-clean = Werkmap is schoon
git-select-file = Selecteer een bestand om de diff te bekijken
git-stage = Stagen
git-discard = Verwerpen
git-recent-commits = Recente commits
git-no-commits = Nog geen commits
git-local-branches = Lokale vertakkingen
git-local = Lokaal
git-remote = Extern
git-tags = Tags
git-no-branches = Geen lokale vertakkingen
...
git-stage-all = Alles stagen
git-switch-workspace = Werkruimte wisselen
git-edit-config = Configuratiebestand bewerken
git-switch-recent-repository = Naar een recente repository wisselen
git-keybindings = Sneltoetsen
git-checkout = Uitchecken
git-new-branch = Nieuwe branch
git-delete-branch = Branch verwijderen
git-stashes = Stashes
git-no-stashes = Geen stashes
git-stash = Wijzigingen stashen
git-stash-pop = Stash toepassen en verwijderen
git-stash-drop = Stash verwijderen
git-amend = Commit aanpassen
git-rebase = Rebase
git-merge = Samenvoegen
git-fast-forward = Fast-forward
git-revert-commit = Commit terugdraaien
git-cherry-pick = Cherry-pick
git-checkout-commit = Commit uitchecken
git-shortcut-panels = Panelen
git-shortcut-navigate = Navigeren
git-shortcut-help = Sneltoetsen
git-shortcut-title = Git-sneltoetsen
git-shortcut-description = Beschikbare sneltoetsen voor deze Git-pagina.
git-shortcut-universal = Algemeen
git-shortcut-next-panel = Volgend paneel
git-shortcut-previous = Vorig item
git-shortcut-next = Volgend item
