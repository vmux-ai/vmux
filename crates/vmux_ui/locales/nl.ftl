...
vault-passkey = Wachtwoord
vault-passkey-description = Ontgrendel deze kluis op andere apparaten zonder wachtwoord.
vault-passkey-add = Wachtwoord toevoegen
vault-passkey-unlock = Ontgrendelen
vault-passkey-provider-unsupported = Deze toegangssleutelprovider ondersteunt nog geen gecodeerde ontgrendeling van de kluis.
...
mobile-demo-open = Neem een rondleiding zonder Mac
mobile-demo-exit = Rondleiding verlaten
mobile-status-demo = Rondleiding
mobile-demo-session-title = Ordertotalen corrigeren
mobile-demo-prompt = Het ordertotaal wijkt één cent af bij winkelwagens met meerdere artikelen. Kun jij het vinden?
mobile-demo-thinking = Elke regel afronden vóór het optellen zou een afwijking van één cent verklaren. Ik kijk hoe het totaal wordt opgebouwd.
mobile-demo-answer = De som werd afgeleid als float, dus elke regel werd afgerond voordat hij werd opgeteld. Door het totaal als Cents te typeren blijft het in gehele getallen en verdwijnt de afwijking.
