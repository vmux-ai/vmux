...
knowledge-search = Fufuzani Chidziwitso
knowledge-no-match = Palibe zolemba zofanana
knowledge-open-linked-note = Tsegulani cholembera cholumikizidwa
knowledge-create-linked-note = Pangani zolemba zolumikizidwa
editor-properties = Katundu
editor-no-properties = Palibe katundu
editor-add-tags = Onjezani ma tag
editor-add-property = Onjezani katundu
editor-change-property-type = Sinthani mtundu wa katundu
editor-add-tag = Onjezani tag
editor-add-item = Onjezani chinthu
editor-linked-note = Zolemba zogwirizana
editor-property-value = Mtengo
editor-delete-property = Chotsani katundu
editor-property-kind-text = Mawu
editor-property-kind-number = Nambala
editor-property-kind-checkbox = Chongani bokosi
editor-property-kind-date = Tsiku
...
mobile-demo-open = Yendetsani ulendo popanda Mac
mobile-demo-exit = Tulukani mu ulendo
mobile-status-demo = Ulendo
mobile-demo-session-title = Konzani chiwerengero cha oda
mobile-demo-prompt = Chiwerengero cha oda chikuphonya ndi sente imodzi pa ngolo zokhala ndi zinthu zambiri. Mungapeze chifukwa chake?
mobile-demo-thinking = Kuzungulira mzere uliwonse musanawonjezere kungafotokoze kusiyana kwa sente imodzi. Ndikuyang’ana momwe chiwerengero chimapangidwira.
mobile-demo-answer = Chiwerengero chinkatengedwa ngati float, choncho mzere uliwonse unkazungulidwa usanawonjezedwe. Kupereka mtundu wa Cents pa chiwerengero kumachisunga mu masamu a manambala athunthu ndipo kusiyana kumatha.
