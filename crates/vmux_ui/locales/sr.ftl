...
knowledge-search = Сеарцх Кновледге
knowledge-no-match = Нема одговарајућих белешки
knowledge-open-linked-note = Отворите повезану белешку
knowledge-create-linked-note = Направите повезану белешку
editor-properties = Својства
editor-no-properties = Нема својстава
editor-add-tags = Додајте ознаке
editor-add-property = Додајте својство
editor-change-property-type = Промените тип имовине
editor-add-tag = Додај ознаку
editor-add-item = Додај ставку
editor-linked-note = Повезана белешка
editor-property-value = Валуе
editor-delete-property = Избриши својство
editor-property-kind-text = Текст
editor-property-kind-number = Број
editor-property-kind-checkbox = Поље за потврду
...
mobile-pair-title = Повежите се са Mac-ом
mobile-pair-subtitle = У Vmux-у отворите Remote и изаберите Connect device.
mobile-pair-scan = Скенирај QR код
mobile-pair-show-link = Ручно унеси везу за упаривање
mobile-pair-hide-link = Сакриј везу за упаривање
mobile-pair-link-placeholder = Налепите везу за упаривање
mobile-pair-connect = Повежи
mobile-pair-connecting = Повезивање…
mobile-pair-disconnect = Прекини везу
mobile-status-connected = Повезано
mobile-status-reaching = Успостављање везе са Mac-ом…
mobile-status-disconnected = Није повезано

mobile-url-invalid = URL за упаривање није исправан.
mobile-url-no-address = URL за упаривање нема адресу сервера.
mobile-url-bad-address = URL за упаривање има неисправну адресу сервера.
mobile-url-no-token = URL за упаривање нема токен.
mobile-url-scheme = URL за упаривање мора да користи HTTPS или HTTP.
mobile-url-paste-full = Налепите цео URL за упаривање који Vmux приказује на вашем Mac-у.

mobile-error-pairing-outdated = Ово упаривање је застарело. Поново скенирајте QR на Mac-у.
mobile-error-pairing-expired = Упаривање је истекло. Поново скенирајте QR на Mac-у.
mobile-error-pairing-lost = Упаривање је истекло. Поново се упарите са Mac-ом.
mobile-error-token-rejected = Токен за упаривање је одбијен.
mobile-error-stack-missing = Рачунар је отворио ћаскање, али се његов стек није појавио.
mobile-error-not-offered = Ваш Mac ово још не нуди.
mobile-error-remote-disabled = Remote је искључен на вашем Mac-у.
mobile-error-session-gone = Те сесије више нема.
mobile-error-no-desktop = Отворите Vmux прозор на свом Mac-у.
mobile-error-refused = Ваш Mac то није могао да уради.
mobile-error-no-answer = Нема одговора са { $address } после { $seconds } секунди.

mobile-start-stacks = Стекови
mobile-start-no-stacks = Нема отворених стекова
mobile-start-team = Тим
mobile-start-search-placeholder = Претражите или питајте…
mobile-start-new-chat = Покрени ћаскање
mobile-start-starting = Покретање…

mobile-chat-back = Назад
mobile-chat-back-to-stacks = Назад на стекове
mobile-chat-no-messages = Још нема порука.
mobile-chat-no-session = Нема активне сесије
mobile-chat-placeholder = Порука агенту…
mobile-chat-send = Пошаљи
mobile-chat-stop = Заустави

mobile-qr-title = Скенирајте QR код који Vmux приказује
mobile-qr-cancel = Откажи
mobile-qr-unavailable = QR скенер није доступан.
mobile-qr-camera-unavailable = Камера није доступна. Унесите везу за упаривање.
mobile-qr-camera-failed = Није могуће отворити камеру: { $error }
mobile-qr-camera-input-unavailable = Улаз камере није доступан.
mobile-qr-unsupported-device = Скенирање QR кода није доступно на овом уређају.
mobile-qr-unsupported-platform = Скенирање QR кода још није доступно на овој платформи. Унесите везу за упаривање.
mobile-error-unexpected-answer = Ваш Mac је неочекивано одговорио.
mobile-error-connection-dropped = Веза са Mac-ом је прекинута.
...
mobile-demo-open = Погледај обилазак без Mac-а
mobile-demo-exit = Изађи из обиласка
mobile-status-demo = Обилазак
mobile-demo-session-title = Исправи збирове поруџбина
mobile-demo-prompt = Збир поруџбине греши за један цент код корпи са више ставки. Можеш ли да нађеш узрок?
mobile-demo-thinking = Заокруживање сваке ставке пре сабирања објаснило би одступање од једног цента. Гледам како се збир рачуна.
mobile-demo-answer = Збир је закључиван као float, па се свака ставка заокруживала пре него што буде додата. Ако се збиру додели тип Cents, остаје у целобројној аритметици и одступање нестаје.
