...
knowledge-search = Tafuta Maarifa
knowledge-no-match = Hakuna madokezo yanayolingana
knowledge-open-linked-note = Fungua kidokezo kilichounganishwa
knowledge-create-linked-note = Unda kidokezo kilichounganishwa
editor-properties = Mali
editor-no-properties = Hakuna mali
editor-add-tags = Ongeza vitambulisho
editor-add-property = Ongeza mali
editor-change-property-type = Badilisha aina ya mali
editor-add-tag = Ongeza lebo
editor-add-item = Ongeza kipengee
editor-linked-note = Kidokezo kilichounganishwa
editor-property-value = Thamani
editor-delete-property = Futa mali
editor-property-kind-text = Maandishi
editor-property-kind-number = Nambari
editor-property-kind-checkbox = Kisanduku cha kuteua
editor-property-kind-date = Tarehe
...
mobile-pair-title = Unganisha na Mac yako
mobile-pair-subtitle = Katika Vmux, fungua Remote kisha uchague Connect device.
mobile-pair-scan = Changanua msimbo wa QR
mobile-pair-show-link = Weka kiungo cha kuoanisha mwenyewe
mobile-pair-hide-link = Ficha kiungo cha kuoanisha
mobile-pair-link-placeholder = Bandika kiungo cha kuoanisha
mobile-pair-connect = Unganisha
mobile-pair-connecting = Inaunganisha…
mobile-pair-disconnect = Tenganisha
mobile-status-connected = Imeunganishwa
mobile-status-reaching = Inafikia Mac yako…
mobile-status-disconnected = Haijaunganishwa

mobile-url-invalid = URL ya kuoanisha si sahihi.
mobile-url-no-address = URL ya kuoanisha haina anwani ya seva.
mobile-url-bad-address = URL ya kuoanisha ina anwani ya seva isiyo sahihi.
mobile-url-no-token = URL ya kuoanisha haina tokeni.
mobile-url-scheme = URL ya kuoanisha lazima itumie HTTPS au HTTP.
mobile-url-paste-full = Bandika URL kamili ya kuoanisha inayoonyeshwa na Vmux kwenye Mac yako.

mobile-error-pairing-outdated = Uoanishaji huu umepitwa na wakati. Changanua tena QR kwenye Mac yako.
mobile-error-pairing-expired = Muda wa uoanishaji umeisha. Changanua tena QR kwenye Mac yako.
mobile-error-pairing-lost = Muda wa uoanishaji umeisha. Oanisha tena na Mac.
mobile-error-token-rejected = Tokeni ya kuoanisha imekataliwa.
mobile-error-stack-missing = Kompyuta ilifungua gumzo, lakini tabaka lake halikuonekana.
mobile-error-not-offered = Mac yako haitoi hili bado.
mobile-error-remote-disabled = Remote imezimwa kwenye Mac yako.
mobile-error-session-gone = Kipindi hicho hakipo tena.
mobile-error-no-desktop = Fungua dirisha la Vmux kwenye Mac yako.
mobile-error-refused = Mac yako haikuweza kufanya hilo.
mobile-error-no-answer = Hakuna jibu kutoka { $address } baada ya sekunde { $seconds }.

mobile-start-stacks = Matabaka
mobile-start-no-stacks = Hakuna matabaka yaliyofunguliwa
mobile-start-team = Timu
mobile-start-search-placeholder = Tafuta au uliza…
mobile-start-new-chat = Anza gumzo
mobile-start-starting = Inaanza…

mobile-chat-back = Rudi
mobile-chat-back-to-stacks = Rudi kwenye matabaka
mobile-chat-no-messages = Bado hakuna ujumbe.
mobile-chat-no-session = Hakuna kipindi kinachoendelea
...
mobile-qr-unavailable = Kichanganuzi cha QR hakipatikani.
mobile-qr-camera-unavailable = Kamera haipatikani. Weka kiungo cha kuoanisha badala yake.
mobile-qr-camera-failed = Imeshindwa kufungua kamera: { $error }
mobile-qr-camera-input-unavailable = Ingizo la kamera halipatikani.
mobile-qr-unsupported-device = Kuchanganua QR hakupatikani kwenye kifaa hiki.
mobile-qr-unsupported-platform = Kuchanganua QR hakupatikani bado kwenye jukwaa hili. Weka kiungo cha kuoanisha badala yake.
mobile-error-unexpected-answer = Mac yako imejibu bila kutarajiwa.
mobile-error-connection-dropped = Muunganisho na Mac yako umekatika.
...
mobile-demo-open = Tazama ziara bila Mac
mobile-demo-exit = Ondoka kwenye ziara
mobile-status-demo = Ziara
mobile-demo-session-title = Rekebisha jumla za maagizo
mobile-demo-prompt = Jumla ya agizo inakosea kwa senti moja kwenye vikapu vyenye bidhaa nyingi. Unaweza kupata sababu?
mobile-demo-thinking = Kuzungusha kila mstari kabla ya kujumlisha kungeeleza tofauti ya senti moja. Naangalia jinsi jumla inavyokokotolewa.
mobile-demo-answer = Jumla ilikuwa ikichukuliwa kama float, hivyo kila mstari ulizungushwa kabla ya kuongezwa. Kuipa jumla aina ya Cents kunaiweka katika hesabu za namba nzima na tofauti inatoweka.
