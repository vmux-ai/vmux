...
knowledge-search = Shakisha Ubumenyi
knowledge-no-match = Nta nyandiko zihuye
knowledge-open-linked-note = Fungura inyandiko ihujwe
knowledge-create-linked-note = Kora inyandiko ihujwe
editor-properties = Ibyiza
editor-no-properties = Nta mutungo
editor-add-tags = Ongeraho ibirango
editor-add-property = Ongeraho umutungo
editor-change-property-type = Hindura ubwoko bwumutungo
editor-add-tag = Ongeraho tagi
editor-add-item = Ongeraho ikintu
editor-linked-note = Inyandiko ihujwe
editor-property-value = Agaciro
editor-delete-property = Siba umutungo
editor-property-kind-text = Inyandiko
editor-property-kind-number = Umubare
editor-property-kind-checkbox = Agasanduku
editor-property-kind-date = Itariki
...
mobile-demo-open = Reba urugendo nta Mac
mobile-demo-exit = Sohoka mu rugendo
mobile-status-demo = Urugendo
mobile-demo-session-title = Kosora igiteranyo cy'ibyatumijwe
mobile-demo-prompt = Igiteranyo cy'ibyatumijwe kirenga senti imwe ku giseke kirimo ibintu byinshi. Wabona icyabiteye?
mobile-demo-thinking = Kuzenguruka buri murongo mbere yo guteranya byasobanura itandukaniro rya senti imwe. Ndareba uko igiteranyo kibarwa.
mobile-demo-answer = Igiteranyo cyafatwaga nka float, bityo buri murongo wazengurukwaga mbere yo kongerwaho. Guha igiteranyo ubwoko bwa Cents bigituma gikomeza mu mibare yuzuye kandi itandukaniro rikavaho.
