...
knowledge-search = Leita Þekking
knowledge-no-match = Engar samsvarandi athugasemdir
knowledge-open-linked-note = Opna tengda athugasemd
knowledge-create-linked-note = Búðu til tengda athugasemd
editor-properties = Eiginleikar
editor-no-properties = Engar eignir
editor-add-tags = Bæta við merkjum
editor-add-property = Bæta við eign
editor-change-property-type = Breyta eignargerð
editor-add-tag = Bæta við merki
editor-add-item = Bæta við hlut
editor-linked-note = Tengd athugasemd
editor-property-value = Gildi
editor-delete-property = Eyða eign
editor-property-kind-text = Texti
editor-property-kind-number = Númer
editor-property-kind-checkbox = Gátreitur
editor-property-kind-date = Dagsetning
...
mobile-pair-title = Tengjast Mac-tölvunni þinni
mobile-pair-subtitle = Opnaðu Remote í Vmux og veldu Connect device.
mobile-pair-scan = Skanna QR-kóða
mobile-pair-show-link = Slá inn pörunartengil handvirkt
mobile-pair-hide-link = Fela pörunartengil
mobile-pair-link-placeholder = Límdu pörunartengil
mobile-pair-connect = Tengjast
mobile-pair-connecting = Tengist…
mobile-pair-disconnect = Aftengja
mobile-status-connected = Tengd
mobile-status-reaching = Næ í Mac-tölvuna þína…
mobile-status-disconnected = Ekki tengdur

mobile-url-invalid = Pörunarslóðin er ógild.
mobile-url-no-address = Pörunarslóðin hefur ekkert vistfang þjóns.
mobile-url-bad-address = Pörunarslóðin hefur ógilt vistfang þjóns.
mobile-url-no-token = Pörunarslóðin hefur engan aðgangslykil.
mobile-url-scheme = Pörunarslóðin verður að nota HTTPS eða HTTP.
mobile-url-paste-full = Límdu inn alla pörunarslóðina sem Vmux sýnir á Mac-tölvunni þinni.

mobile-error-pairing-outdated = Þessi pörun er úrelt. Skannaðu QR-kóðann á Mac-tölvunni þinni aftur.
mobile-error-pairing-expired = Pörunin rann út. Skannaðu QR-kóðann á Mac-tölvunni þinni aftur.
mobile-error-pairing-lost = Pörunin rann út. Paraðu við Mac-tölvuna aftur.
mobile-error-token-rejected = Pörunarlyklinum var hafnað.
mobile-error-stack-missing = Tölvan opnaði spjallið en staflinn birtist ekki.
mobile-error-not-offered = Mac-tölvan þín býður ekki upp á þetta enn.
mobile-error-remote-disabled = Slökkt er á Remote í Mac-tölvunni þinni.
mobile-error-session-gone = Þessi lota er horfin.
mobile-error-no-desktop = Opnaðu Vmux-gluggann á Mac-tölvunni þinni.
mobile-error-refused = Mac-tölvan þín gat ekki gert þetta.
mobile-error-no-answer = Ekkert svar frá { $address } eftir { $seconds } sek.

mobile-start-stacks = Staflar
mobile-start-no-stacks = Engir opnir staflar
mobile-start-team = Teymi
mobile-start-search-placeholder = Leita eða spyrja…
mobile-start-new-chat = Hefja spjall
mobile-start-starting = Ræsir…

mobile-chat-back = Til baka
mobile-chat-back-to-stacks = Aftur í stafla
mobile-chat-no-messages = Engin skilaboð enn.
mobile-chat-no-session = Engin virk lota
...
mobile-qr-unavailable = QR-skanninn er ekki tiltækur.
mobile-qr-camera-unavailable = Myndavél ekki tiltæk. Sláðu inn pörunartengilinn í staðinn.
mobile-qr-camera-failed = Tókst ekki að opna myndavél: { $error }
mobile-qr-camera-input-unavailable = Inntak myndavélar er ekki tiltækt.
mobile-qr-unsupported-device = QR-skönnun er ekki tiltæk í þessu tæki.
mobile-qr-unsupported-platform = QR-skönnun er ekki tiltæk á þessum vettvangi enn. Sláðu inn pörunartengilinn í staðinn.
mobile-error-unexpected-answer = Mac-tölvan þín svaraði óvænt.
mobile-error-connection-dropped = Tengingin við Mac-tölvuna þína rofnaði.
...
mobile-demo-open = Skoðunarferð án Mac
mobile-demo-exit = Hætta í skoðunarferð
mobile-status-demo = Skoðunarferð
mobile-demo-session-title = Laga heildarupphæðir pantana
mobile-demo-prompt = Heildarupphæð pöntunar skeikar um eitt sent í körfum með mörgum vörum. Finnurðu ástæðuna?
mobile-demo-thinking = Ef hver lína er námunduð áður en lagt er saman skýrir það eins sents skekkju. Ég er að skoða hvernig heildarupphæðin er reiknuð.
mobile-demo-answer = Summan var ályktuð sem fleytitala, svo hver lína námundaðist áður en henni var bætt við. Með því að gefa heildarupphæðinni gerðina Cents helst hún í heiltölureikningi og skekkjan hverfur.
