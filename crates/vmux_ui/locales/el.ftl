...
knowledge-search = Αναζήτηση γνώσεων
knowledge-no-match = Δεν υπάρχουν σημειώσεις που να ταιριάζουν
knowledge-open-linked-note = Ανοίξτε τη συνδεδεμένη σημείωση
knowledge-create-linked-note = Δημιουργία συνδεδεμένης σημείωσης
editor-properties = Σκηνικά θέατρου
editor-no-properties = Δεν υπάρχουν ακίνητα
editor-add-tags = Προσθήκη ετικετών
editor-add-property = Προσθήκη ιδιοκτησίας
editor-change-property-type = Αλλαγή τύπου ιδιοκτησίας
editor-add-tag = Προσθήκη ετικέτας
editor-add-item = Προσθήκη στοιχείου
editor-linked-note = Συνδεδεμένη σημείωση
editor-property-value = Αξία
editor-delete-property = Διαγραφή ιδιοκτησίας
editor-property-kind-text = Κείμενο
editor-property-kind-number = Αριθμός
editor-property-kind-checkbox = Πλαίσιο ελέγχου
editor-property-kind-date = Ημερομηνία
...
mobile-pair-title = Σύνδεση με το Mac σας
mobile-pair-subtitle = Στο Vmux, ανοίξτε το Remote και επιλέξτε Connect device.
mobile-pair-scan = Σάρωση κωδικού QR
mobile-pair-show-link = Μη αυτόματη εισαγωγή συνδέσμου σύζευξης
mobile-pair-hide-link = Απόκρυψη συνδέσμου σύζευξης
mobile-pair-link-placeholder = Επικολλήστε τον σύνδεσμο σύζευξης
mobile-pair-connect = Σύνδεση
mobile-pair-connecting = Σύνδεση…
mobile-pair-disconnect = Αποσύνδεση
mobile-status-connected = Συνδεδεμένο
mobile-status-reaching = Επικοινωνία με το Mac σας…
mobile-status-disconnected = Χωρίς σύνδεση

mobile-url-invalid = Το URL σύζευξης δεν είναι έγκυρο.
mobile-url-no-address = Το URL σύζευξης δεν έχει διεύθυνση διακομιστή.
mobile-url-bad-address = Το URL σύζευξης έχει μη έγκυρη διεύθυνση διακομιστή.
mobile-url-no-token = Το URL σύζευξης δεν έχει token.
mobile-url-scheme = Το URL σύζευξης πρέπει να χρησιμοποιεί HTTPS ή HTTP.
mobile-url-paste-full = Επικολλήστε ολόκληρο το URL σύζευξης που εμφανίζει το Vmux στο Mac σας.

mobile-error-pairing-outdated = Αυτή η σύζευξη είναι παλιά. Σαρώστε ξανά τον κωδικό QR στο Mac σας.
mobile-error-pairing-expired = Η σύζευξη έληξε. Σαρώστε ξανά τον κωδικό QR στο Mac σας.
mobile-error-pairing-lost = Η σύζευξη έληξε. Κάντε ξανά σύζευξη με το Mac.
mobile-error-token-rejected = Το token σύζευξης απορρίφθηκε.
mobile-error-stack-missing = Ο υπολογιστής άνοιξε τη συνομιλία, αλλά η στοίβα της δεν εμφανίστηκε.
mobile-error-not-offered = Το Mac σας δεν το προσφέρει ακόμη αυτό.
mobile-error-remote-disabled = Το Remote είναι απενεργοποιημένο στο Mac σας.
mobile-error-session-gone = Αυτή η συνεδρία δεν υπάρχει πλέον.
mobile-error-no-desktop = Ανοίξτε το παράθυρο του Vmux στο Mac σας.
mobile-error-refused = Το Mac σας δεν μπόρεσε να το κάνει αυτό.
mobile-error-no-answer = Καμία απάντηση από { $address } μετά από { $seconds } δευτ.

mobile-start-stacks = Στοίβες
mobile-start-no-stacks = Δεν υπάρχουν ανοιχτές στοίβες
mobile-start-team = Ομάδα
mobile-start-search-placeholder = Αναζήτηση ή ερώτηση…
mobile-start-new-chat = Έναρξη συνομιλίας
mobile-start-starting = Εκκίνηση…

mobile-chat-back = Πίσω
mobile-chat-back-to-stacks = Πίσω στις στοίβες
mobile-chat-no-messages = Δεν υπάρχουν ακόμη μηνύματα.
mobile-chat-no-session = Καμία ενεργή συνεδρία
...
mobile-qr-unavailable = Ο σαρωτής QR δεν είναι διαθέσιμος.
mobile-qr-camera-unavailable = Η κάμερα δεν είναι διαθέσιμη. Εισαγάγετε τον σύνδεσμο σύζευξης.
mobile-qr-camera-failed = Δεν ήταν δυνατό το άνοιγμα της κάμερας: { $error }
mobile-qr-camera-input-unavailable = Η είσοδος κάμερας δεν είναι διαθέσιμη.
mobile-qr-unsupported-device = Η σάρωση QR δεν είναι διαθέσιμη σε αυτή τη συσκευή.
mobile-qr-unsupported-platform = Η σάρωση QR δεν είναι ακόμη διαθέσιμη σε αυτή την πλατφόρμα. Εισαγάγετε τον σύνδεσμο σύζευξης.
mobile-error-unexpected-answer = Το Mac σας απάντησε απροσδόκητα.
mobile-error-connection-dropped = Η σύνδεση με το Mac σας διακόπηκε.
...
mobile-demo-open = Ξεναγηθείτε χωρίς Mac
mobile-demo-exit = Έξοδος από την ξενάγηση
mobile-status-demo = Ξενάγηση
mobile-demo-session-title = Διόρθωση συνόλων παραγγελίας
mobile-demo-prompt = Σε καλάθια με πολλά είδη, το σύνολο της παραγγελίας αποκλίνει κατά ένα λεπτό. Μπορείς να βρεις γιατί;
mobile-demo-thinking = Η στρογγυλοποίηση κάθε γραμμής πριν από την άθροιση θα εξηγούσε απόκλιση ενός λεπτού. Εξετάζω πώς υπολογίζεται το σύνολο.
mobile-demo-answer = Το άθροισμα συναγόταν ως αριθμός κινητής υποδιαστολής, οπότε κάθε γραμμή στρογγυλοποιούνταν πριν προστεθεί. Δίνοντας στο σύνολο τον τύπο Cents, παραμένει σε ακέραια αριθμητική και η απόκλιση εξαφανίζεται.
