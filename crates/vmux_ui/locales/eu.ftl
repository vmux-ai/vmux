...
knowledge-search = Bilatu Ezagutza
knowledge-no-match = Ez dago bat datorren oharrik
knowledge-open-linked-note = Ireki estekatutako oharra
knowledge-create-linked-note = Sortu estekatutako oharra
editor-properties = Propietateak
editor-no-properties = Ez dago propietaterik
editor-add-tags = Gehitu etiketak
editor-add-property = Gehitu jabetza
editor-change-property-type = Aldatu jabetza mota
editor-add-tag = Gehitu etiketa
editor-add-item = Gehitu elementua
editor-linked-note = Lotutako oharra
editor-property-value = Balioa
editor-delete-property = Ezabatu jabetza
editor-property-kind-text = Testua
editor-property-kind-number = Zenbakia
editor-property-kind-checkbox = Kontrol-laukia
...
mobile-pair-title = Konektatu zure Mac-era
mobile-pair-subtitle = Vmux-en, ireki Remote eta hautatu Connect device.
mobile-pair-scan = Eskaneatu QR kodea
mobile-pair-show-link = Sartu parekatze-esteka eskuz
mobile-pair-hide-link = Ezkutatu parekatze-esteka
mobile-pair-link-placeholder = Itsatsi parekatze-esteka
mobile-pair-connect = Konektatu
mobile-pair-connecting = Konektatzen…
mobile-pair-disconnect = Deskonektatu
mobile-status-connected = Konektatuta
mobile-status-reaching = Zure Mac-era iristen…
mobile-status-disconnected = Konektatu gabe

mobile-url-invalid = Parekatze-URLa ez da baliozkoa.
mobile-url-no-address = Parekatze-URLak ez du zerbitzari-helbiderik.
mobile-url-bad-address = Parekatze-URLak zerbitzari-helbide baliogabea du.
mobile-url-no-token = Parekatze-URLak ez du tokenik.
mobile-url-scheme = Parekatze-URLak HTTPS edo HTTP erabili behar du.
mobile-url-paste-full = Itsatsi Vmux-ek zure Mac-en erakusten duen parekatze-URL osoa.

mobile-error-pairing-outdated = Parekatze hau zaharkituta dago. Eskaneatu berriro zure Mac-eko QR kodea.
mobile-error-pairing-expired = Parekatzea iraungi da. Eskaneatu berriro zure Mac-eko QR kodea.
mobile-error-pairing-lost = Parekatzea iraungi da. Parekatu berriro Mac-arekin.
mobile-error-token-rejected = Parekatze-tokena ukatu da.
mobile-error-stack-missing = Mahaigainak txata ireki du, baina haren pila ez da agertu.
mobile-error-not-offered = Zure Mac-ek ez du hori eskaintzen oraindik.
mobile-error-remote-disabled = Remote itzalita dago zure Mac-en.
mobile-error-session-gone = Saio hori ez dago jada.
mobile-error-no-desktop = Ireki Vmux-en leihoa zure Mac-en.
mobile-error-refused = Zure Mac-ek ezin izan du hori egin.
mobile-error-no-answer = { $address } helbideak ez du erantzun { $seconds } s igarota.

mobile-start-stacks = Pilak
mobile-start-no-stacks = Ez dago pila irekirik
mobile-start-team = Taldea
mobile-start-search-placeholder = Bilatu edo galdetu…
mobile-start-new-chat = Hasi txata
mobile-start-starting = Hasten…

mobile-chat-back = Atzera
mobile-chat-back-to-stacks = Itzuli piletara
mobile-chat-no-messages = Oraindik ez dago mezurik.
mobile-chat-no-session = Ez dago saio aktiborik
...
mobile-qr-unavailable = QR eskanerra ez dago erabilgarri.
mobile-qr-camera-unavailable = Kamera ez dago erabilgarri. Sartu parekatze-esteka horren ordez.
mobile-qr-camera-failed = Ezin izan da kamera ireki: { $error }
mobile-qr-camera-input-unavailable = Kameraren sarrera ez dago erabilgarri.
mobile-qr-unsupported-device = QR eskaneatzea ez dago erabilgarri gailu honetan.
mobile-qr-unsupported-platform = QR eskaneatzea ez dago oraindik erabilgarri plataforma honetan. Sartu parekatze-esteka horren ordez.
mobile-error-unexpected-answer = Zure Mac-ek ustekabean erantzun du.
mobile-error-connection-dropped = Zure Mac-arekiko konexioa eten da.
...
mobile-demo-open = Egin bisita Mac-ik gabe
mobile-demo-exit = Irten bisitatik
mobile-status-demo = Bisita
mobile-demo-session-title = Konpondu eskaeren guztizkoak
mobile-demo-prompt = Hainbat artikulu dituzten saskietan, eskaeraren guztizkoa zentimo bat aldentzen da. Aurki dezakezu zergatik?
mobile-demo-thinking = Lerro bakoitza batu aurretik biribiltzeak zentimo bateko aldea azalduko luke. Guztizkoa nola kalkulatzen den begiratzen ari naiz.
mobile-demo-answer = Batura koma higikorreko zenbaki gisa ondorioztatzen zen, beraz lerro bakoitza batu aurretik biribiltzen zen. Guztizkoari Cents mota emanez gero, osoko aritmetikan mantentzen da eta aldea desagertzen da.
