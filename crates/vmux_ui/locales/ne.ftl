...
vault-recovery-key-create-failed = रिकभरी कुञ्जी सिर्जना गर्न सकिएन।
vault-recovery-key-save = अहिले यो कुञ्जी बचत गर्नुहोस्। Vmux ले यसलाई फेरि देखाउन सक्दैन।
vault-recovery-key-saved = मैले यसलाई बचत गरें
vault-recovery-key-placeholder = टाँस्नुहोस् रिकभरी कुञ्जी
vault-recovery-key-unlock = अनलक
vault-recovery-key-invalid = यो रिकभरी कुञ्जीले भल्ट अनलक गर्न सक्दैन।
vault-recovery-key-ready = रिकभरी कुञ्जी कन्फिगर गरियो
vault-recovery-key-upload-pending = कुञ्जी स्थानीय रूपमा बचत गरिएको छ, तर अपलोड असफल भयो। यसलाई सुरक्षित राख्नुहोस् र पुन: प्रयास गर्न सिंक थिच्नुहोस्।
vault-auto-sync = स्वचालित ब्याकअप
vault-backup-failed = स्वचालित ब्याकअप असफल भयो। पुन: प्रयास गर्न सिंक थिच्नुहोस्।
vault-backup-failed-short = ब्याकअप असफल भयो
vault-recovery-key-copy-hint = प्रतिलिपि गर्न क्लिक गर्नुहोस्
vault-recovery-key-copied = प्रतिलिपि गरियो
vault-recovery-key-verify = यसलाई आफ्नो पासवर्ड प्रबन्धकमा बचत गर्नुहोस्, त्यसपछि प्रमाणित गर्न तल टाँस्नुहोस्।
vault-recovery-key-verify-placeholder = सुरक्षित गरिएको रिकभरी कुञ्जी टाँस्नुहोस्
vault-recovery-key-mismatch = रिकभरी कुञ्जी मेल खाँदैन।
...
vault-github = GitHub
vault-github-description = एउटा निजी भण्डार सिर्जना गर्नुहोस् वा अवस्थित भल्ट छनौट गर्नुहोस्।
vault-connect-github = GitHub जडान गर्नुहोस्
vault-connected-as = { $name } को रूपमा जडान गरियो
vault-use-repository = प्रयोग गर्नुहोस्
vault-repository-name = भण्डारको नाम
vault-cloud-folder = क्लाउड फोल्डर
vault-cloud-folder-description = Google Drive, iCloud Drive, Dropbox, वा OneDrive बाट फोल्डर प्रयोग गर्नुहोस्।
vault-choose-folder = फोल्डर छान्नुहोस्
vault-result-github-connected = GitHub · { common-done }
vault-result-folder-connected = फोल्डर · { common-done }
vault-private = निजी भण्डार
vault-public-warning = रिपोजिटरीको इतिहास र इन्क्रिप्ट गरिएको डेटा सार्वजनिक हुनेछ।
...
knowledge-search = ज्ञान खोज्नुहोस्
knowledge-no-match = कुनै मिल्दो टिपोटहरू छैनन्
knowledge-open-linked-note = लिङ्क गरिएको नोट खोल्नुहोस्
knowledge-create-linked-note = लिङ्क गरिएको नोट सिर्जना गर्नुहोस्
editor-properties = गुणहरू
editor-no-properties = कुनै गुण छैन
editor-add-tags = ट्यागहरू थप्नुहोस्
editor-add-property = सम्पत्ति थप्नुहोस्
editor-change-property-type = सम्पत्ति प्रकार परिवर्तन गर्नुहोस्
editor-add-tag = ट्याग थप्नुहोस्
editor-add-item = वस्तु थप्नुहोस्
editor-linked-note = लिङ्क गरिएको नोट
editor-property-value = मूल्य
editor-delete-property = सम्पत्ति मेटाउनुहोस्
editor-property-kind-text = पाठ
editor-property-kind-number = नम्बर
editor-property-kind-checkbox = चेकबक्स
editor-property-kind-date = मिति
...
mobile-pair-title = आफ्नो Mac मा जडान गर्नुहोस्
mobile-pair-subtitle = Vmux मा Remote खोल्नुहोस् र Connect device छान्नुहोस्।
mobile-pair-scan = QR कोड स्क्यान गर्नुहोस्
mobile-pair-show-link = पेयरिङ लिंक आफैं हाल्नुहोस्
mobile-pair-hide-link = पेयरिङ लिंक लुकाउनुहोस्
mobile-pair-link-placeholder = पेयरिङ लिंक टाँस्नुहोस्
mobile-pair-connect = जडान गर्नुहोस्
mobile-pair-connecting = जडान हुँदै…
mobile-pair-disconnect = विच्छेद गर्नुहोस्
mobile-status-connected = जडान भयो
mobile-status-reaching = तपाईंको Mac खोज्दै…
mobile-status-disconnected = जडान भएको छैन

mobile-url-invalid = पेयरिङ URL अवैध छ।
mobile-url-no-address = पेयरिङ URL मा सर्भर ठेगाना छैन।
mobile-url-bad-address = पेयरिङ URL को सर्भर ठेगाना अवैध छ।
mobile-url-no-token = पेयरिङ URL मा टोकन छैन।
mobile-url-scheme = पेयरिङ URL ले HTTPS वा HTTP प्रयोग गर्नुपर्छ।
mobile-url-paste-full = तपाईंको Mac मा Vmux ले देखाएको पूरा पेयरिङ URL टाँस्नुहोस्।

mobile-error-pairing-outdated = यो पेयरिङ पुरानो भयो। आफ्नो Mac को QR फेरि स्क्यान गर्नुहोस्।
mobile-error-pairing-expired = पेयरिङको म्याद सकियो। आफ्नो Mac को QR फेरि स्क्यान गर्नुहोस्।
mobile-error-pairing-lost = पेयरिङको म्याद सकियो। Mac सँग फेरि पेयर गर्नुहोस्।
mobile-error-token-rejected = पेयरिङ टोकन अस्वीकार गरियो।
mobile-error-stack-missing = डेस्कटपले च्याट खोल्यो, तर त्यसको स्ट्याक देखिएन।
mobile-error-not-offered = तपाईंको Mac ले यो अझै दिँदैन।
mobile-error-remote-disabled = तपाईंको Mac मा Remote बन्द छ।
mobile-error-session-gone = त्यो सत्र अब छैन।
mobile-error-no-desktop = आफ्नो Mac मा Vmux विन्डो खोल्नुहोस्।
mobile-error-refused = तपाईंको Mac ले त्यो गर्न सकेन।
mobile-error-no-answer = { $seconds }s पछि पनि { $address } बाट जवाफ आएन।

mobile-start-stacks = स्ट्याकहरू
mobile-start-no-stacks = कुनै खुला स्ट्याक छैन
mobile-start-team = टोली
mobile-start-search-placeholder = खोज्नुहोस् वा सोध्नुहोस्…
mobile-start-new-chat = च्याट सुरु
mobile-start-starting = सुरु हुँदै…

mobile-chat-back = पछाडि
mobile-chat-back-to-stacks = स्ट्याकहरूमा फर्कनुहोस्
mobile-chat-no-messages = अझै कुनै सन्देश छैन।
mobile-chat-no-session = कुनै सक्रिय सत्र छैन
mobile-chat-placeholder = एजेन्टलाई सन्देश…
mobile-chat-send = पठाउनुहोस्
mobile-chat-stop = रोक्नुहोस्

mobile-qr-title = Vmux ले देखाएको QR कोड स्क्यान गर्नुहोस्
mobile-qr-cancel = रद्द गर्नुहोस्
mobile-qr-unavailable = QR स्क्यानर उपलब्ध छैन।
mobile-qr-camera-unavailable = क्यामेरा उपलब्ध छैन। बरु पेयरिङ लिंक हाल्नुहोस्।
mobile-qr-camera-failed = क्यामेरा खोल्न सकिएन: { $error }
mobile-qr-camera-input-unavailable = क्यामेरा इनपुट उपलब्ध छैन।
mobile-qr-unsupported-device = यो उपकरणमा QR स्क्यानिङ उपलब्ध छैन।
mobile-qr-unsupported-platform = यो प्लेटफर्ममा QR स्क्यानिङ अझै उपलब्ध छैन। बरु पेयरिङ लिंक हाल्नुहोस्।
mobile-error-unexpected-answer = तपाईंको Mac ले अनपेक्षित जवाफ दियो।
mobile-error-connection-dropped = तपाईंको Mac सँगको जडान टुट्यो।
...
mobile-demo-open = Mac बिना नै भ्रमण गर्नुहोस्
mobile-demo-exit = भ्रमण बन्द गर्नुहोस्
mobile-status-demo = भ्रमण
mobile-demo-session-title = अर्डरको कुल रकम मिलाउनुहोस्
mobile-demo-prompt = धेरै वस्तु भएका कार्टमा अर्डरको कुल रकम एक सेन्टले फरक पर्छ। तपाईं कारण पत्ता लगाउन सक्नुहुन्छ?
mobile-demo-thinking = जोड्नुअघि हरेक पङ्क्तिलाई राउन्ड गर्दा एक सेन्टको फरक आउन सक्छ। कुल रकम कसरी बन्छ भनेर हेर्दैछु।
mobile-demo-answer = जोडलाई float मानिएको थियो, त्यसैले हरेक पङ्क्ति थपिनुअघि नै राउन्ड हुन्थ्यो। कुल रकमलाई Cents प्रकार दिँदा त्यो पूर्णाङ्क गणितमै रहन्छ र फरक हराउँछ।
