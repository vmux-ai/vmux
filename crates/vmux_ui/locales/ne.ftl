...
mobile-chat-allow = अनुमति
mobile-chat-deny = अस्वीकार
mobile-chat-allow-prompt = { $name } लाई अनुमति दिने?
mobile-chat-enter-to-send = पठाउन Enter
mobile-chat-default-effort = पूर्वनिर्धारित प्रयास
