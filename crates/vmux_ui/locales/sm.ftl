...
knowledge-search = Saili le Poto
knowledge-no-match = Leai ni fa'amatalaga tutusa
knowledge-open-linked-note = Tatala tusi feso'ota'i
knowledge-create-linked-note = Fausia se fa'amatalaga feso'ota'i
editor-properties = Meatotino
editor-no-properties = Leai ni meatotino
editor-add-tags = Fa'aopoopo fa'ailoga
editor-add-property = Faaopoopo meatotino
editor-change-property-type = Suia ituaiga meatotino
editor-add-tag = Fa'aopoopo fa'ailoga
editor-add-item = Fa'aopoopo mea
editor-linked-note = Fa'amatalaga feso'ota'i
editor-property-value = Taua
editor-delete-property = Aveese meatotino
editor-property-kind-text = Tusitusi
editor-property-kind-number = Numera
editor-property-kind-checkbox = Pusa siaki
editor-property-kind-date = Aso
...
mobile-pair-title = Feso‘ota‘i i lau Mac
mobile-pair-subtitle = I le Vmux, tatala Remote ona filifili lea o Connect device.
mobile-pair-scan = Siaki le QR code
mobile-pair-show-link = Lomi le so‘otaga i le lima
mobile-pair-hide-link = Nātia le so‘otaga feso‘ota‘i
mobile-pair-link-placeholder = Fa‘apipi‘i le so‘otaga feso‘ota‘i
mobile-pair-connect = Feso‘ota‘i
mobile-pair-connecting = O lo‘o feso‘ota‘i…
mobile-pair-disconnect = Motusia
mobile-status-connected = Ua feso‘ota‘i
mobile-status-reaching = O lo‘o o‘o atu i lau Mac…
mobile-status-disconnected = E le‘i feso‘ota‘i

mobile-url-invalid = E lē aogā le URL feso‘ota‘i.
mobile-url-no-address = E leai se tuatusi server i le URL feso‘ota‘i.
mobile-url-bad-address = E lē aogā le tuatusi server i le URL feso‘ota‘i.
mobile-url-no-token = E leai se token i le URL feso‘ota‘i.
mobile-url-scheme = E tatau i le URL feso‘ota‘i ona fa‘aaogā HTTPS po‘o HTTP.
mobile-url-paste-full = Fa‘apipi‘i le URL feso‘ota‘i atoa o lo‘o fa‘aali e Vmux i lau Mac.

mobile-error-pairing-outdated = Ua tuai lenei feso‘ota‘iga. Toe siaki le QR i lau Mac.
mobile-error-pairing-expired = Ua uma le taimi o le feso‘ota‘iga. Toe siaki le QR i lau Mac.
mobile-error-pairing-lost = Ua uma le taimi o le feso‘ota‘iga. Toe feso‘ota‘i ma le Mac.
mobile-error-token-rejected = Ua te‘ena le token feso‘ota‘i.
mobile-error-stack-missing = Na tatala e le komepiuta le talanoaga, ae e le‘i sau lona fa‘aputuga.
mobile-error-not-offered = E le‘i maua lenei mea i lau Mac.
mobile-error-remote-disabled = Ua tape le Remote i lau Mac.
mobile-error-session-gone = Ua leai lena session.
mobile-error-no-desktop = Tatala le faamalama Vmux i lau Mac.
mobile-error-refused = E lē mafai e lau Mac ona fai lena mea.
mobile-error-no-answer = E leai se tali mai { $address } ina ua mavae sekone e { $seconds }.

mobile-start-stacks = Fa‘aputuga
mobile-start-no-stacks = E leai ni fa‘aputuga ua tatala
mobile-start-team = Au
mobile-start-search-placeholder = Su‘e pe fesili…
mobile-start-new-chat = Amata talanoaga
mobile-start-starting = O lo‘o amata…

mobile-chat-back = Tua
mobile-chat-back-to-stacks = Toe fo‘i i fa‘aputuga
mobile-chat-no-messages = E leai ni fe‘au.
mobile-chat-no-session = E leai se session o galue
...
mobile-qr-unavailable = E le maua le mea siaki QR.
mobile-qr-camera-unavailable = E le maua le mea pu‘eata. Lomi le so‘otaga feso‘ota‘i.
mobile-qr-camera-failed = E le mafai ona tatala le mea pu‘eata: { $error }
mobile-qr-camera-input-unavailable = E le maua le fa‘aoga o le mea pu‘eata.
mobile-qr-unsupported-device = E le mafai ona siaki QR i lenei masini.
mobile-qr-unsupported-platform = E le‘i maua le siaki QR i lenei ituaiga masini. Lomi le so‘otaga feso‘ota‘i.
mobile-error-unexpected-answer = Ua tali mai lau Mac i se auala e le‘i fa‘amoemoeina.
mobile-error-connection-dropped = Ua motu le so‘otaga i lau Mac.
...
mobile-demo-open = Fai se āsiasiga e aunoa ma se Mac
mobile-demo-exit = Alu ese mai le āsiasiga
mobile-status-demo = Āsiasiga
mobile-demo-session-title = Fa‘asa‘o aofa‘iga o fa‘atonuga
mobile-demo-prompt = E sese le aofa‘i o le fa‘atonuga i le tasi sene i ato fa‘atau e tele mea o iai. E mafai ona e su‘eina le mafua‘aga?
mobile-demo-thinking = O le fa‘atapula‘aina o laina ta‘itasi a‘o le‘i fa‘aopoopoina e mafai ona fa‘amatalaina ai le eseesega e tasi le sene. O lo‘o siaki pe fa‘apefea ona fausia le aofa‘i.
mobile-demo-answer = Sa manatu o le aofa‘i o se float, o lea na fa‘atapula‘aina ai laina ta‘itasi a‘o le‘i fa‘aopoopoina. A fa‘ailoa le aofa‘i o le ituaiga Cents, e tumau i numera atoa ma mou atu le eseesega.
