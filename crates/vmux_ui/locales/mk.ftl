...
mobile-demo-open = Направи обиколка без Mac
mobile-demo-exit = Излези од обиколката
mobile-status-demo = Обиколка
mobile-demo-session-title = Поправи ги вкупните износи на нарачките
mobile-demo-prompt = Вкупниот износ на нарачката отстапува за еден цент кај кошнички со повеќе ставки. Можеш ли да го најдеш?
mobile-demo-thinking = Заокружување на секоја ставка пред собирањето би го објаснило отстапувањето од еден цент. Проверувам како се пресметува вкупниот износ.
mobile-demo-answer = Збирот се заклучуваше како float, па секоја ставка се заокружуваше пред да биде додадена. Ако вкупниот износ се типизира како Cents, останува во целобројна аритметика и отстапувањето исчезнува.
