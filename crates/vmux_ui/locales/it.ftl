...
mobile-demo-open = Fai un tour senza Mac
mobile-demo-exit = Esci dal tour
mobile-status-demo = Tour
mobile-demo-session-title = Correggere i totali degli ordini
mobile-demo-prompt = Il totale dell’ordine sbaglia di un centesimo nei carrelli con più articoli. Riesci a trovare il motivo?
mobile-demo-thinking = Arrotondare ogni riga prima di sommarle spiegherebbe uno scarto di un centesimo. Sto guardando come viene calcolato il totale.
mobile-demo-answer = La somma veniva inferita come virgola mobile, quindi ogni riga veniva arrotondata prima di essere aggiunta. Tipizzando il totale come Cents il calcolo resta in aritmetica intera e lo scarto sparisce.
