...
mobile-chat-allow = Consenti
mobile-chat-deny = Nega
mobile-chat-allow-prompt = Consentire { $name }?
mobile-chat-enter-to-send = Invio per inviare
mobile-chat-default-effort = Sforzo predefinito
