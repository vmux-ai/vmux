...
mobile-chat-allow = Дазволіць
mobile-chat-deny = Адхіліць
mobile-chat-allow-prompt = Дазволіць { $name }?
mobile-chat-enter-to-send = Enter — адправіць
mobile-chat-default-effort = Намаганне па змаўчанні
