...
mobile-demo-open = Faça um tour sem Mac
mobile-demo-exit = Sair do tour
mobile-status-demo = Tour
mobile-demo-session-title = Corrigir totais de pedidos
mobile-demo-prompt = O total do pedido está um centavo errado em carrinhos com vários itens. Você consegue achar?
mobile-demo-thinking = Arredondar cada linha antes de somar explicaria uma diferença de um centavo. Verificando como o total é montado.
mobile-demo-answer = A soma estava sendo inferida como float, então cada linha era arredondada antes de ser somada. Tipar o total como Cents mantém tudo em aritmética inteira e a diferença some.
