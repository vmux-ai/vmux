...
schema-update-channel = Release channel
schema-update-channel-detail = Stable receives published releases. Preview receives nightly builds.
schema-update-channel-stable = Stable
schema-update-channel-preview = Preview
...
git-commits = Commits
git-log = Log
git-command-log = Command log
git-command-log-empty = Git operations will appear here.
git-command-error = error
...
git-switch-workspace = Switch workspace
git-edit-config = Edit config file
git-switch-recent-repository = Switch to a recent repository
git-keybindings = Keybindings
git-checkout = Checkout
git-new-branch = New branch
git-delete-branch = Delete branch
git-stashes = Stashes
git-no-stashes = No stashes
...
git-checkout-commit = Checkout commit
git-shortcut-panels = Panels
git-shortcut-navigate = Navigate
git-shortcut-help = Shortcuts
git-shortcut-title = Git shortcuts
git-shortcut-description = Available shortcuts for this Git page.
git-shortcut-universal = Universal
git-shortcut-next-panel = Next panel
git-shortcut-previous = Previous item
git-shortcut-next = Next item
...
mobile-nav-untitled-chat = Untitled chat
mobile-nav-launcher = Start
mobile-nav-new-tab = New tab
mobile-nav-unsupported = Not available on this device
mobile-nav-read-only = Read-only
mobile-nav-open-on-mac = Open it on your Mac
mobile-nav-url-placeholder = Ask, or paste a URL…
