...
knowledge-search = Мэдлэг хайх
knowledge-no-match = Тохирох тэмдэглэл алга
knowledge-open-linked-note = Холбоостой тэмдэглэлийг нээх
knowledge-create-linked-note = Холбоотой тэмдэглэл үүсгэх
editor-properties = Үл хөдлөх хөрөнгө
editor-no-properties = Үл хөдлөх хөрөнгө байхгүй
editor-add-tags = Шошго нэмэх
editor-add-property = Үл хөдлөх хөрөнгө нэмнэ үү
editor-change-property-type = Үл хөдлөх хөрөнгийн төрлийг өөрчлөх
editor-add-tag = Шошго нэмэх
editor-add-item = Зүйл нэмэх
editor-linked-note = Холбоотой тэмдэглэл
editor-property-value = Үнэ цэнэ
editor-delete-property = Үл хөдлөх хөрөнгийг устгах
editor-property-kind-text = Текст
editor-property-kind-number = Тоо
editor-property-kind-checkbox = Checkbox
editor-property-kind-date = Огноо
...
mobile-pair-title = Mac-тайгаа холбогдох
mobile-pair-subtitle = Vmux дээр Remote-г нээгээд Connect device-г сонгоно уу.
mobile-pair-scan = QR код уншуулах
mobile-pair-show-link = Холбох линкийг гараар оруулах
mobile-pair-hide-link = Холбох линкийг нуух
mobile-pair-link-placeholder = Холбох линкийг буулгана уу
mobile-pair-connect = Холбох
mobile-pair-connecting = Холбогдож байна…
mobile-pair-disconnect = Салгах
mobile-status-connected = Холбогдсон
mobile-status-reaching = Mac-тай холбоо тогтоож байна…
mobile-status-disconnected = Холбогдоогүй

mobile-url-invalid = Холболтын URL буруу байна.
mobile-url-no-address = Холболтын URL-д серверийн хаяг алга.
mobile-url-bad-address = Холболтын URL-ийн серверийн хаяг буруу байна.
mobile-url-no-token = Холболтын URL-д токен алга.
mobile-url-scheme = Холболтын URL нь HTTPS эсвэл HTTP байх ёстой.
mobile-url-paste-full = Mac дээрх Vmux-ийн харуулж буй холболтын бүтэн URL-ийг буулгана уу.

mobile-error-pairing-outdated = Энэ холболт хуучирсан байна. Mac дээрх QR-ийг дахин уншуулна уу.
mobile-error-pairing-expired = Холболтын хугацаа дууссан. Mac дээрх QR-ийг дахин уншуулна уу.
mobile-error-pairing-lost = Холболтын хугацаа дууссан. Mac-тай дахин холбогдоно уу.
mobile-error-token-rejected = Холболтын токеныг татгалзсан.
mobile-error-stack-missing = Десктоп чатыг нээсэн ч түүний stack гарч ирсэнгүй.
mobile-error-not-offered = Таны Mac үүнийг хараахан дэмжихгүй байна.
mobile-error-remote-disabled = Таны Mac дээр Remote унтраалттай байна.
mobile-error-session-gone = Тэр сешн байхгүй болсон.
mobile-error-no-desktop = Mac дээрээ Vmux цонхыг нээнэ үү.
mobile-error-refused = Таны Mac үүнийг гүйцэтгэж чадсангүй.
mobile-error-no-answer = { $seconds }s хүлээсэн ч { $address } хариу өгсөнгүй.

mobile-start-stacks = Stack-үүд
mobile-start-no-stacks = Нээлттэй stack алга
mobile-start-team = Баг
mobile-start-search-placeholder = Хайх эсвэл асуух…
mobile-start-new-chat = Чат эхлүүлэх
mobile-start-starting = Эхэлж байна…

mobile-chat-back = Буцах
mobile-chat-back-to-stacks = Stack руу буцах
mobile-chat-no-messages = Одоохондоо мессеж алга.
mobile-chat-no-session = Идэвхтэй сешн алга
...
mobile-qr-unavailable = QR уншигч боломжгүй байна.
mobile-qr-camera-unavailable = Камер боломжгүй байна. Оронд нь холбох линкийг оруулна уу.
mobile-qr-camera-failed = Камерыг нээж чадсангүй: { $error }
mobile-qr-camera-input-unavailable = Камерын оролт боломжгүй байна.
mobile-qr-unsupported-device = Энэ төхөөрөмж дээр QR уншуулах боломжгүй.
mobile-qr-unsupported-platform = Энэ платформ дээр QR уншуулах боломж хараахан алга. Оронд нь холбох линкийг оруулна уу.
mobile-error-unexpected-answer = Таны Mac гэнэтийн хариу өглөө.
mobile-error-connection-dropped = Таны Mac-тай холбоо тасарлаа.
...
mobile-demo-open = Mac-гүйгээр танилцуулга үзэх
mobile-demo-exit = Танилцуулгаас гарах
mobile-status-demo = Танилцуулга
mobile-demo-session-title = Захиалгын нийт дүнг засах
mobile-demo-prompt = Олон бараатай сагсанд захиалгын нийт дүн нэг центээр зөрж байна. Шалтгааныг нь олж чадах уу?
mobile-demo-thinking = Мөр бүрийг нэмэхээс өмнө бүхэлчилж байгаа нь нэг центийн зөрүүг тайлбарлаж магадгүй. Нийт дүнг хэрхэн бодж байгааг шалгаж байна.
mobile-demo-answer = Нийлбэрийг float гэж таамаглаж байсан тул мөр бүр нэмэгдэхээсээ өмнө бүхэлчлэгдэж байжээ. Нийт дүнг Cents гэж тодорхойлбол бүхэл тооны арифметикт үлдэж, зөрүү арилна.
