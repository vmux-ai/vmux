...
mobile-chat-allow = Уруксат берүү
mobile-chat-deny = Баш тартуу
mobile-chat-allow-prompt = { $name } үчүн уруксат бересизби?
mobile-chat-enter-to-send = Жөнөтүү үчүн Enter
mobile-chat-default-effort = Демейки аракет
