...
knowledge-search = Билимди издөө
knowledge-no-match = Дал келген эскертүүлөр жок
knowledge-open-linked-note = Шилтемеленген жазууну ачуу
knowledge-create-linked-note = Шилтемеленген эскертүү түзүңүз
editor-properties = Properties
editor-no-properties = Мүлк жок
editor-add-tags = Тегдерди кошуу
editor-add-property = Менчик кошуу
editor-change-property-type = Менчик түрүн өзгөртүү
editor-add-tag = Тег кошуу
editor-add-item = Элемент кошуу
editor-linked-note = Шилтемеленген эскертүү
editor-property-value = Нарк
editor-delete-property = Менчикти жок кылуу
editor-property-kind-text = Текст
editor-property-kind-number = Сан
editor-property-kind-checkbox = Белгилөө кутучасы
...
mobile-pair-title = Mac-ке туташуу
mobile-pair-subtitle = Vmux-та Remote бөлүмүн ачып, Түзмөктү туташтыруу дегенди тандаңыз.
mobile-pair-scan = QR кодун сканерлөө
mobile-pair-show-link = Жупташтыруу шилтемесин кол менен киргизүү
mobile-pair-hide-link = Жупташтыруу шилтемесин жашыруу
mobile-pair-link-placeholder = Жупташтыруу шилтемесин коюңуз
mobile-pair-connect = Туташуу
mobile-pair-connecting = Туташууда…
mobile-pair-disconnect = Ажыратуу
mobile-status-connected = Туташты
mobile-status-reaching = Mac-ке туташууда…
mobile-status-disconnected = Туташкан эмес

mobile-url-invalid = Жупташтыруу URL дареги жараксыз.
mobile-url-no-address = Жупташтыруу URL дарегинде сервердин дареги жок.
mobile-url-bad-address = Жупташтыруу URL дарегиндеги сервердин дареги жараксыз.
mobile-url-no-token = Жупташтыруу URL дарегинде токен жок.
mobile-url-scheme = Жупташтыруу URL дареги HTTPS же HTTP колдонушу керек.
mobile-url-paste-full = Mac-теги Vmux көрсөткөн толук жупташтыруу URL дарегин коюңуз.

mobile-error-pairing-outdated = Бул жупташтыруу эскирген. Mac-теги QR кодун кайра сканерлеңиз.
mobile-error-pairing-expired = Жупташтыруунун мөөнөтү бүттү. Mac-теги QR кодун кайра сканерлеңиз.
mobile-error-pairing-lost = Жупташтыруунун мөөнөтү бүттү. Mac менен кайра жупташтырыңыз.
mobile-error-token-rejected = Жупташтыруу токени четке кагылды.
mobile-error-stack-missing = Компьютерде чат ачылды, бирок анын стеги көрүнбөй калды.
mobile-error-not-offered = Mac-иңиз муну азырынча сунуштабайт.
mobile-error-remote-disabled = Mac-иңизде Remote өчүрүлгөн.
mobile-error-session-gone = Ал сессия жок.
mobile-error-no-desktop = Mac-иңизде Vmux терезесин ачыңыз.
mobile-error-refused = Mac-иңиз муну аткара алган жок.
mobile-error-no-answer = { $seconds } секунддан кийин { $address } жооп берген жок.

mobile-start-stacks = Стектер
mobile-start-no-stacks = Ачык стектер жок
mobile-start-team = Команда
mobile-start-search-placeholder = Издөө же суроо…
mobile-start-new-chat = Чат баштоо
mobile-start-starting = Башталууда…

mobile-chat-back = Артка
mobile-chat-back-to-stacks = Стектерге кайтуу
mobile-chat-no-messages = Азырынча билдирүү жок.
mobile-chat-no-session = Активдүү сессия жок
mobile-chat-placeholder = Агентке билдирүү…
mobile-chat-send = Жөнөтүү
mobile-chat-stop = Токтотуу

mobile-qr-title = Vmux көрсөткөн QR кодун сканерлеңиз
mobile-qr-cancel = Жокко чыгаруу
mobile-qr-unavailable = QR сканери жеткиликсиз.
mobile-qr-camera-unavailable = Камера жеткиликсиз. Анын ордуна жупташтыруу шилтемесин киргизиңиз.
mobile-qr-camera-failed = Камераны ачуу мүмкүн болгон жок: { $error }
mobile-qr-camera-input-unavailable = Камеранын кириши жеткиликсиз.
mobile-qr-unsupported-device = Бул түзмөктө QR сканерлөө жеткиликсиз.
mobile-qr-unsupported-platform = Бул платформада QR сканерлөө азырынча жеткиликсиз. Анын ордуна жупташтыруу шилтемесин киргизиңиз.
mobile-error-unexpected-answer = Mac-иңиз күтүлбөгөн жооп берди.
mobile-error-connection-dropped = Mac-иңиз менен туташуу үзүлүп калды.
...
mobile-demo-open = Mac-сыз тур жасаңыз
mobile-demo-exit = Турдан чыгуу
mobile-status-demo = Тур
mobile-demo-session-title = Заказдын жыйынтыгын оңдоо
mobile-demo-prompt = Бир нече товары бар себеттерде заказдын жыйынтыгы бир центке айырмаланат. Себебин таба аласыңбы?
mobile-demo-thinking = Ар бир сапты кошуудан мурун тегеректөө бир центтик айырманы түшүндүрмөк. Жыйынтык кантип эсептелерин карап жатам.
mobile-demo-answer = Жыйынтык калкыма чекиттүү сан катары аныкталчу, ошондуктан ар бир сап кошулардан мурун тегеректелчү. Жыйынтыкка Cents түрүн берүү аны бүтүн сандык арифметикада калтырат жана айырма жоголот.
