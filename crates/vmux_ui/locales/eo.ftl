...
knowledge-search = Serĉu Scion
knowledge-no-match = Neniuj kongruaj notoj
knowledge-open-linked-note = Malfermu ligitan noton
knowledge-create-linked-note = Krei ligitan noton
editor-properties = Propraĵoj
editor-no-properties = Neniuj propraĵoj
editor-add-tags = Aldonu etikedojn
editor-add-property = Aldonu posedaĵon
editor-change-property-type = Ŝanĝu posedaĵotipo
editor-add-tag = Aldonu etikedon
editor-add-item = Aldonu eron
editor-linked-note = Ligita noto
editor-property-value = Valoro
editor-delete-property = Forigi posedaĵon
editor-property-kind-text = Teksto
editor-property-kind-number = Numero
editor-property-kind-checkbox = Markobutono
...
mobile-pair-title = Konekti al via Mac
mobile-pair-subtitle = En Vmux, malfermu Remote kaj elektu Connect device.
mobile-pair-scan = Skani QR-kodon
mobile-pair-show-link = Enigi parigan ligilon permane
mobile-pair-hide-link = Kaŝi parigan ligilon
mobile-pair-link-placeholder = Alglui parigan ligilon
mobile-pair-connect = Konekti
mobile-pair-connecting = Konektante…
mobile-pair-disconnect = Malkonekti
mobile-status-connected = Konektita
mobile-status-reaching = Atingante vian Mac…
mobile-status-disconnected = Ne konektita

mobile-url-invalid = La pariga URL estas nevalida.
mobile-url-no-address = La pariga URL ne havas servilan adreson.
mobile-url-bad-address = La pariga URL havas nevalidan servilan adreson.
mobile-url-no-token = La pariga URL ne havas ĵetonon.
mobile-url-scheme = La pariga URL devas uzi HTTPS aŭ HTTP.
mobile-url-paste-full = Algluu la tutan parigan URL montritan de Vmux sur via Mac.

mobile-error-pairing-outdated = Ĉi tiu parigo estas malaktuala. Reskanu la QR-kodon sur via Mac.
mobile-error-pairing-expired = La parigo eksvalidiĝis. Reskanu la QR-kodon sur via Mac.
mobile-error-pairing-lost = La parigo eksvalidiĝis. Parigu denove kun la Mac.
mobile-error-token-rejected = La pariga ĵetono estis rifuzita.
mobile-error-stack-missing = La labortablo malfermis la babilon, sed ĝia stako ne aperis.
mobile-error-not-offered = Via Mac ankoraŭ ne proponas tion.
mobile-error-remote-disabled = Remote estas malŝaltita sur via Mac.
mobile-error-session-gone = Tiu sesio ne plu ekzistas.
mobile-error-no-desktop = Malfermu la fenestron de Vmux sur via Mac.
mobile-error-refused = Via Mac ne povis fari tion.
mobile-error-no-answer = Neniu respondo de { $address } post { $seconds } s.

mobile-start-stacks = Stakoj
mobile-start-no-stacks = Neniuj malfermitaj stakoj
mobile-start-team = Teamo
mobile-start-search-placeholder = Serĉi aŭ demandi…
mobile-start-new-chat = Komenci babilon
mobile-start-starting = Komencante…

mobile-chat-back = Reen
mobile-chat-back-to-stacks = Reen al stakoj
mobile-chat-no-messages = Ankoraŭ neniuj mesaĝoj.
mobile-chat-no-session = Neniu aktiva sesio
...
mobile-qr-unavailable = La QR-skanilo ne disponeblas.
mobile-qr-camera-unavailable = Fotilo ne disponeblas. Enigu anstataŭe la parigan ligilon.
mobile-qr-camera-failed = Ne eblis malfermi la fotilon: { $error }
mobile-qr-camera-input-unavailable = La fotila enigo ne disponeblas.
mobile-qr-unsupported-device = QR-skanado ne disponeblas sur ĉi tiu aparato.
mobile-qr-unsupported-platform = QR-skanado ankoraŭ ne disponeblas sur ĉi tiu platformo. Enigu anstataŭe la parigan ligilon.
mobile-error-unexpected-answer = Via Mac respondis neatendite.
mobile-error-connection-dropped = La konekto al via Mac rompiĝis.
...
mobile-demo-open = Faru viziton sen Mac
mobile-demo-exit = Eliri el la vizito
mobile-status-demo = Vizito
mobile-demo-session-title = Ripari mendo-sumojn
mobile-demo-prompt = La mendosumo devias je unu cendo ĉe korboj kun pluraj eroj. Ĉu vi povas trovi kial?
mobile-demo-thinking = Rondigo de ĉiu linio antaŭ la sumigo klarigus devion de unu cendo. Mi rigardas, kiel la sumo estas kalkulata.
mobile-demo-answer = La sumo estis konkludita kiel glitkoma nombro, do ĉiu linio estis rondigita antaŭ ol aldoniĝi. Doni al la sumo la tipon Cents tenas ĝin en entjera aritmetiko kaj la devio malaperas.
