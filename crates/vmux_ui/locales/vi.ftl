...
knowledge-search = Tìm kiếm kiến ​​thức
knowledge-no-match = Không có ghi chú phù hợp
knowledge-open-linked-note = Mở ghi chú được liên kết
knowledge-create-linked-note = Tạo ghi chú được liên kết
editor-properties = Của cải
editor-no-properties = Không có thuộc tính
editor-add-tags = Thêm thẻ
editor-add-property = Thêm tài sản
editor-change-property-type = Thay đổi loại thuộc tính
editor-add-tag = Thêm thẻ
editor-add-item = Thêm mục
editor-linked-note = Ghi chú được liên kết
editor-property-value = Giá trị
editor-delete-property = Xóa thuộc tính
editor-property-kind-text = Chữ
editor-property-kind-number = Con số
editor-property-kind-checkbox = Hộp kiểm
editor-property-kind-date = Ngày
...
mobile-demo-open = Tham quan mà không cần máy Mac
mobile-demo-exit = Thoát tham quan
mobile-status-demo = Tham quan
mobile-demo-session-title = Sửa tổng tiền đơn hàng
mobile-demo-prompt = Tổng tiền đơn hàng lệch một xu ở những giỏ có nhiều mặt hàng. Bạn tìm ra nguyên nhân được không?
mobile-demo-thinking = Việc làm tròn từng dòng trước khi cộng sẽ giải thích được độ lệch một xu. Đang xem tổng tiền được tính như thế nào.
mobile-demo-answer = Tổng đang được suy ra là float nên mỗi dòng bị làm tròn trước khi cộng vào. Khai báo tổng theo kiểu Cents sẽ giữ phép tính ở số nguyên và độ lệch biến mất.
