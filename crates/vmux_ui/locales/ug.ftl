...
knowledge-search = ئىزدەش بىلىملىرى
knowledge-no-match = ماس كېلىدىغان خاتىرە يوق
knowledge-open-linked-note = ئۇلانغان خاتىرىنى ئېچىڭ
knowledge-create-linked-note = ئۇلانغان خاتىرە قۇر
editor-properties = خاسلىقى
editor-no-properties = ھېچقانداق خاسلىقى يوق
editor-add-tags = خەتكۈچ قوشۇڭ
editor-add-property = مۈلۈك قوشۇڭ
editor-change-property-type = مۈلۈك تىپىنى ئۆزگەرتىش
editor-add-tag = خەتكۈچ قوشۇڭ
editor-add-item = تۈر قوشۇڭ
editor-linked-note = ئۇلانغان ئىزاھات
editor-property-value = قىممەت
editor-delete-property = مۈلۈكنى ئۆچۈرۈڭ
editor-property-kind-text = تېكىست
editor-property-kind-number = سان
editor-property-kind-checkbox = تەكشۈرۈش رامكىسى
editor-property-kind-date = چېسلا
...
mobile-demo-open = Mac بولمىسىمۇ ساياھەت قىلىڭ
mobile-demo-exit = ساياھەتتىن چېكىنىش
mobile-status-demo = ساياھەت
mobile-demo-session-title = زاكاز ئومۇمىي سوممىسىنى تۈزىتىش
mobile-demo-prompt = كۆپ تۈرلۈك مال بار سېۋەتلەردە زاكازنىڭ ئومۇمىي سوممىسى بىر سېنت خاتا چىقىۋاتىدۇ. سەۋەبىنى تاپالامسىز؟
mobile-demo-thinking = قوشۇشتىن بۇرۇن ھەر بىر قۇرنى پۈتۈنلەشتۈرۈش بىر سېنتلىق پەرقنى چۈشەندۈرەلەيدۇ. ئومۇمىي سوممىنىڭ قانداق ھېسابلىنىدىغانلىقىنى كۆرۈۋاتىمەن.
mobile-demo-answer = يىغىندى float دەپ پەرەز قىلىنغاچقا، ھەر بىر قۇر قوشۇلۇشتىن بۇرۇن پۈتۈنلەشتۈرۈلگەن. ئومۇمىي سوممىغا Cents تىپى بېرىلسە، پۈتۈن سان ھېسابىدا قالىدۇ ۋە پەرق يوقايدۇ.
