...
schema-update-channel = Канал обновлений
schema-update-channel-detail = Стабильный канал получает опубликованные релизы, а предварительный — ночные сборки.
schema-update-channel-stable = Стабильный
schema-update-channel-preview = Предварительный
...
command-rotate-forward = Макет > Панель > Повернуть панели вперёд
command-rotate-backward = Макет > Панель > Повернуть панели назад
command-mirror-panes = Макет > Панель > Отразить панели
command-mirror-panes-horizontal = Макет > Панель > Отразить панели по горизонтали
command-mirror-panes-vertical = Макет > Панель > Отразить панели по вертикали
...
mobile-nav-untitled-chat = Чат без названия
mobile-nav-launcher = Старт
mobile-nav-new-tab = Новая вкладка
mobile-nav-unsupported = Недоступно на этом устройстве
mobile-nav-read-only = Только для чтения
mobile-nav-open-on-mac = Откройте на Mac
mobile-nav-url-placeholder = Спросите или вставьте URL…
...
git-command-log-empty = Операции Git появятся здесь.
git-command-error = ошибка
git-repository = Репозиторий
git-changes = Изменения
git-branches = Ветки
git-staged-changes = Индексированные изменения
git-unstaged-changes = Неиндексированные изменения
git-repository-clean = Рабочее дерево чисто
git-select-file = Выберите файл для просмотра различий
git-stage = Индексировать
git-discard = Отменить
git-recent-commits = Недавние коммиты
git-no-commits = Коммитов пока нет
git-local-branches = Локальные ветки
git-local = Локальные
git-remote = Удалённые
git-tags = Теги
git-no-branches = Локальных веток нет
...
git-stage-all = Индексировать всё
git-switch-workspace = Сменить рабочую область
git-edit-config = Изменить файл конфигурации
git-switch-recent-repository = Переключиться на недавний репозиторий
git-keybindings = Сочетания клавиш
git-checkout = Переключиться
git-new-branch = Новая ветка
git-delete-branch = Удалить ветку
git-stashes = Спрятанные изменения
git-no-stashes = Нет спрятанных изменений
git-stash = Спрятать изменения
git-stash-pop = Применить и удалить
git-stash-drop = Удалить stash
git-amend = Дополнить коммит
git-rebase = Перебазировать
git-merge = Слить
git-fast-forward = Перемотать вперёд
git-revert-commit = Отменить коммит
git-cherry-pick = Cherry-pick
git-checkout-commit = Перейти на коммит
git-shortcut-panels = Панели
git-shortcut-navigate = Навигация
git-shortcut-help = Сочетания клавиш
git-shortcut-title = Сочетания клавиш Git
git-shortcut-description = Доступные сочетания клавиш для этой страницы Git.
git-shortcut-universal = Общие
git-shortcut-next-panel = Следующая панель
git-shortcut-previous = Предыдущий элемент
git-shortcut-next = Следующий элемент
