...
mobile-chat-allow = Разрешить
mobile-chat-deny = Запретить
mobile-chat-allow-prompt = Разрешить { $name }?
mobile-chat-enter-to-send = Enter — отправить
mobile-chat-default-effort = Стандартное усилие
