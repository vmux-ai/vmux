...
knowledge-search = Neman Ilimi
knowledge-no-match = Babu bayanin kula masu dacewa
knowledge-open-linked-note = Buɗe bayanin kula mai alaƙa
knowledge-create-linked-note = Ƙirƙiri bayanin kula mai alaƙa
editor-properties = Kayayyaki
editor-no-properties = Babu kadarori
editor-add-tags = Ƙara tags
editor-add-property = Ƙara dukiya
editor-change-property-type = Canja nau'in dukiya
editor-add-tag = Ƙara tag
editor-add-item = Ƙara abu
editor-linked-note = bayanin kula mai alaƙa
editor-property-value = Daraja
editor-delete-property = Share dukiya
editor-property-kind-text = Rubutu
editor-property-kind-number = Lamba
editor-property-kind-checkbox = Akwatin ajiya
editor-property-kind-date = Kwanan wata
...
mobile-demo-open = Yi yawo ba tare da Mac ba
mobile-demo-exit = Fita daga yawon
mobile-status-demo = Yawo
mobile-demo-session-title = Gyara jimillar oda
mobile-demo-prompt = Jimillar oda tana bambanta da sisi ɗaya a kwandunan da ke da kaya fiye da ɗaya. Za ka iya gano dalilin?
mobile-demo-thinking = Zagaye kowane layi kafin a haɗa su zai bayyana bambancin sisi ɗaya. Ina duba yadda ake ƙirƙirar jimillar.
mobile-demo-answer = An ɗauki jimillar a matsayin lambar ruwa, don haka an zagaye kowane layi kafin a ƙara shi. Sanya nau’in jimillar a matsayin Cents yana kiyaye ta cikin lissafin cikakkiyar lamba kuma bambancin ya ɓace.
