...
knowledge-search = Ricerca Cunniscenza
knowledge-no-match = Nisuna nota currispondente
knowledge-open-linked-note = Apertura nota ligata
knowledge-create-linked-note = Crea una nota ligata
editor-properties = Pruprietà
editor-no-properties = Nisuna pruprietà
editor-add-tags = Aggiungi tag
editor-add-property = Aghjunghjite a pruprietà
editor-change-property-type = Cambia u tipu di pruprietà
editor-add-tag = Aggiungi tag
editor-add-item = Aghjunghjite articulu
editor-linked-note = Nota ligata
editor-property-value = Valore
editor-delete-property = Sguassà a pruprietà
editor-property-kind-text = Testu
editor-property-kind-number = numeru
...
mobile-pair-title = Cunnettati à u to Mac
mobile-pair-subtitle = In Vmux, apri Remote è sceglii Cunnette un apparechju.
mobile-pair-scan = Scannà u codice QR
mobile-pair-show-link = Inserisci u ligame à manu
mobile-pair-hide-link = Piatta u ligame d’appaghjamentu
mobile-pair-link-placeholder = Incolla u ligame d’appaghjamentu
mobile-pair-connect = Cunnette
mobile-pair-connecting = Cunnessione in corsu…
mobile-pair-disconnect = Scunnette
mobile-status-connected = Cunnessu
mobile-status-reaching = Ricerca di u to Mac…
mobile-status-disconnected = Micca cunnessu

mobile-url-invalid = L’URL d’appaghjamentu ùn hè micca validu.
mobile-url-no-address = L’URL d’appaghjamentu ùn hà nisun indirizzu di servitore.
mobile-url-bad-address = L’URL d’appaghjamentu hà un indirizzu di servitore invalidu.
mobile-url-no-token = L’URL d’appaghjamentu ùn hà nisun token.
mobile-url-scheme = L’URL d’appaghjamentu deve aduprà HTTPS o HTTP.
mobile-url-paste-full = Incolla l’URL d’appaghjamentu sanu chì Vmux mostra nant’à u to Mac.

mobile-error-pairing-outdated = St’appaghjamentu hè vechju. Scannà torna u QR nant’à u to Mac.
mobile-error-pairing-expired = L’appaghjamentu hè scadutu. Scannà torna u QR nant’à u to Mac.
mobile-error-pairing-lost = L’appaghjamentu hè scadutu. Appaghja torna cù u Mac.
mobile-error-token-rejected = U token d’appaghjamentu hè statu ricusatu.
mobile-error-stack-missing = U desktop hà apertu a chjachjarata, ma a so pila ùn hè micca apparsa.
mobile-error-not-offered = U to Mac ùn offre ancu quessa.
mobile-error-remote-disabled = Remote hè spentu nant’à u to Mac.
mobile-error-session-gone = Quella sessione ùn ci hè più.
mobile-error-no-desktop = Apri a finestra di Vmux nant’à u to Mac.
mobile-error-refused = U to Mac ùn hà pussutu fà quessa.
mobile-error-no-answer = Nisuna risposta da { $address } dopu à { $seconds } s.

mobile-start-stacks = Pile
mobile-start-no-stacks = Nisuna pila aperta
mobile-start-team = Squadra
mobile-start-search-placeholder = Circà o dumandà…
mobile-start-new-chat = Principia una chjachjarata
mobile-start-starting = Principiu in corsu…

mobile-chat-back = In daretu
mobile-chat-back-to-stacks = Torna à e pile
mobile-chat-no-messages = Ancu nisun messagiu.
mobile-chat-no-session = Nisuna sessione attiva
mobile-chat-placeholder = Messagiu à l’agente…
mobile-chat-send = Mandà
mobile-chat-stop = Firmà

mobile-qr-title = Scannà u codice QR mustratu da Vmux
mobile-qr-cancel = Annullà
mobile-qr-unavailable = U scanner QR ùn hè micca dispunibule.
mobile-qr-camera-unavailable = Camera micca dispunibule. Inserisci piuttostu u ligame d’appaghjamentu.
mobile-qr-camera-failed = Ùn si pò apre a camera: { $error }
mobile-qr-camera-input-unavailable = L’entrata di a camera ùn hè micca dispunibule.
mobile-qr-unsupported-device = A scansione QR ùn hè micca dispunibule nant’à st’apparechju.
mobile-qr-unsupported-platform = A scansione QR ùn hè ancu dispunibule nant’à sta piattaforma. Inserisci piuttostu u ligame d’appaghjamentu.
mobile-error-unexpected-answer = U to Mac hà rispostu in modu inaspettatu.
mobile-error-connection-dropped = A cunnessione cù u to Mac s’hè interrotta.
...
mobile-demo-open = Fà un giru senza Mac
mobile-demo-exit = Esce da u giru
mobile-status-demo = Giru
mobile-demo-session-title = Riparà i totali di l’ordini
mobile-demo-prompt = U totale di l’ordine sbaglia d’un centesimu nant’à i carrelli cù parechji articuli. Poi truvà perchè?
mobile-demo-thinking = Arrutundà ogni linea prima di sumà spiegherebbe una differenza d’un centesimu. Stò à fighjà cumu si custruisce u totale.
mobile-demo-answer = A somma era inferita cum’è un fluttuante, dunque ogni linea era arrutundata prima d’esse aghjunta. Tipizzà u totale cum’è Cents u mantene in aritmetica intera è a differenza sparisce.
