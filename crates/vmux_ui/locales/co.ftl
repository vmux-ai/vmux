...
mobile-chat-allow = Permette
mobile-chat-deny = Ricusà
mobile-chat-allow-prompt = Permette { $name }?
mobile-chat-enter-to-send = Entrata per mandà
mobile-chat-default-effort = Sforzu predefinitu
