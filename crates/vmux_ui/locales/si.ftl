...
knowledge-search = දැනුම සොයන්න
knowledge-no-match = ගැළපෙන සටහන් නැත
knowledge-open-linked-note = සබැඳි සටහන විවෘත කරන්න
knowledge-create-linked-note = සම්බන්ධිත සටහනක් සාදන්න
editor-properties = දේපල
editor-no-properties = දේපල නැත
editor-add-tags = ටැග් එකතු කරන්න
editor-add-property = දේපල එකතු කරන්න
editor-change-property-type = දේපල වර්ගය වෙනස් කරන්න
editor-add-tag = ටැගය එක් කරන්න
editor-add-item = අයිතමය එකතු කරන්න
editor-linked-note = සම්බන්ධිත සටහන
editor-property-value = වටිනාකම
editor-delete-property = දේපල මකන්න
editor-property-kind-text = පෙළ
editor-property-kind-number = අංකය
editor-property-kind-checkbox = පිරික්සුම් කොටුව
editor-property-kind-date = දිනය
...
mobile-demo-open = Mac නොමැතිව චාරිකාවක් යන්න
mobile-demo-exit = චාරිකාවෙන් ඉවත් වන්න
mobile-status-demo = චාරිකාව
mobile-demo-session-title = ඇණවුම් එකතුව නිවැරදි කරන්න
mobile-demo-prompt = අයිතම කිහිපයක් ඇති කරත්තවල ඇණවුමේ එකතුව සතයකින් වැරදියි. ඔබට හේතුව සොයාගත හැකිද?
mobile-demo-thinking = එකතු කිරීමට පෙර එක් එක් පේළිය වට කිරීම සතයක විචලනය පැහැදිලි කරයි. එකතුව ගොඩනැගෙන ආකාරය පරීක්ෂා කරමි.
mobile-demo-answer = එකතුව float ලෙස අනුමාන වූ නිසා එක් එක් පේළිය එකතු වීමට පෙර වට විය. එකතුවට Cents ටයිප් එක ලබා දුන් විට එය පූර්ණ සංඛ්‍යා ගණිතයේ රැඳී විචලනය නැති වේ.
