...
pub fn CollapsibleTrigger(props: CollapsibleTriggerProps) -> Element {
    let base = attributes!(button {
        class: "box-border flex w-full flex-row items-center justify-between overflow-hidden border-0 bg-transparent py-4 text-left text-muted-foreground outline-none hover:cursor-pointer hover:underline focus-visible:shadow-[inset_0_0_0_2px_var(--ring)]"
    });
