...
"$ROOT/scripts/cargo-with-cef-cache.sh" build -p vmux_desktop -p vmux_service --release --features vmux_desktop/package
"$ROOT/scripts/verify-web-bundle.sh" release
